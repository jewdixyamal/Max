...
public class RoundedRectConstraintLayout extends ConstraintLayout {
    ...
    public RoundedRectConstraintLayout(Context context, AttributeSet attributeSet) {
        ...
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, g3c.RoundedRectConstraintLayout);
            int dimensionPixelSize = obtainStyledAttributes.getDimensionPixelSize(g3c.RoundedRectConstraintLayout_roundRadius, -1);
