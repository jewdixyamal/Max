...
public class RoundedRectFrameLayout extends FrameLayout {
    ...
    public RoundedRectFrameLayout(Context context, AttributeSet attributeSet) {
        ...
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, g3c.RoundedRectFrameLayout);
            int dimensionPixelSize = obtainStyledAttributes.getDimensionPixelSize(g3c.RoundedRectFrameLayout_cornersRadius, -1);
