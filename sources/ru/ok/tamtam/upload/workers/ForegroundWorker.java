...
public abstract class ForegroundWorker extends SdkCoroutineWorker {
    public static final ey5 Companion = new Object();
    private static final long WORK_DELAY = 1000;
    private AtomicBoolean isGetForegroundInfoCalled = new AtomicBoolean(false);
    private final bn9 needUpdateWorkerProgressNotifUseCase = new bn9(z7.g(new es3(19, this)));
    ...
    public final java.lang.Object doWork(kotlin.coroutines.Continuation<? super defpackage.fm7> r7) {
        /*
            r6 = this;
    ...
    /* JADX WARNING: Removed duplicated region for block: B:8:0x0021  */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final java.lang.Object getForegroundInfo(kotlin.coroutines.Continuation<? super defpackage.ay5> r5) {
        /*
            r4 = this;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:26:0x00a0, code lost:
        if ((java.lang.System.currentTimeMillis() - r4) > r0.q(ru.ok.tamtam.android.prefs.PmsKey.f143workerprogresstimedifffornotifyms, androidx.work.WorkRequest.MIN_BACKOFF_MILLIS)) goto L_0x00a2;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final boolean needToShowNotification(float r11) {
        ...
        L_0x0051:
            ...
            r7.getClass()
            ru.ok.tamtam.android.prefs.PmsKey r8 = ru.ok.tamtam.android.prefs.PmsKey.f101progressdifffornotify
            ...
            r0.getClass()
            ru.ok.tamtam.android.prefs.PmsKey r3 = ru.ok.tamtam.android.prefs.PmsKey.f143workerprogresstimedifffornotifyms
