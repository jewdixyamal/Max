...
public final class MediaMuteManagerImpl implements MediaMuteManager, MediaMuteCommandExecutor, MediaMuteListenerManager {
    ...
    public sd8 getMediaOptionsForCall(zad zad) {
        return this.commandExecutor.getMediaOptionsForCall(zad);
    }
    ...
    public void requestToEnableMediaForAll(Set<? extends qd8> set, zad zad, k56 k56, m56 m56) {
        this.commandExecutor.requestToEnableMediaForAll(set, zad, k56, m56);
    }

    public void requestToEnableMediaForParticipant(Set<? extends qd8> set, ParticipantId participantId, zad zad, k56 k56, m56 m56) {
        this.commandExecutor.requestToEnableMediaForParticipant(set, participantId, zad, k56, m56);
    }
    ...
    public void updateMediaOptionsForAll(Map<qd8, ? extends rd8> map, zad zad, k56 k56, m56 m56) {
        this.commandExecutor.updateMediaOptionsForAll(map, zad, k56, m56);
    }

    public void updateMediaOptionsForParticipant(Map<qd8, ? extends rd8> map, ParticipantId participantId, zad zad, k56 k56, m56 m56) {
        this.commandExecutor.updateMediaOptionsForParticipant(map, participantId, zad, k56, m56);
    }
}
