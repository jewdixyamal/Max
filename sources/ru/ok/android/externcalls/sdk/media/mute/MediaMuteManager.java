...
public interface MediaMuteManager {
    static /* synthetic */ sd8 getMediaOptionsForCall$default(MediaMuteManager mediaMuteManager, zad zad, int i, Object obj) {
        if (obj == null) {
            if ((i & 1) != 0) {
                zad = null;
            }
            return mediaMuteManager.getMediaOptionsForCall(zad);
        }
    ...
    static /* synthetic */ void requestToEnableMediaForAll$default(MediaMuteManager mediaMuteManager, Set set, zad zad, k56 k56, m56 m56, int i, Object obj) {
        if (obj == null) {
            if ((i & 2) != 0) {
                zad = null;
            }
            ...
            mediaMuteManager.requestToEnableMediaForAll(set, zad, k56, m56);
            return;
        }
    ...
    static /* synthetic */ void requestToEnableMediaForParticipant$default(MediaMuteManager mediaMuteManager, Set set, ParticipantId participantId, zad zad, k56 k56, m56 m56, int i, Object obj) {
        if (obj == null) {
            mediaMuteManager.requestToEnableMediaForParticipant(set, participantId, (i & 4) != 0 ? null : zad, (i & 8) != 0 ? null : k56, (i & 16) != 0 ? null : m56);
            return;
        }
    ...
    static /* synthetic */ void updateMediaOptionsForAll$default(MediaMuteManager mediaMuteManager, Map map, zad zad, k56 k56, m56 m56, int i, Object obj) {
        if (obj == null) {
            if ((i & 2) != 0) {
                zad = null;
            }
            ...
            mediaMuteManager.updateMediaOptionsForAll(map, zad, k56, m56);
            return;
        }
    ...
    static /* synthetic */ void updateMediaOptionsForParticipant$default(MediaMuteManager mediaMuteManager, Map map, ParticipantId participantId, zad zad, k56 k56, m56 m56, int i, Object obj) {
        if (obj == null) {
            mediaMuteManager.updateMediaOptionsForParticipant(map, participantId, (i & 4) != 0 ? null : zad, (i & 8) != 0 ? null : k56, (i & 16) != 0 ? null : m56);
            return;
        }
    ...
    sd8 getMediaOptionsForCall(zad zad);

    sd8 getMediaOptionsForCurrentUser();

    void removeListener(MediaMuteManagerListener mediaMuteManagerListener);

    void requestToEnableMediaForAll(Set<? extends qd8> set, zad zad, k56 k56, m56 m56);

    void requestToEnableMediaForParticipant(Set<? extends qd8> set, ParticipantId participantId, zad zad, k56 k56, m56 m56);

    void setAudioPlayoutMuted(boolean z);

    void updateMediaOptionsForAll(Map<qd8, ? extends rd8> map, zad zad, k56 k56, m56 m56);

    void updateMediaOptionsForParticipant(Map<qd8, ? extends rd8> map, ParticipantId participantId, zad zad, k56 k56, m56 m56);
}
