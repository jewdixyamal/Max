...
public interface ParticipantStatesManager {
    ...
    public static final class StateChangedEvent {
        ...
        public boolean equals(Object obj) {
            ...
            return (obj instanceof StateChangedEvent) && tpa.f(this.changes, ((StateChangedEvent) obj).changes);
        }
    ...
    static /* synthetic */ void lowerHandForAll$default(ParticipantStatesManager participantStatesManager, k56 k56, m56 m56, int i, Object obj) {
        if (obj == null) {
            if ((i & 1) != 0) {
                k56 = null;
            }
            ...
            participantStatesManager.lowerHandForAll(k56, m56);
            return;
        }
    ...
    void lowerHandForAll(k56 k56, m56 m56);
    ...
    void resetAssistanceRequests(yad yad);
