...
public final class MediaConnectionManagerImpl implements MediaConnectionManager, wm1, yxe {
    ...
    private final Runnable disconnectRunnable = new v88(this, 0);
    ...
    private final Runnable noDataRunnable = new v88(this, 1);
    ...
    public MediaConnectionManagerImpl(a4c a4c, k56 k56, MediaConnectionSettings mediaConnectionSettings) {
        this.log = a4c;
        this.isConversationEnded = k56;
    ...
    private final void reportNewStateIfNeeded() {
        ...
        if (state2 != state) {
            ...
            a4c.log(LOG_TAG, "new state: " + state + " isIceConnected=" + z + " isDataConnected=" + z2);
    ...
    public void onMediaDataReceived(long j) {
        ...
        if (z != z2) {
            a4c a4c = this.log;
            a4c.log(LOG_TAG, "isDataConnected=" + z2 + " timeSinceBytesReceivedMs=" + j);
        }
        reportNewStateIfNeeded();
    ...
    public void onTopologyUpdated(xxe xxe, xxe xxe2) {
        a4c a4c = this.log;
        a4c.log(LOG_TAG, "topology changed: oldTopology=" + xxe + " newTopology=" + xxe2);
    }
