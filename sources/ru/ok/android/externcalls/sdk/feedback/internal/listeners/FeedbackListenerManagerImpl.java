...
public final class FeedbackListenerManagerImpl implements FeedbackListenerManager, b71 {
    ...
    public static final class CallParticipantFeedback {
        ...
        public CallParticipantFeedback(bg1 bg1, String str) {
            this.participantId = bg1;
            this.feedbackId = str;
        }
    ...
    private final void notifyResolvedFeedbackItems(List<ParticipantFeedback> list) {
        if (!list.isEmpty()) {
            ...
            for (T next : list) {
                ...
                if (!tpa.f(participantFeedback2 != null ? participantFeedback2.getKey() : null, participantFeedback.getKey())) {
                    arrayList.add(next);
                }
            }
    ...
    private final List<CallParticipantFeedback> processFeedbackForResolvedInternalIds(List<CallParticipantFeedback> list, List<ParticipantFeedback> list2) {
        ...
        for (CallParticipantFeedback callParticipantFeedback : list) {
            ...
            ParticipantFeedback participantFeedback = participantId != null ? new ParticipantFeedback(callParticipantFeedback.getFeedbackId(), currentTimeMillis, participantId, (ParticipantFeedbackSource) null, 8, (z84) null) : null;
    ...
    private final void scheduleRemoving() {
        ...
        if (remove != null) {
            ...
            this.mainHandler.postDelayed(new r60(this, longValue, 4), longValue - System.currentTimeMillis());
        }
    }
    ...
    private final List<CallParticipantFeedback> unrollReceivedFeedback(a71 a71) {
        List<z61> list = a71.b;
        ArrayList arrayList = new ArrayList();
        for (z61 z61 : list) {
            List<bg1> list2 = z61.b;
            ArrayList arrayList2 = new ArrayList(z53.S(list2, 10));
            for (bg1 callParticipantFeedback : list2) {
                arrayList2.add(new CallParticipantFeedback(callParticipantFeedback, z61.a));
            }
    ...
    public void onFeedback(a71 a71) {
        if (tpa.f(a71.a, this.store.getActiveRoomId())) {
            List<CallParticipantFeedback> unrollReceivedFeedback = unrollReceivedFeedback(a71);
            if (!unrollReceivedFeedback.isEmpty()) {
                ...
                ArrayList arrayList2 = new ArrayList(z53.S(processFeedbackForResolvedInternalIds, 10));
                ...
                idMappingResolver2.resolveExternalsByInternalsIds(arrayList2, new v05((Object) this, (Object) processFeedbackForResolvedInternalIds, (Object) arrayList, 3), new kl4((Object) this, 24, (Object) arrayList));
            }
        }
    }
