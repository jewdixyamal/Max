...
public class IdMappingWrapper {
    ...
    private final LinkedHashMap<ParticipantId, bg1> externalToInternal;
    private final LinkedHashMap<bg1, ParticipantId> internalToExternal;
    private final a4c log;
    private boolean wasRead = false;

    private IdMappingWrapper(Context context, a4c a4c) {
        this.log = a4c;
    ...
    private synchronized void ensureMappingNotOutdated(bg1 bg1) {
        ensureMappingNotOutdated(this.internalToExternal.get(bg1));
    }

    public static IdMappingWrapper get(Context context, a4c a4c) {
        if (DEFAULT == null) {
            synchronized (IdMappingWrapper.class) {
                try {
                    if (DEFAULT == null) {
                        DEFAULT = new IdMappingWrapper(context.getApplicationContext(), a4c);
                    }
                } catch (Throwable th) {
                    throw th;
                }
    ...
    private synchronized void read() throws java.io.IOException {
        ...
        L_0x0014:
            ...
            bg1 r6 = defpackage.bg1.a(r1)     // Catch:{ NumberFormatException -> 0x0048 }
            java.util.LinkedHashMap<ru.ok.android.externcalls.sdk.id.ParticipantId, bg1> r7 = r8.externalToInternal     // Catch:{ NumberFormatException -> 0x0048 }
            r7.put(r3, r6)     // Catch:{ NumberFormatException -> 0x0048 }
            java.util.LinkedHashMap<bg1, ru.ok.android.externcalls.sdk.id.ParticipantId> r7 = r8.internalToExternal     // Catch:{ NumberFormatException -> 0x0048 }
        ...
        L_0x0046:
            ...
            goto L_0x007b
        L_0x0048:
            a4c r3 = r8.log     // Catch:{ all -> 0x0046 }
        ...
        L_0x0069:
            ...
            a4c r0 = r8.log     // Catch:{ all -> 0x0046 }
            ...
            if (file != null) {
                ...
                try {
                    for (ParticipantId next : getMappingKeysForWritingToDisk()) {
                        bg1 bg1 = this.externalToInternal.get(next);
                        if (bg1 != null) {
                            bufferedWriter.write(next.toStringValue());
                            bufferedWriter.write(9);
                            bufferedWriter.write(bg1.c());
    ...
    public synchronized void addMapping(ParticipantId participantId, bg1 bg1) {
        try {
            if (this.internalToExternal.get(bg1) == null) {
                this.changed = true;
            }
            this.internalToExternal.put(bg1, participantId);
            this.externalToInternal.put(participantId, bg1);
    ...
    public synchronized ParticipantId getByInternal(bg1 bg1) {
        if (!this.wasRead) {
            return null;
        }
        ensureMappingNotOutdated(bg1);
        return this.internalToExternal.get(bg1);
    }
