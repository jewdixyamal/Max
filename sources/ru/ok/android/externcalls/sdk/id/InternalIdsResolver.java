...
public class InternalIdsResolver {
    ...
    public interface ParticipantPrivateStateModifier {
        void setInternalId(ConversationParticipant conversationParticipant, bg1 bg1);
    }

    public InternalIdsResolver(ParticipantStore participantStore, IdMappingWrapper idMappingWrapper2, ParticipantPrivateStateModifier participantPrivateStateModifier, LocalIdMappings localIdMappings2, IdsMapper<ParticipantId, bg1> idsMapper) {
    ...
    private void applyInternalIds(Map<ParticipantId, bg1> map) {
        for (Map.Entry next : map.entrySet()) {
            ...
            if (byExternal != null) {
                this.stateModifier.setInternalId(byExternal, bg1);
