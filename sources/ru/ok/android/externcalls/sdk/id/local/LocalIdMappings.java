...
public final class LocalIdMappings {
    ...
    public final void addMappings(ConversationParticipant conversationParticipant) {
        ...
        if (!(callParticipant == null || (bg1 = callParticipant.a) == null)) {
            this.internalToLocalIdMap.put(bg1, localParticipantIdExt);
    ...
    public final Set<LocalParticipantId> getAllLocalIds(bg1 bg1) {
        Set<LocalParticipantId> set = this.internalIdToLocalIdsMap.get(bg1.a);
        return set == null ? wz4.a : set;
    }

    public final LocalParticipantId getAnyLocalId(bg1 bg1) {
        Set set = this.internalIdToLocalIdsMap.get(bg1.a);
        if (set != null) {
    ...
    public final LocalParticipantId getLocalId(bg1 bg1) {
        return this.internalToLocalIdMap.get(bg1);
    }
    ...
    public final void removedMappings(ConversationParticipant conversationParticipant) {
        ...
        fg1 callParticipant = conversationParticipant.getCallParticipant();
        if (!(callParticipant == null || (bg1 = callParticipant.a) == null)) {
            this.internalToLocalIdMap.remove(bg1);
            LongSparseArray<Set<LocalParticipantId>> longSparseArray = this.internalIdToLocalIdsMap;
            long j = bg1.a;
            Set set = longSparseArray.get(j);
            if (set != null) {
