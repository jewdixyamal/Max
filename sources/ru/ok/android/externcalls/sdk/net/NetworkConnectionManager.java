...
public interface NetworkConnectionManager {
    void addNetworkConnectivityListener(tn9 tn9);

    xxe getTopology();

    void minusAssign(yxe yxe);

    void plusAssign(yxe yxe);

    void registerBadConnectionCallback(qf0 qf0);

    void removeNetworkConnectivityListener(tn9 tn9);

    void unregisterBadConnectionCallback(qf0 qf0);
}
