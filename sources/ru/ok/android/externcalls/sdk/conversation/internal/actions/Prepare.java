...
public final class Prepare implements Action<PrepareParams, PrepareResult> {
    ...
    public Prepare(OkApiService okApiService2, gw3 gw3, ConversationParams conversationParams, InternalIdsResolver internalIdsResolver2, ExternalIdsResolver externalIdsResolver2, StartCallApiParams startCallApiParams2, PeerIdGenerator peerIdGenerator2, ConversationPreparedStat conversationPreparedStat, boolean z, boolean z2, a4c a4c, ag1 ag1) {
    ...
    private final iqd executeWithJoinLink(String str, String str2) {
        return prepareImpl(true, new Prepare$executeWithJoinLink$1(this, str, str2));
    }

    private final iqd getPrepareResult(boolean z, k56 k56) {
        return (!this.callParams.B.j || (!this.isCaller && !z)) ? getPrepareResultWithInternalIds(k56) : getPrepareResultWithoutInternalIds(k56);
    }

    private final iqd getPrepareResultWithInternalIds(k56 k56) {
        iqd iqd = (iqd) k56.invoke();
        iqd retryForApiCall = retryForApiCall(this.internalIdsResolver.resolveIdsAndGetFailed());
        ExternalIdsResolver externalIdsResolver2 = this.externalIdsResolver;
        pa3 resolveIds = externalIdsResolver2.resolveIds(externalIdsResolver2.collectExternalIdResolutionCandidates());
        e5f e5f = e5f.a;
        resolveIds.getClass();
        iqd retryForApiCall2 = retryForApiCall(new ib3(resolveIds, 0, e5f));
        ...
        Objects.requireNonNull(iqd, "source1 is null");
        ...
        return new ib3(new iqd[]{iqd, retryForApiCall, retryForApiCall2}, 6, new gd1(11, prepare$getPrepareResultWithInternalIds$1));
    }

    private final iqd getPrepareResultWithoutInternalIds(k56 k56) {
        return ((iqd) k56.invoke()).h(Prepare$getPrepareResultWithoutInternalIds$1.INSTANCE);
    }

    private final iqd prepareImpl(boolean z, k56 k56) {
        return new ib3(getPrepareResult(z, k56).i(ce.a()), 5, new Prepare$prepareImpl$1(this));
    }

    /* access modifiers changed from: private */
    public final <T> iqd retryForApiCall(iqd iqd) {
        return this.isAnswer ? RetryKt.retryApiCallForIncoming(iqd, this.callParams.B.h, this.log) : RetryKt.retryApiCallForOutgoing(iqd, this.callParams.B.h, this.log);
    }

    public iqd execute(PrepareParams prepareParams) {
