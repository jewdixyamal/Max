...
public final class RateManagerImpl implements RateManager, yh1 {
    ...
    public RateManagerImpl(a4c a4c, RttRateHintConfig rttRateHintConfig) {
        this.log = a4c;
        this.rttTrigger = new RttRateHintTrigger(a4c, rttRateHintConfig, new RateManagerImpl$rttTrigger$1(this));
    ...
    public final void addRateHint(RateHint rateHint) {
        ...
        a4c a4c = this.log;
        a4c.log(LOG_TAG, "addRateHint " + rateHint);
    }
    ...
    public final void logHints() {
        ...
        a4c.log(LOG_TAG, "rateHints = " + rateHints2 + ", shouldRateConversation=" + shouldRateConversation);
    }

    public void onRtcStats(c4c c4c) {
        this.rttTrigger.onRtcStats(c4c);
    }
}
