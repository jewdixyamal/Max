...
public interface AsrManager {
    static /* synthetic */ void startRecord$default(AsrManager asrManager, String str, zad zad, k56 k56, m56 m56, int i, Object obj) {
        if (obj == null) {
            if ((i & 2) != 0) {
                zad = null;
            }
            ...
            asrManager.startRecord(str, zad, k56, m56);
            return;
        }
        throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: startRecord");
    }

    static /* synthetic */ void stopRecord$default(AsrManager asrManager, zad zad, k56 k56, m56 m56, int i, Object obj) {
        if (obj == null) {
            if ((i & 1) != 0) {
                zad = null;
            }
            ...
            asrManager.stopRecord(zad, k56, m56);
            return;
        }
    ...
    void startRecord(String str, zad zad, k56 k56, m56 m56);

    void stopRecord(zad zad, k56 k56, m56 m56);
}
