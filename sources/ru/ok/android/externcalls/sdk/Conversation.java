...
public interface Conversation {
    ...
    static /* synthetic */ void addParticipant$default(Conversation conversation, ParticipantId participantId, Boolean bool, boolean z, rj3 rj3, int i, Object obj) {
        if (obj == null) {
            if ((i & 4) != 0) {
                z = false;
            }
            ...
            conversation.addParticipant(participantId, bool, z, rj3);
            return;
        }
    ...
    static /* synthetic */ void addParticipants$default(Conversation conversation, Collection collection, Boolean bool, boolean z, m56 m56, m56 m562, int i, Object obj) {
        if (obj == null) {
            if ((i & 4) != 0) {
                z = false;
            }
            boolean z2 = z;
            if ((i & 8) != 0) {
                m56 = Conversation$addParticipants$1.INSTANCE;
            }
            m56 m563 = m56;
            if ((i & 16) != 0) {
                m562 = null;
            }
            conversation.addParticipants(collection, bool, z2, m563, m562);
            return;
        }
    ...
    static /* synthetic */ void setAnonJoinForbidden$default(Conversation conversation, boolean z, rj3 rj3, int i, Object obj) {
        if (obj == null) {
            if ((i & 2) != 0) {
                rj3 = null;
            }
            conversation.setAnonJoinForbidden(z, rj3);
            return;
        }
    ...
    static /* synthetic */ void setFeedbackEnabled$default(Conversation conversation, boolean z, rj3 rj3, int i, Object obj) {
        if (obj == null) {
            if ((i & 2) != 0) {
                rj3 = null;
            }
            conversation.setFeedbackEnabled(z, rj3);
            return;
        }
    ...
    static /* synthetic */ void setWaitingRoomEnabled$default(Conversation conversation, boolean z, rj3 rj3, int i, Object obj) {
        if (obj == null) {
            if ((i & 2) != 0) {
                rj3 = null;
            }
            conversation.setWaitingRoomEnabled(z, rj3);
            return;
        }
    ...
    void addParticipant(String str, boolean z, rj3 rj3);

    void addParticipant(ParticipantId participantId, Boolean bool, boolean z, rj3 rj3);

    void addParticipantByLink(String str, Runnable runnable, rj3 rj3);

    void addParticipants(Collection<ParticipantId> collection, Boolean bool, boolean z, m56 m56, m56 m562);

    void changeMyState(Map<String, String> map);

    void changeMyState(Map<String, String> map, qod qod);

    void connect();

    void createJoinLink(rj3 rj3, rj3 rj32);
    ...
    wk8 getParticipantMediaStat(ConversationParticipant conversationParticipant);
    ...
    void grantRoles(ParticipantId participantId, boolean z, eg1... eg1Arr);
    ...
    void removeJoinLink(Runnable runnable, rj3 rj3);
    ...
    void setAnonJoinForbidden(boolean z, rj3 rj3);

    void setAudioCaptureEnabled(boolean z);

    void setCallOptionEnabled(oy0 oy0, boolean z, rj3 rj3);

    void setFeedbackEnabled(boolean z);

    void setFeedbackEnabled(boolean z, rj3 rj3);

    void setMuteState(ParticipantId participantId, boolean z);

    void setWaitingRoomEnabled(boolean z);

    void setWaitingRoomEnabled(boolean z, rj3 rj3);
}
