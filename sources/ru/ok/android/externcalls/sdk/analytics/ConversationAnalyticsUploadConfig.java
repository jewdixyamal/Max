...
public final class ConversationAnalyticsUploadConfig {
    ...
    public int hashCode() {
        int e = k7d.e(this.maxLocalFileCount, k7d.e(this.maxEventCount, Integer.hashCode(this.maxLocalFileSizeKb) * 31, 31), 31);
        Long l = this.timeToUploadNextFileMs;
        return Boolean.hashCode(this.disableUploadWhenCallIsActiveProvider) + ms2.d((e + (l == null ? 0 : l.hashCode())) * 31, 31, this.compressContent);
    }
    ...
    public String toString() {
        ...
        StringBuilder j = wg0.j("ConversationAnalyticsUploadConfig(maxLocalFileSizeKb=", i, ", maxEventCount=", i2, ", maxLocalFileCount=");
        j.append(i3);
        j.append(", timeToUploadNextFileMs=");
        j.append(l);
        j.append(", compressContent=");
        j.append(z);
        j.append(", disableUploadWhenCallIsActiveProvider=");
        j.append(z2);
        j.append(")");
        return j.toString();
    }
    ...
    public /* synthetic */ ConversationAnalyticsUploadConfig(int i, int i2, int i3, Long l, boolean z, boolean z2, int i4, z84 z84) {
