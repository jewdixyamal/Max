...
public interface ConversationEventsListener extends RecordEventListener {
    ...
    public static class CallEndInfo {
        ...
        public CallEndInfo(ji6 ji6, Set<HangupHint> set, String str) {
            this.reason = ji6;
            this.hints = set;
    ...
    @Deprecated
    void onMuteChanged(vi9 vi9) {
    }

    @Deprecated
    void onMuteStateInitialized(vi9 vi9) {
    }
    ...
    void onStateChanged(ConversationParticipant conversationParticipant, dg1 dg1) {
    }
