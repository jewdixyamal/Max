...
public final class MovieState {
    ...
    public /* synthetic */ MovieState(ParticipantId participantId2, fd9 fd9, boolean z, float f, boolean z2, zc9 zc9, z84 z84) {
        this(participantId2, fd9, z, f, z2, zc9);
    }

    /* renamed from: copy-brw6TxU$default  reason: not valid java name */
    public static /* synthetic */ MovieState m133copybrw6TxU$default(MovieState movieState, ParticipantId participantId2, fd9 fd9, boolean z, float f, boolean z2, zc9 zc9, int i, Object obj) {
        if ((i & 1) != 0) {
            participantId2 = movieState.participantId;
        }
        if ((i & 2) != 0) {
            fd9 = movieState.position;
        }
        fd9 fd92 = fd9;
        if ((i & 4) != 0) {
        ...
        boolean z4 = z2;
        if ((i & 32) != 0) {
            zc9 = movieState.movie;
        }
        return movieState.m135copybrw6TxU(participantId2, fd92, z3, f2, z4, zc9);
    }
    ...
    public final float m134component4_pGdNCs() {
        return this.volume;
    }
    ...
    public final zc9 component6() {
        return this.movie;
    }

    /* renamed from: copy-brw6TxU  reason: not valid java name */
    public final MovieState m135copybrw6TxU(ParticipantId participantId2, fd9 fd9, boolean z, float f, boolean z2, zc9 zc9) {
        return new MovieState(participantId2, fd9, z, f, z2, zc9, (z84) null);
    }
    ...
    public final float m136getVolume_pGdNCs() {
        return this.volume;
    }

    public int hashCode() {
        int d = ms2.d((this.position.hashCode() + (this.participantId.hashCode() * 31)) * 31, 31, this.isPlaying);
        float f = this.volume;
        float f2 = qd9.a;
        int d2 = ms2.d(ms2.c(d, f, 31), 31, this.isMuted);
        zc9 zc9 = this.movie;
        return d2 + (zc9 == null ? 0 : zc9.hashCode());
    }
    ...
    public String toString() {
        ...
        fd9 fd9 = this.position;
        boolean z = this.isPlaying;
        float f = this.volume;
        float f2 = qd9.a;
        return "MovieState(participantId=" + participantId2 + ", position=" + fd9 + ", isPlaying=" + z + ", volume=" + ("MovieVolume(value=" + f + ")") + ", isMuted=" + this.isMuted + ", movie=" + this.movie + ")";
    }

    private MovieState(ParticipantId participantId2, fd9 fd9, boolean z, float f, boolean z2, zc9 zc9) {
