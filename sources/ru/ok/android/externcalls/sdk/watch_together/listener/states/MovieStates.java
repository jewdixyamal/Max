...
public final class MovieStates {
    ...
    public static /* synthetic */ MovieStates copy$default(MovieStates movieStates, Map<cd9, MovieState> map, int i, Object obj) {
        if ((i & 1) != 0) {
    ...
    public final MovieStates copy(Map<cd9, MovieState> map) {
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof MovieStates) && tpa.f(this.states, ((MovieStates) obj).states);
    }
    ...
    public String toString() {
        Map<cd9, MovieState> map = this.states;
