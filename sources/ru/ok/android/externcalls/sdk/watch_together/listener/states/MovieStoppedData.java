...
public final class MovieStoppedData {
    ...
    public MovieStoppedData(ParticipantId participantId, zad zad, cd9 cd9, id9 id9) {
    ...
    public static /* synthetic */ MovieStoppedData copy$default(MovieStoppedData movieStoppedData, ParticipantId participantId, zad zad, cd9 cd9, id9 id9, int i, Object obj) {
        if ((i & 1) != 0) {
            participantId = movieStoppedData.participant;
        }
        if ((i & 2) != 0) {
            zad = movieStoppedData.roomId;
        }
        if ((i & 4) != 0) {
            cd9 = movieStoppedData.movieId;
        }
        if ((i & 8) != 0) {
            id9 = movieStoppedData.sourceType;
        }
        return movieStoppedData.copy(participantId, zad, cd9, id9);
    }
    ...
    public final cd9 component3() {
        return this.movieId;
    }

    public final id9 component4() {
        return this.sourceType;
    }

    public final MovieStoppedData copy(ParticipantId participantId, zad zad, cd9 cd9, id9 id9) {
        return new MovieStoppedData(participantId, zad, cd9, id9);
    }
    ...
    public String toString() {
        ...
        zad zad = this.roomId;
        cd9 cd9 = this.movieId;
        id9 id9 = this.sourceType;
        return "MovieStoppedData(participant=" + participantId + ", roomId=" + zad + ", movieId=" + cd9 + ", sourceType=" + id9 + ")";
    }
}
