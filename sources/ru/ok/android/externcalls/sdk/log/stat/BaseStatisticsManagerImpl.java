...
public abstract class BaseStatisticsManagerImpl<S extends StatItem> implements StatisticsManager<S> {
    ...
    /* JADX WARNING: type inference failed for: r0v0, types: [d4a, java.lang.Object] */
    public e4a makeState(S s) {
        ? obj = new Object();
        obj.b();
    ...
    public void setCustom(d4a d4a, Map<String, String> map) {
        for (Map.Entry next : map.entrySet()) {
            d4a.c((String) next.getKey(), (String) next.getValue());
        }
    }

    public d4a setStat(d4a d4a, S s) {
        setCustom(d4a, s.getCustom());
        d4a.a = s.getCollector();
        d4a.b = s.getType();
        d4a.c = s.getOperation();
        d4a.d(getTime(s.getTimestamp()));
        return d4a;
    }
}
