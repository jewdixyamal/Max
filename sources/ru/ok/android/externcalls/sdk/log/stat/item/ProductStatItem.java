...
public final class ProductStatItem implements StatItem {
    ...
    public static final class Builder implements StatItem.Builder {
        ...
        public ProductStatItem build() {
            return new ProductStatItem(this.collector, this.type, this.operation, this.timestamp, this.custom, (z84) null);
        }
    }

    public /* synthetic */ ProductStatItem(String str, int i, String str2, long j, Map map, z84 z84) {
