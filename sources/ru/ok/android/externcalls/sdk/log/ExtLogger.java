...
public class ExtLogger extends d4c {
    ...
    public static d4a simpleBuilder(e0e e0e) {
        ? obj = new Object();
        obj.b();
        obj.a = COLLECTOR;
        obj.b = 1;
        obj.c = e0e != null ? e0e.a : null;
        obj.d = 1;
        return obj;
    }
    ...
    public void logSimple(e0e e0e, String str, String str2) {
        d4a simpleBuilder = simpleBuilder(e0e);
    ...
    public void log(e0e e0e, Map<String, String> map) {
        log(COLLECTOR, e0e.a, map);
    }
