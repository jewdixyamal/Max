...
public interface ChatManager {
    static /* synthetic */ void sendMessage$default(ChatManager chatManager, OutboundMessage outboundMessage, k56 k56, m56 m56, int i, Object obj) {
        if (obj == null) {
            if ((i & 2) != 0) {
                k56 = null;
            }
            ...
            chatManager.sendMessage(outboundMessage, k56, m56);
            return;
        }
    ...
    void sendMessage(OutboundMessage outboundMessage, k56 k56, m56 m56);
}
