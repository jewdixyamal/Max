...
public class TextureViewRenderer extends TextureView implements VideoSink, RendererView {
    ...
    public static final class FrameSize {
        ...
        public /* synthetic */ FrameSize(int i, int i2, int i3, int i4, z84 z84) {
    ...
    public static final class PostponedFrameStatistics {
        ...
        private final void logStatisticsIfNeeded() {
            ...
            if (elapsedRealtime - this.lastLogTime >= TextureViewRenderer.POSTPONED_FRAME_STAT_LOG_INTERVAL_MILLIS) {
                ...
                StringBuilder k = au1.k(j4, "postponed: ", ", re-postponed: ");
                k.append(j5);
                au1.q(j6, ", dropped: ", " (", k);
                k.append(d);
                au1.q(j8, "%), delivered: ", " (", k);
                k.append(percent);
                au1.q(j9, "%), rejected: ", " (", k);
                k.append(d2);
                k.append("%)");
        ...
        private final double toPercent(double d) {
            return ((double) tu0.H(d * ((double) 10000))) / 100.0d;
        }
    ...
    public TextureViewRenderer(Context context) {
        this(context, (AttributeSet) null, 0, 6, (z84) null);
    }
    ...
    /* access modifiers changed from: private */
    public static final void setFrameSizeListener$lambda$2(a66 a66, int i, int i2) {
        a66.invoke(Integer.valueOf(i), Integer.valueOf(i2));
    }
    ...
    public boolean init(oe1 oe1, RendererCommon.RendererEvents rendererEvents2, RendererCommon.GlDrawer glDrawer) {
        ...
        this.videoRenderer.init(oe1, glDrawer);
    ...
    public final void onFrame(VideoFrame videoFrame) {
        if (this.doRender) {
            ...
            m56 m56 = this.frameSkipPredicate;
            if (m56 == null || !((Boolean) m56.invoke(videoFrame)).booleanValue()) {
    ...
    public void setFrameSizeListener(a66 a66) {
        maybeReleaseLastSizeListener();
        VideoRendererInterface videoRendererInterface = this.videoRenderer;
        jre jre = new jre(a66);
        this.lastSizeListener = jre;
        videoRendererInterface.addFrameSizeListener(jre);
    }

    public final void setFrameSkipCondition(m56 m56) {
        this.frameSkipPredicate = m56;
    }
    ...
    public TextureViewRenderer(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, 0, 4, (z84) null);
    }
    ...
    public TextureViewRenderer(Context context, AttributeSet attributeSet, int i) {
        ...
        this.rotatedFrameSize = new FrameSize(0, 0, 0, 7, (z84) null);
        this.measureFrameSize = new FrameSize(0, 0, 0, 7, (z84) null);
        this.doRender = true;
    ...
    public boolean init(oe1 oe1, RendererCommon.RendererEvents rendererEvents2, FrameDecorator frameDecorator2) {
        this.frameDecorator = frameDecorator2;
        return init(oe1, rendererEvents2, (RendererCommon.GlDrawer) new GlRectDrawer());
    }

    /* JADX INFO: this call moved to the top of the method (can break code semantics) */
    public /* synthetic */ TextureViewRenderer(Context context, AttributeSet attributeSet, int i, int i2, z84 z84) {
