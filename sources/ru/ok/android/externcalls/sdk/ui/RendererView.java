...
public interface RendererView {
    static /* synthetic */ boolean init$default(RendererView rendererView, oe1 oe1, RendererCommon.RendererEvents rendererEvents, FrameDecorator frameDecorator, int i, Object obj) {
        if (obj == null) {
            if ((i & 4) != 0) {
                frameDecorator = FrameDecorator.Companion.getEMPTY();
            }
            return rendererView.init(oe1, rendererEvents, frameDecorator);
        }
    ...
    boolean init(oe1 oe1, RendererCommon.RendererEvents rendererEvents, RendererCommon.GlDrawer glDrawer);

    boolean init(oe1 oe1, RendererCommon.RendererEvents rendererEvents, FrameDecorator frameDecorator);

    void release();

    void setFrameDecorator(FrameDecorator frameDecorator);

    void setFrameSizeListener(a66 a66);
