...
public final class StartCallParams extends BaseCallParams<Builder, StartCallParams> {
            ...
            if (myId != null) {
                ...
                if (onPrepared != null) {
                    ...
                    if (onError != null) {
                        ...
                        getFrameInterceptor();
                        return new StartCallParams(participantId, str, this.tokenProvider, this.tokenInfoProvider, l, this.isWatchTogetherEnabledForAll, myId, onPrepared, onError, (uz1) null, eventListener, getCameraCapturerFactory(), shouldStartWithVideo, (z84) null);
                    }
    ...
    public /* synthetic */ StartCallParams(ParticipantId participantId, String str, dwe dwe, rl rlVar, Long l, boolean z, ParticipantId participantId2, m56 m56, m56 m562, uz1 uz1, ConversationEventsListener conversationEventsListener, gy9 gy9, boolean z2, z84 z84) {
        this(participantId, str, dwe, rlVar, l, z, participantId2, m56, m562, uz1, conversationEventsListener, gy9, z2);
    }
    ...
    private StartCallParams(ParticipantId participantId, String str, dwe dwe, rl rlVar, Long l, boolean z, ParticipantId participantId2, m56 m56, m56 m562, uz1 uz1, ConversationEventsListener conversationEventsListener, gy9 gy9, boolean z2) {
        super(participantId2, conversationEventsListener, m56, m562, z2, uz1, gy9);
        this.opponentId = participantId;
        this.payload = str;
        this.tokenProvider = dwe;
        this.tokenInfoProvider = rlVar;
