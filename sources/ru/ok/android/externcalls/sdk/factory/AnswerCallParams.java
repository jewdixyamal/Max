...
public final class AnswerCallParams extends BaseCallParams<Builder, AnswerCallParams> {
                    ...
                    if (myId != null) {
                        ...
                        if (onPrepared != null) {
                            ...
                            if (onError != null) {
                                ...
                                getFrameInterceptor();
                                return new AnswerCallParams(str, participantId, z, this.tokenProvider, this.tokenInfoProvider, this.conversationParams, myId, shouldStartWithVideo, (uz1) null, eventListener, onPrepared, onError, getCameraCapturerFactory(), (z84) null);
                            }
    ...
    public /* synthetic */ AnswerCallParams(String str, ParticipantId participantId, boolean z, dwe dwe, rl rlVar, String str2, ParticipantId participantId2, boolean z2, uz1 uz1, ConversationEventsListener conversationEventsListener, m56 m56, m56 m562, gy9 gy9, z84 z84) {
        this(str, participantId, z, dwe, rlVar, str2, participantId2, z2, uz1, conversationEventsListener, m56, m562, gy9);
    }
    ...
    private AnswerCallParams(String str, ParticipantId participantId, boolean z, dwe dwe, rl rlVar, String str2, ParticipantId participantId2, boolean z2, uz1 uz1, ConversationEventsListener conversationEventsListener, m56 m56, m56 m562, gy9 gy9) {
