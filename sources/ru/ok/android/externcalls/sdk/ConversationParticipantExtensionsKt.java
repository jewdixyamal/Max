...
public final class ConversationParticipantExtensionsKt {
    public static final ConversationParticipant createConversationParticipantFromInternal(bg1 bg1, IdMappingWrapper idMappingWrapper) {
        return ConversationParticipant.fromInternal(bg1, idMappingWrapper);
    }

    public static final void deAnonymizeExt(ConversationParticipant conversationParticipant, fg1 fg1, ParticipantId participantId, ParticipantId participantId2, LocalIdMappings localIdMappings) {
        conversationParticipant.deAnonymize(fg1, participantId, participantId2, localIdMappings);
    }
    ...
    public static final void setCallParticipantExt(ConversationParticipant conversationParticipant, fg1 fg1, LocalIdMappings localIdMappings) {
        conversationParticipant.setCallParticipant(fg1, localIdMappings);
    }
