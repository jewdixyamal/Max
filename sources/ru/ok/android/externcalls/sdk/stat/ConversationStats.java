...
public final class ConversationStats {
    ...
    public ConversationStats(k56 k56, ExtLogger extLogger, gw3 gw3, Conversation.CallType callType, vte vte) {
        this.connectedToSignalingStat = new ConversationConnectedToSignalingStat(k56, vte);
        this.reconnectStat = new ConversationReconnectStat(extLogger, gw3);
        this.preparedStat = new ConversationPreparedStat(k56, vte);
        this.startedStat = new ConversationStartedStat(k56, callType, vte);
        this.wsSignalingStat = new SignalingStat(k56, vte);
    }
}
