...
public final class ConversationStartedStat {
    ...
    public ConversationStartedStat(k56 k56, Conversation.CallType callType2, vte vte) {
    ...
    private final void report() {
        ...
        if (m61 != null) {
            ...
            List M = y53.M(asString(this.callType), getWarmupStatusString());
            ...
            ArrayList<Object> arrayList2 = new ArrayList<>(z53.S(arrayList, 10));
            for (String r4 : arrayList) {
                arrayList2.add(EventItemValue.StringValue.m110boximpl(EventItemValue.StringValue.m111constructorimpl(r4)));
            }
            ...
            ((n61) m61).c("call_start", eventItemValue, eventItemsMap);
        }
    }
