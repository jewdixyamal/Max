...
public final class SignalingStat {
    ...
    public SignalingStat(k56 k56, vte vte) {
    ...
    private final void report(String str, Integer num) {
        ...
        if (m61 != null) {
            ((n61) m61).c(str, EventItemValueKt.toEventItemValue(num != null ? num.intValue() : 0), new EventItemsMap());
        }
    }
    ...
    private final void report(String str, String str2) {
        m61 m61 = (m61) this.getEventualStatSender.invoke();
        if (m61 != null) {
            ((n61) m61).c(str, EventItemValueKt.toEventItemValue(str2), new EventItemsMap());
        }
    }
}
