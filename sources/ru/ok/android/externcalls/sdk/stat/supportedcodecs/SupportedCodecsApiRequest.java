...
public final class SupportedCodecsApiRequest implements yk {
    ...
    public static final Response _get_okParser_$lambda$0(SupportedCodecsApiRequest supportedCodecsApiRequest, db7 db7) {
        return new Response(mqd.w(db7).optBoolean("success", false));
    }
