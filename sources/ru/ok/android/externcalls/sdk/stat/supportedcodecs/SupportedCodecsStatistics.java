...
public final class SupportedCodecsStatistics {
    ...
    public static final void tryToReport(q2a q2a, i7b i7b, a4c a4c, ag1 ag1) {
        long time = new Date().getTime();
        if (time - i7b.a.getLong("supportedCodecsLastUpdate", 0) >= ONE_MONTH_IN_MS) {
            JSONObject buildCodecLists = INSTANCE.buildCodecLists();
            a4c.log(LOG_TAG, "Sending supported codecs " + buildCodecLists);
            RetryKt.retryApiCallForBackgroundWork(q2a.c().a(new SupportedCodecsApiRequest(buildCodecLists)), ag1.B.h, a4c).i(ce.a()).k(new iq1(new SupportedCodecsStatistics$tryToReport$1(a4c, i7b, time), 2, new SupportedCodecsStatistics$tryToReport$2(a4c)));
        }
    }
}
