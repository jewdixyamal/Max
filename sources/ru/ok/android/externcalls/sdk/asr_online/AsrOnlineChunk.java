...
public final class AsrOnlineChunk {
    ...
    public static final class Companion {
        ...
        public final AsrOnlineChunk chunkFromPackage$calls_sdk_release(ParticipantStore participantStore, st stVar) {
            ParticipantId participantId = null;
            bg1 bg1 = stVar.a;
            ConversationParticipant byInternal = bg1 != null ? participantStore.getByInternal(bg1) : null;
            if (byInternal != null) {
                participantId = byInternal.getExternalId();
            }
            return new AsrOnlineChunk(participantId, stVar.b);
        }
