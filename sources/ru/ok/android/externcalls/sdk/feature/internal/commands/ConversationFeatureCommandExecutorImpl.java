...
public final class ConversationFeatureCommandExecutorImpl implements ConversationFeatureCommandExecutor {
    ...
    public final w61 paramsCreator = new Object();
    private final SignalingProvider signalingProvider;

    /* JADX WARNING: type inference failed for: r1v1, types: [w61, java.lang.Object] */
    ...
    private final JSONObject createParamsOrPassExceptionToOnError(m56 m56, k56 k56) {
        try {
            return (JSONObject) k56.invoke();
        } catch (JSONException e) {
            if (m56 == null) {
                return null;
            }
            m56.invoke(new ConversationFeatureException("Can't create params for the method", e));
            return null;
        }
    }

    /* access modifiers changed from: private */
    public static final void enableFeatureForRoles$lambda$0(k56 k56, JSONObject jSONObject) {
        if (k56 != null) {
            k56.invoke();
        }
    }
    ...
    /* access modifiers changed from: private */
    public static final void enableFeatureForRoles$lambda$1(m56 m56, JSONObject jSONObject) {
        if (m56 != null) {
            m56.invoke(new ConversationFeatureException("Command error " + jSONObject));
        }
    }

    public void enableFeatureForAll(u61 u61, k56 k56, m56 m56) {
        enableFeatureForRoles(u61, wz4.a, k56, m56);
    }

    public void enableFeatureForRoles(u61 u61, Set<? extends eg1> set, k56 k56, m56 m56) {
        JSONObject createParamsOrPassExceptionToOnError;
        rod rod = SignalingProviderKt.get(this.signalingProvider, m56);
        if (rod != null && (createParamsOrPassExceptionToOnError = createParamsOrPassExceptionToOnError(m56, new ConversationFeatureCommandExecutorImpl$enableFeatureForRoles$params$1(this, u61, set))) != null) {
            rod.j(createParamsOrPassExceptionToOnError, new mt(3, k56), new nt(3, m56));
        }
    }
}
