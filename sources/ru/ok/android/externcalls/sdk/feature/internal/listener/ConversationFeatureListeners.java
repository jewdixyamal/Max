...
public interface ConversationFeatureListeners {
    void addFeatureListener(u61 u61, ConversationFeatureManager.FeatureListener featureListener);

    FeatureRoles getFeatureRoles(u61 u61);

    boolean isFeatureEnabled(u61 u61);

    void removeFeatureListener(u61 u61, ConversationFeatureManager.FeatureListener featureListener);
}
