...
public final class ConversationFeatureManagerImpl implements ConversationFeatureManager, ConversationFeatureCommandExecutor, ConversationFeatureListeners {
    ...
    public void addFeatureListener(u61 u61, ConversationFeatureManager.FeatureListener featureListener) {
        this.featureListeners.addFeatureListener(u61, featureListener);
    }

    public void enableFeatureForAll(u61 u61, k56 k56, m56 m56) {
        this.commandExecutor.enableFeatureForAll(u61, k56, m56);
    }

    public void enableFeatureForRoles(u61 u61, Set<? extends eg1> set, k56 k56, m56 m56) {
        this.commandExecutor.enableFeatureForRoles(u61, set, k56, m56);
    }

    public FeatureRoles getFeatureRoles(u61 u61) {
        return this.featureListeners.getFeatureRoles(u61);
    }

    public boolean isFeatureEnabled(u61 u61) {
        return this.featureListeners.isFeatureEnabled(u61);
    }

    public void removeFeatureListener(u61 u61, ConversationFeatureManager.FeatureListener featureListener) {
        this.featureListeners.removeFeatureListener(u61, featureListener);
    }
}
