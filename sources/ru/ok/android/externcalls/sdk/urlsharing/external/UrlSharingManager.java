...
public interface UrlSharingManager {
    static /* synthetic */ void start$default(UrlSharingManager urlSharingManager, String str, k56 k56, m56 m56, int i, Object obj) {
        if (obj == null) {
            if ((i & 2) != 0) {
                k56 = null;
            }
            ...
            urlSharingManager.start(str, k56, m56);
            return;
        }
        throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: start");
    }

    static /* synthetic */ void stop$default(UrlSharingManager urlSharingManager, k56 k56, m56 m56, int i, Object obj) {
        if (obj == null) {
            if ((i & 1) != 0) {
                k56 = null;
            }
            ...
            urlSharingManager.stop(k56, m56);
            return;
        }
    ...
    void start(String str, k56 k56, m56 m56);

    void stop(k56 k56, m56 m56);
}
