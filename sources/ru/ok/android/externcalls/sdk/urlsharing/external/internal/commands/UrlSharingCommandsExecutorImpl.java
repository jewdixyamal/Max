...
public final class UrlSharingCommandsExecutorImpl implements UrlSharingCommandsExecutor {
    ...
    public static final void start$lambda$0(k56 k56, JSONObject jSONObject) {
        if (k56 != null) {
            k56.invoke();
        }
    }
    ...
    /* access modifiers changed from: private */
    public static final void start$lambda$1(m56 m56, JSONObject jSONObject) {
        if (m56 != null) {
            m56.invoke(new RuntimeException("Start url sharing error " + jSONObject));
        }
    }
    ...
    /* access modifiers changed from: private */
    public static final void stop$lambda$3(m56 m56, JSONObject jSONObject) {
        if (m56 != null) {
            m56.invoke(new RuntimeException("Stop url sharing error " + jSONObject));
        }
    }

    public void start(String str, k56 k56, m56 m56) {
        ...
        if (signalingOrPassExceptionToOnError != null) {
            ...
            signalingOrPassExceptionToOnError.j(jSONObject, new mt(16, k56), new nt(10, m56));
        }
    }

    public void stop(k56 k56, m56 m56) {
        rod signalingOrPassExceptionToOnError = getSignalingOrPassExceptionToOnError(m56);
        if (signalingOrPassExceptionToOnError != null) {
            JSONObject jSONObject = new JSONObject();
            jSONObject.put("command", (Object) "stop-url-sharing");
            signalingOrPassExceptionToOnError.j(jSONObject, new mt(17, k56), new nt(11, m56));
        }
    }
}
