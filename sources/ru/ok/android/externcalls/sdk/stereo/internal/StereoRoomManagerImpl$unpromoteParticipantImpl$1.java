...
public final class StereoRoomManagerImpl$unpromoteParticipantImpl$1 extends rd7 implements m56 {
    final /* synthetic */ m56 $onError;
    final /* synthetic */ k56 $onSuccess;
    final /* synthetic */ StereoRoomManagerImpl this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public StereoRoomManagerImpl$unpromoteParticipantImpl$1(StereoRoomManagerImpl stereoRoomManagerImpl, k56 k56, m56 m56) {
        super(1);
    ...
    public final void invoke(bg1 bg1) {
        this.this$0.commandExecutor.promoteParticipant(new StereoRoomCommandExecutor.PromoteParticipantParams(bg1, false), this.$onSuccess, this.$onError);
    }
}
