...
public interface StereoRoomCommandExecutor {
    ...
    public static final class PromoteParticipantParams {
        ...
        public PromoteParticipantParams(bg1 bg1, boolean z) {
            this.participantId = bg1;
            this.promote = z;
        }

        public static /* synthetic */ PromoteParticipantParams copy$default(PromoteParticipantParams promoteParticipantParams, bg1 bg1, boolean z, int i, Object obj) {
            if ((i & 1) != 0) {
                bg1 = promoteParticipantParams.participantId;
            }
            if ((i & 2) != 0) {
                z = promoteParticipantParams.promote;
            }
            return promoteParticipantParams.copy(bg1, z);
        }
        ...
        public final PromoteParticipantParams copy(bg1 bg1, boolean z) {
            return new PromoteParticipantParams(bg1, z);
        }
        ...
        public String toString() {
            bg1 bg1 = this.participantId;
            boolean z = this.promote;
            return "PromoteParticipantParams(participantId=" + bg1 + ", promote=" + z + ")";
        }
    }
    ...
    void acceptPromotion(AcceptPromotionParams acceptPromotionParams, k56 k56, m56 m56);

    void getHandsQueue(c66 c66, m56 m56);

    void promoteParticipant(PromoteParticipantParams promoteParticipantParams, k56 k56, m56 m56);

    void requestPromotion(RequestPromotionParams requestPromotionParams, k56 k56, m56 m56);
}
