...
public final class SessionRoomParticipants {
    ...
    public static final class Participant {
        ...
        public Participant(ParticipantId participantId, zad zad, ConversationParticipant conversationParticipant) {
            this.id = participantId;
            this.actualRoomId = zad;
    ...
    public SessionRoomParticipants(zad zad, Collection<Participant> collection) {
        this.roomId = zad;
