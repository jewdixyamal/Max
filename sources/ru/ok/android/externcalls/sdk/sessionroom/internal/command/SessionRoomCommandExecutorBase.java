...
public class SessionRoomCommandExecutorBase {
    public final void parseErrorResponse(String str, JSONObject jSONObject, m56 m56) {
        Object obj;
        if (m56 != null) {
            String optString = jSONObject.optString("error");
            if (tpa.f(optString, "rooms.roomInactive")) {
                obj = new SessionRoomInactiveException();
            } else if (tpa.f(optString, "rooms.notAdmin")) {
                obj = new SessionRoomNotAdminException();
            } else {
                obj = new SessionRoomException("Error response for " + str + " command " + jSONObject, (Throwable) null, 2, (z84) null);
            }
            m56.invoke(obj);
        }
    }
