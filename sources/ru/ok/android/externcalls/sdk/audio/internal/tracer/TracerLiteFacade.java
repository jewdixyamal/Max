...
public final class TracerLiteFacade {
    ...
    private final je7 crashReport$delegate = new khe(new TracerLiteFacade$crashReport$2(this));
    private final je7 tracerLite$delegate;
    ...
    public TracerLiteFacade(Context context) {
        this.tracerLite$delegate = new khe(new TracerLiteFacade$tracerLite$2(context));
    }

    private final qye getCrashReport() {
        return (qye) this.crashReport$delegate.getValue();
    }

    /* access modifiers changed from: private */
    public final wye getTracerLite() {
        return (wye) this.tracerLite$delegate.getValue();
    }
