...
public final class MicrophoneManagerImpl implements MicrophoneManager {
    ...
    public MicrophoneManagerImpl(py0 py0, k56 k56) {
        this.call = py0;
        this.isPrepared = k56;
    }
    ...
    public void registerAudioSampleCallback(long j, z99 z99) {
        qld qld = this.call.k1;
        qld.getClass();
        qld.a.execute(new tb2((Object) qld, (Object) z99, j, 6));
    }

    public void removeAudioSampleCallback(z99 z99) {
        qld qld = this.call.k1;
        qld.getClass();
        qld.a.execute(new flc(qld, 17, z99));
    }
