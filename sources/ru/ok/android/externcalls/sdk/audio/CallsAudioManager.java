...
public interface CallsAudioManager {
    ...
    public enum AudioDeviceType {
        ...
        public final boolean oneOf(AudioDeviceType... audioDeviceTypeArr) {
            return ys.T(audioDeviceTypeArr, this);
        }
    }
    ...
    static /* synthetic */ void changeStateAsync$default(CallsAudioManager callsAudioManager, State state, k56 k56, m56 m56, int i, Object obj) {
        if (obj == null) {
            if ((i & 2) != 0) {
                k56 = null;
            }
            ...
            callsAudioManager.changeStateAsync(state, k56, m56);
            return;
        }
    ...
    static /* synthetic */ void releaseAsync$default(CallsAudioManager callsAudioManager, k56 k56, m56 m56, int i, Object obj) {
        if (obj == null) {
            if ((i & 1) != 0) {
                k56 = null;
            }
            ...
            callsAudioManager.releaseAsync(k56, m56);
            return;
        }
    ...
    static /* synthetic */ void setAudioDeviceAsync$default(CallsAudioManager callsAudioManager, CallsAudioDeviceInfo callsAudioDeviceInfo, k56 k56, m56 m56, int i, Object obj) {
        if (obj == null) {
            if ((i & 2) != 0) {
                k56 = null;
            }
            ...
            callsAudioManager.setAudioDeviceAsync(callsAudioDeviceInfo, k56, m56);
            return;
        }
    ...
    static /* synthetic */ void setAudioDeviceTypeAsync$default(CallsAudioManager callsAudioManager, AudioDeviceType audioDeviceType, k56 k56, m56 m56, int i, Object obj) {
        if (obj == null) {
            if ((i & 2) != 0) {
                k56 = null;
            }
            ...
            callsAudioManager.setAudioDeviceTypeAsync(audioDeviceType, k56, m56);
            return;
        }
    ...
    static /* synthetic */ void setSpeakerEnabledAsync$default(CallsAudioManager callsAudioManager, boolean z, boolean z2, k56 k56, m56 m56, int i, Object obj) {
        if (obj == null) {
            if ((i & 2) != 0) {
                z2 = false;
            }
            ...
            callsAudioManager.setSpeakerEnabledAsync(z, z2, k56, m56);
            return;
        }
    ...
    void changeStateAsync(State state, k56 k56, m56 m56);

    List<CallsAudioDeviceInfo> getAvailableAudioDevices();

    CallsAudioDeviceInfo getCurrentDevice();

    void hasBluetoothHeadsetAsync(m56 m56, m56 m562);

    void hasWiredHeadsetAsync(m56 m56, m56 m562);

    boolean isHeadsetConnected();

    void notifyBluetoothPermissionGranted();

    void releaseAsync(k56 k56, m56 m56);

    void requestAudioFocusAsync();

    void setAudioDeviceAsync(CallsAudioDeviceInfo callsAudioDeviceInfo, k56 k56, m56 m56);

    void setAudioDeviceTypeAsync(AudioDeviceType audioDeviceType, k56 k56, m56 m56);

    void setOnAudioDeviceChangeListener(OnAudioDeviceInfoChangeListener onAudioDeviceInfoChangeListener);

    void setSpeakerEnabledAsync(boolean z, boolean z2, k56 k56, m56 m56);
}
