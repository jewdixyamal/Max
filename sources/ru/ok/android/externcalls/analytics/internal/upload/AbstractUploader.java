...
public abstract class AbstractUploader implements Uploader {
    ...
    /* access modifiers changed from: private */
    public static final String sdkVersionString = "125.1.0.48.3";
    ...
    public static final class Companion {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:6:0x0014, code lost:
            r0 = (java.lang.String) (r0 = (r0 = r0.getEventMetaParams()).getAppName()).invoke();
         */
    ...
    private final void executeApiMethod(uk ukVar, String str, sr0 sr0) throws IOException, ApiException {
        Companion companion = Companion;
        try {
            ukVar.a(new CallAnalyticsApiRequest(str, companion.getPlatformParam(), companion.getApplicationVersionParams(), SDK_TYPE_STRING, sdkVersionString, 1, sr0, CallAnalyticsConfigStorage.INSTANCE.getLogger()));
    ...
    /* access modifiers changed from: private */
    public final UploadResult uploadFileWithContent(uk ukVar, File file) throws ApiInvocationException, IOException {
        try {
            long currentTimeMillis = System.currentTimeMillis();
            executeApiMethod(ukVar, this.collector, new StreamingItemsApiValue(file, this.isContentCompressed));
    ...
    public final <T> T withLock(k56 k56) {
        try {
            this.lock.lock();
            return k56.invoke();
        } finally {
