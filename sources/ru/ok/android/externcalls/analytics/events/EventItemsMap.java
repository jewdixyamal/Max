...
public final class EventItemsMap {
    ...
    public final EventItemsMap set(String str, String str2) {
        if (str2 != null) {
            this.items.put(str, EventItemValue.StringValue.m110boximpl(EventItemValue.StringValue.m111constructorimpl(str2)));
        }
        return this;
    }
    ...
    public final EventItemsMap set(String str, Integer num) {
        if (num != null) {
            this.items.put(str, EventItemValue.IntValue.m96boximpl(EventItemValue.IntValue.m97constructorimpl(num.intValue())));
        }
        return this;
    }
    ...
    public final EventItemsMap set(String str, Long l) {
        if (l != null) {
            this.items.put(str, EventItemValue.LongValue.m103boximpl(EventItemValue.LongValue.m104constructorimpl(l.longValue())));
        }
        return this;
    }
    ...
    public final EventItemsMap set(String str, Float f) {
        if (f != null) {
            this.items.put(str, EventItemValue.FloatValue.m89boximpl(EventItemValue.FloatValue.m90constructorimpl(f.floatValue())));
        }
        return this;
    }
}
