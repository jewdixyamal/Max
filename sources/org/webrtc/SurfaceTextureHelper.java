...
public class SurfaceTextureHelper {
    ...
    public void dispose() {
        ...
        ThreadUtils.invokeAtFrontUninterruptibly(this.handler, (Runnable) new tee(this, 1));
    }
    ...
    public void stopListening() {
        ...
        ThreadUtils.invokeAtFrontUninterruptibly(this.handler, (Runnable) new tee(this, 0));
    }
    ...
    private SurfaceTextureHelper(EglBase.Context context, Handler handler2, boolean z, YuvConverter yuvConverter2, FrameRefMonitor frameRefMonitor2, FrameGeometryAdjuster frameGeometryAdjuster) {
        ...
        if (handler2.getLooper().getThread() == Thread.currentThread()) {
            ...
            try {
                ...
                surfaceTexture2.setOnFrameAvailableListener(new wsc(1, this), handler2);
