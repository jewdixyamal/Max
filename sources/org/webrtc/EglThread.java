...
public class EglThread implements RenderSynchronizer.Listener {
    ...
    public static EglThread create(ReleaseMonitor releaseMonitor2, EglBase.Context context, int[] iArr, RenderSynchronizer renderSynchronizer2) {
        ...
        EglBase.EglConnection eglConnection2 = (EglBase.EglConnection) ThreadUtils.invokeAtFrontUninterruptibly((Handler) handlerWithExceptionCallbacks, new u24(context, 2, iArr));
        if (releaseMonitor2 == null) {
            releaseMonitor2 = new ta4(9);
        }
    ...
    public void release() {
        if (this.releaseMonitor.onRelease(this)) {
            ...
            handlerWithExceptionCallbacks.post(new dd4(13, eglConnection2));
