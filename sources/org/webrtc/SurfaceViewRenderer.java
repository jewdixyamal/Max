...
public class SurfaceViewRenderer extends SurfaceView implements SurfaceHolder.Callback, VideoSink, RendererCommon.RendererEvents {
    ...
    private void updateSurfaceSize() {
        ...
        StringBuilder j = wg0.j("updateSurfaceSize. Layout size: ", width2, "x", height, ", frame size: ");
        ms2.k(j, i3, "x", i4, ", requested surface size: ");
        ms2.k(j, min, "x", min2, ", old surface size: ");
        j.append(i5);
        j.append("x");
        j.append(i6);
        logD(j.toString());
    ...
    public void onMeasure(int i, int i2) {
        ...
        logD(rh4.h("onMeasure(). New size: ", measure.x, measure.y, "x"));
    }
