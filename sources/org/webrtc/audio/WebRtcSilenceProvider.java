...
class WebRtcSilenceProvider {
    ...
    public static class Statistics {
        ...
        public void trackRead(long j, long j2, long j3) {
            ...
            if (j5 > j6) {
                ...
                StringBuilder k = au1.k(j6, "Log interval: ", "ns, log delta: ");
                k.append(j5);
                k.append("ns, reads: ");
                k.append(i2);
                au1.q(millis, ", read time: ", "ms, suspend time: ", k);
                k.append(j7);
                k.append("ms");
                Logging.d(WebRtcSilenceProvider.TAG, k.toString());
                reset();
            }
        }
    ...
    public WebRtcSilenceProvider(int i, int i2, int i3, int i4, int i5, byte[] bArr) {
        ...
        StringBuilder j = wg0.j("Silence provider initialized, sampleRate=", i2, ", framesPerBuffer=", i4, ", bufferDuration=");
        j.append(millis);
        j.append("ms, bufferCapacity=");
        j.append(length);
        Logging.d(TAG, j.toString());
    }
