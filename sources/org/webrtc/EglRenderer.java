...
public class EglRenderer implements VideoSink {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:19:0x002f, code lost:
        if (r1 != Long.MAX_VALUE) goto L_0x0033;
     */
    ...
    private void swapBuffersOnRenderThread(VideoFrame videoFrame, long j) {
        synchronized (this.threadLock) {
            try {
                EglThread eglThread2 = this.eglThread;
                if (eglThread2 != null) {
                    eglThread2.scheduleRenderUpdate(new yv4(this, videoFrame, j));
                }
            } catch (Throwable th) {
                throw th;
            }
    ...
    public void onFrame(org.webrtc.VideoFrame r7) {
        ...
        L_0x002c:
            ...
            dd4 r3 = new dd4     // Catch:{ all -> 0x002a }
            r5 = 12
    ...
    public void release() {
        ...
        L_0x001b:
            ...
            org.webrtc.EglThread r2 = r5.eglThread     // Catch:{ all -> 0x0019 }
            android.os.Handler r2 = r2.getHandler()     // Catch:{ all -> 0x0019 }
            kl4 r3 = new kl4     // Catch:{ all -> 0x0019 }
            r4 = 6
            r3.<init>((java.lang.Object) r5, (int) r4, (java.lang.Object) r0)     // Catch:{ all -> 0x0019 }
            ...
            monitor-enter(r0)
            org.webrtc.VideoFrame r1 = r5.pendingFrame     // Catch:{ all -> 0x0053 }
            if (r1 == 0) goto L_0x0055
            r1.release()     // Catch:{ all -> 0x0053 }
            r5.pendingFrame = r2     // Catch:{ all -> 0x0053 }
            goto L_0x0055
        L_0x0053:
            r5 = move-exception
            goto L_0x005c
        ...
        synchronized (this.threadLock) {
            try {
                ...
                if (eglThread2 != null) {
                    ...
                    this.eglThread.getHandler().postAtFrontOfQueue(new kl4((Object) this, 5, (Object) runnable));
                    return;
                }
                runnable.run();
            } catch (Throwable th) {
            ...
            try {
                if (this.eglThread != null) {
                    if (Thread.currentThread() != this.eglThread.getHandler().getLooper().getThread()) {
                        postToRenderThread(new f5((Object) this, (Object) countDownLatch, (Object) frameListener, 26));
    ...
    public void clearImage(float f, float f2, float f3, float f4) {
        synchronized (this.threadLock) {
            try {
                EglThread eglThread2 = this.eglThread;
                if (eglThread2 != null) {
                    eglThread2.getHandler().postAtFrontOfQueue(new xv4(this, f, f2, f3, f4));
                }
            } catch (Throwable th) {
                throw th;
            }
    ...
    public void addFrameListener(FrameListener frameListener, float f, RendererCommon.GlDrawer glDrawer, boolean z) {
        postToRenderThread(new wv4(this, glDrawer, frameListener, f, z));
    }
