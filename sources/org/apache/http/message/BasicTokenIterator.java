        ...
        if (i >= 0) {
            ...
            while (!z && i < length) {
                ...
                if (isTokenSeparator(charAt)) {
                    ...
                    StringBuilder n = rh4.n(i, "Tokens without separator (pos ", "): ");
                    n.append(this.currentHeader);
                    throw new ParseException(n.toString());
                } else {
                    StringBuilder n2 = rh4.n(i, "Invalid character after token (pos ", "): ");
                    n2.append(this.currentHeader);
            ...
            while (!z) {
                ...
                while (!z && i < length) {
                    ...
                    if (isTokenSeparator(charAt) || isWhitespace(charAt)) {
                        ...
                        StringBuilder n = rh4.n(i, "Invalid character before token (pos ", "): ");
                        n.append(this.currentHeader);
                        throw new ParseException(n.toString());
                    }
                }
