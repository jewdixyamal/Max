...
public class DefaultRequestDirector implements RequestDirector {
    ...
    public HttpRoute determineRoute(HttpHost httpHost, HttpRequest httpRequest, HttpContext httpContext) throws HttpException {
        ...
        StringBuilder k = k7d.k("Target host must not be null, or set in parameters. scheme=", str2, ", host=", str, ", path=");
        k.append(str3);
        ...
        do {
            ...
            switch (nextStep) {
                ...
                case 5:
                    ...
                    continue;
                default:
                    throw new IllegalStateException(wg0.g(nextStep, "Unknown step indicator ", " from RouteDirector."));
            }
        } while (nextStep > 0);
    }
