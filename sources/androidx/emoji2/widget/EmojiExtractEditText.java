    ...
    public EmojiExtractEditText(Context context, AttributeSet attributeSet) {
        ...
        if (!this.b) {
            ...
            if (attributeSet != null) {
                TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, l3c.EmojiEditText, 16842862, 0);
                int integer = obtainStyledAttributes.getInteger(l3c.EmojiEditText_maxEmojiCount, Integer.MAX_VALUE);
