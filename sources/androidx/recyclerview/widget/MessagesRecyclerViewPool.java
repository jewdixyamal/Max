...
public final class MessagesRecyclerViewPool extends b {
    public static final o79 Companion = new Object();
    ...
    private final udc getScrapDataForType(int i) {
        int i2 = i & -2013265921;
        udc udc = this.mScrap.get(i2);
        if (udc != null) {
            return udc;
        }
        udc udc2 = new udc();
        this.mScrap.put(i2, udc2);
        return udc2;
    }
    ...
    public dec getRecycledView(int i) {
        int i2;
        udc udc = this.mScrap.get(i & -2013265921);
        if (udc == null) {
            return null;
        }
        ...
        while (true) {
            int i3 = i2 - 1;
            if (!((dec) arrayList.get(i2)).l()) {
                dec dec = (dec) arrayList.remove(i2);
                boolean z = dec instanceof qy8;
                return dec;
            } else if (i3 < 0) {
                return null;
            } else {
    ...
    public void putRecycledView(dec dec) {
        ArrayList arrayList = getScrapDataForType(dec.Y).a;
        if (this.mScrap.get(dec.Y & -2013265921).b <= arrayList.size()) {
            hm9.m0("MessagesRecyclerViewPool", "could not add " + dec, new Object[0]);
            return;
        }
        dec.u();
        if (dec instanceof qy8) {
            qy8 qy8 = (qy8) dec;
        }
        arrayList.add(dec);
    }
