...
public class GridLayoutManager extends LinearLayoutManager {
    ...
    public final void M0(zdc zdc, uh7 uh7, b23 b23) {
        int i = this.F;
        for (int i2 = 0; i2 < this.F && (r3 = uh7.d) >= 0 && r3 < zdc.b() && i > 0; i2++) {
            int i3 = uh7.d;
            b23.b(i3, Math.max(0, uh7.g));
            i -= this.K.c(i3);
            uh7.d += uh7.e;
        }
    }

    public final int O(vdc vdc, zdc zdc) {
        if (this.p == 0) {
            return this.F;
        }
        if (zdc.b() < 1) {
    ...
    public final void b0(vdc vdc, zdc zdc, View view, l4 l4Var) {
        ...
        jg6 jg6 = (jg6) layoutParams;
        int w1 = w1(jg6.a.i(), vdc, zdc);
        if (this.p == 0) {
            l4Var.i(k4.a(false, jg6.X, jg6.Y, w1, 1));
        } else {
            l4Var.i(k4.a(false, w1, 1, jg6.X, jg6.Y));
        }
    }

    public final View b1(vdc vdc, zdc zdc, boolean z, boolean z2) {
        int i;
        int i2;
        int w = w();
        int i3 = 1;
        ...
        while (i2 != i) {
            View v = v(i2);
            int M = a.M(v);
            if (M >= 0 && M < b && x1(M, vdc, zdc) == 0) {
                if (((pdc) v.getLayoutParams()).a.p()) {
                    if (view2 == null) {
                        view2 = v;
                    }
    ...
    public final void h1(vdc vdc, zdc zdc, uh7 uh7, th7 th7) {
        int i;
        int i2;
        int i3;
        int i4;
        ...
        int i15 = this.F;
        if (!z3) {
            i15 = x1(uh72.d, vdc2, zdc2) + y1(uh72.d, vdc2, zdc2);
        }
        int i16 = 0;
        while (i16 < this.F && (r14 = uh72.d) >= 0 && r14 < zdc.b() && i15 > 0) {
            int i17 = uh72.d;
            int y1 = y1(i17, vdc2, zdc2);
            if (y1 <= this.F) {
                i15 -= y1;
                if (i15 < 0 || (b = uh72.b(vdc2)) == null) {
                    break;
                }
                this.H[i16] = b;
                i16++;
            } else {
                throw new IllegalArgumentException(zr6.j(wg0.j("Item at position ", i17, " requires ", y1, " spans but GridLayoutManager has only "), this.F, " spans."));
            }
        }
        if (i16 == 0) {
            th72.b = true;
        ...
        while (i3 != i2) {
            View view = this.H[i3];
            jg6 jg6 = (jg6) view.getLayoutParams();
            int y12 = y1(a.M(view), vdc2, zdc2);
            jg6.Y = y12;
            jg6.X = i18;
            i18 += y12;
            i3 += i;
        ...
        for (int i20 = 0; i20 < i16; i20++) {
            ...
            float e = (((float) this.r.e(view2)) * 1.0f) / ((float) ((jg6) view2.getLayoutParams()).Y);
            if (e > f) {
                f = e;
            }
        }
        ...
        for (int i22 = 0; i22 < i16; i22++) {
            ...
            if (this.r.d(view4) != i19) {
                jg6 jg62 = (jg6) view4.getLayoutParams();
                Rect rect = jg62.b;
                int i23 = rect.top + rect.bottom + jg62.topMargin + jg62.bottomMargin;
                int i24 = rect.left + rect.right + jg62.leftMargin + jg62.rightMargin;
                int v1 = v1(jg62.X, jg62.Y);
                if (this.p == 1) {
                    i13 = a.x(false, v1, 1073741824, i24, jg62.width);
                    ...
                    i12 = a.x(false, v1, 1073741824, i23, jg62.height);
                    i13 = makeMeasureSpec;
                }
                if (H0(view4, i13, i12, (pdc) view4.getLayoutParams())) {
        ...
        while (i25 < i16) {
            ...
            jg6 jg63 = (jg6) view5.getLayoutParams();
            if (this.p != 1) {
                int L2 = L() + this.G[jg63.X];
                i11 = i7;
                i10 = i6;
                i9 = L2;
                i8 = this.r.e(view5) + L2;
            } else if (g1()) {
                int J2 = J() + this.G[this.F - jg63.X];
                i10 = J2;
                i9 = i5;
                i8 = i4;
                i11 = J2 - this.r.e(view5);
            } else {
                int J3 = J() + this.G[jg63.X];
            ...
            if (jg63.a.p() || jg63.a.s()) {
                th72.c = true;
            }
            th72.d |= view5.hasFocusable();
            i25++;
            i7 = i11;
            i6 = i10;
            i5 = i9;
    ...
    public final void i1(vdc vdc, zdc zdc, b85 b85, int i) {
        B1();
        if (zdc.b() > 0 && !zdc.h) {
            boolean z = i == 1;
            int x1 = x1(b85.b, vdc, zdc);
            if (z) {
                while (x1 > 0) {
                    int i2 = b85.b;
                    if (i2 <= 0) {
    ...
    public final void j0(vdc vdc, zdc zdc) {
        ...
        if (z) {
            int w = w();
            for (int i = 0; i < w; i++) {
                jg6 jg6 = (jg6) v(i).getLayoutParams();
                int i2 = jg6.a.i();
                sparseIntArray2.put(i2, jg6.Y);
                sparseIntArray.put(i2, jg6.X);
            }
        }
        super.j0(vdc, zdc);
    ...
    /* JADX WARNING: type inference failed for: r0v1, types: [jg6, pdc] */
    ...
    /* JADX WARNING: type inference failed for: r2v2, types: [jg6, pdc] */
    /* JADX WARNING: type inference failed for: r2v3, types: [jg6, pdc] */
    public pdc u(ViewGroup.LayoutParams layoutParams) {
        if (layoutParams instanceof ViewGroup.MarginLayoutParams) {
            ? pdc = new pdc((ViewGroup.MarginLayoutParams) layoutParams);
            pdc.X = -1;
            pdc.Y = 0;
            return pdc;
        }
        ? pdc2 = new pdc(layoutParams);
        pdc2.X = -1;
        pdc2.Y = 0;
        return pdc2;
    }
    ...
    public final int w1(int i, vdc vdc, zdc zdc) {
        if (!zdc.h) {
    ...
    public final int x0(int i, vdc vdc, zdc zdc) {
        B1();
        u1();
        return super.x0(i, vdc, zdc);
    }

    public final int x1(int i, vdc vdc, zdc zdc) {
        if (!zdc.h) {
    ...
    public final int y(vdc vdc, zdc zdc) {
        if (this.p == 1) {
            return this.F;
        }
        if (zdc.b() < 1) {
    ...
    public final int y1(int i, vdc vdc, zdc zdc) {
        if (!zdc.h) {
            return this.K.c(i);
        }
    ...
    public final void z1(int i, View view, boolean z) {
        ...
        jg6 jg6 = (jg6) view.getLayoutParams();
        Rect rect = jg6.b;
        int i4 = rect.top + rect.bottom + jg6.topMargin + jg6.bottomMargin;
        int i5 = rect.left + rect.right + jg6.leftMargin + jg6.rightMargin;
        int v1 = v1(jg6.X, jg6.Y);
        if (this.p == 1) {
            i2 = a.x(false, v1, i, i5, jg6.width);
            i3 = a.x(true, this.r.n(), this.m, i4, jg6.height);
        } else {
            int x = a.x(false, v1, i, i4, jg6.height);
            int x2 = a.x(true, this.r.n(), this.l, i5, jg6.width);
            i3 = x;
            i2 = x2;
        }
        pdc pdc = (pdc) view.getLayoutParams();
        if (z ? H0(view, i2, i3, pdc) : F0(view, i2, i3, pdc)) {
            view.measure(i2, i3);
        }
    }
