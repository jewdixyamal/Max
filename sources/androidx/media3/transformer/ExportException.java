...
public final class ExportException extends Exception {
    ...
    /* JADX WARNING: type inference failed for: r0v0, types: [jn, iw6] */
    static {
        ? jnVar = new jn(4);
        jnVar.J("ERROR_CODE_FAILED_RUNTIME_CHECK", Integer.valueOf(MultiFileUploader.MSG_TRY_UPLOAD_NEXT));
    ...
    public static ExportException b(AudioProcessor$UnhandledAudioFormatException audioProcessor$UnhandledAudioFormatException, String str) {
        StringBuilder m = au1.m("Audio error: ", str, ", audioFormat=");
    ...
    public static ExportException c(Throwable th, int i, qh3 qh3) {
        return new ExportException("Codec exception: " + qh3, th, i);
    }
