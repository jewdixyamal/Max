...
public abstract class a implements ComponentCallbacks, View.OnCreateContextMenuListener, eh7, ynf, pi6, isc {
    ...
    /* JADX WARNING: type inference failed for: r0v4, types: [n16, androidx.fragment.app.c] */
    /* JADX WARNING: type inference failed for: r0v8, types: [ci9, xm7] */
    public a() {
        new re(23, this);
        this.c1 = fg7.X;
        this.f1 = new xm7();
    ...
    public LayoutInflater C0(Bundle bundle) {
        ...
        if (z06 != null) {
            ...
            cloneInContext.setFactory2(this.H0.f);
    ...
    public final void F0(AttributeSet attributeSet, Bundle bundle) {
        this.S0 = true;
        z06 z06 = this.G0;
        Activity activity = z06 == null ? null : z06.t0;
        if (activity != null) {
            this.S0 = false;
    ...
    public final LayoutInflater R0() {
        LayoutInflater C02 = C0((Bundle) null);
        this.Z0 = C02;
        return C02;
    }
    ...
    public void Z(String str, FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
        ...
        w06 w06 = this.X0;
        printWriter.println(w06 == null ? false : w06.a);
        w06 w062 = this.X0;
        if ((w062 == null ? 0 : w062.b) != 0) {
            printWriter.print(str);
            printWriter.print("getEnterAnim=");
            w06 w063 = this.X0;
            printWriter.println(w063 == null ? 0 : w063.b);
        }
        w06 w064 = this.X0;
        if ((w064 == null ? 0 : w064.c) != 0) {
            printWriter.print(str);
            printWriter.print("getExitAnim=");
            w06 w065 = this.X0;
            printWriter.println(w065 == null ? 0 : w065.c);
        }
        w06 w066 = this.X0;
        if ((w066 == null ? 0 : w066.d) != 0) {
            printWriter.print(str);
            printWriter.print("getPopEnterAnim=");
            w06 w067 = this.X0;
            printWriter.println(w067 == null ? 0 : w067.d);
        }
        w06 w068 = this.X0;
        if ((w068 == null ? 0 : w068.e) != 0) {
            printWriter.print(str);
        ...
        if (d0() != null) {
            new b(this, w()).a(str, printWriter);
        }
        printWriter.print(str);
    ...
    /* JADX WARNING: type inference failed for: r0v1, types: [java.lang.Object, w06] */
    public final w06 a0() {
        if (this.X0 == null) {
            ? obj = new Object();
            Object obj2 = k1;
    ...
    public final void a1() {
        t16 t16 = u16.a;
        u16.b(new Violation(this, "Attempting to set retain instance for fragment " + this));
        u16.a(this).getClass();
        this.O0 = true;
        c cVar = this.F0;
        if (cVar != null) {
    ...
    public final void b1(int i, a aVar) {
        if (aVar != null) {
            t16 t16 = u16.a;
            u16.b(new Violation(this, "Attempting to set target fragment " + aVar + " with request code " + i + " for fragment " + this));
            u16.a(this).getClass();
        }
        c cVar = this.F0;
    ...
    public void c1(boolean z) {
        t16 t16 = u16.a;
        u16.b(new Violation(this, "Attempting to set user visible hint to " + z + " for fragment " + this));
        u16.a(this).getClass();
        boolean z2 = false;
    ...
    public final void d1(Intent intent, int i, Bundle bundle) {
        if (this.G0 != null) {
            ...
            z06 z06 = f0.w;
            if (i == -1) {
                z06.u0.startActivity(intent, bundle);
            } else {
                z06.getClass();
    ...
    public final int e0() {
        fg7 fg7 = this.c1;
        return (fg7 == fg7.b || this.I0 == null) ? fg7.ordinal() : Math.min(fg7.ordinal(), this.I0.e0());
    }
    ...
    public final a i0(boolean z) {
        ...
        if (z) {
            t16 t16 = u16.a;
            u16.b(new Violation(this, "Attempting to get target fragment from fragment " + this));
            u16.a(this).getClass();
        }
        a aVar = this.s0;
        if (aVar != null) {
    ...
    public final int j0() {
        t16 t16 = u16.a;
        u16.b(new Violation(this, "Attempting to get target request code from fragment " + this));
        u16.a(this).getClass();
        return this.u0;
    }
    ...
    public final void m0() {
        ...
        this.h1 = new td((isc) this);
        Bundle bundle = null;
        this.g1 = null;
        ArrayList arrayList = this.i1;
        u06 u06 = this.j1;
        if (arrayList.contains(u06)) {
            return;
        }
        if (this.a >= 0) {
            a aVar = u06.a;
    ...
    /* JADX WARNING: type inference failed for: r2v0, types: [n16, androidx.fragment.app.c] */
    ...
    public final boolean p0() {
        if (!this.M0) {
            ...
            a aVar = this.I0;
            cVar.getClass();
            return aVar == null ? false : aVar.p0();
        }
    }
    ...
    public final void startActivity(Intent intent) {
        z06 z06 = this.G0;
        if (z06 != null) {
            z06.u0.startActivity(intent, (Bundle) null);
            return;
        }
        throw new IllegalStateException(rh4.i("Fragment ", this, " not attached to Activity"));
    }
    ...
    public final xnf w() {
        if (this.F0 == null) {
            ...
            HashMap hashMap = this.F0.O.d;
            xnf xnf = (xnf) hashMap.get(this.Y);
            if (xnf != null) {
                return xnf;
            }
            xnf xnf2 = new xnf();
            hashMap.put(this.Y, xnf2);
            return xnf2;
        } else {
