...
public class FileProvider extends ContentProvider {
    ...
    public static qi5 e(int i, Context context, String str) {
        qi5 qi5 = new qi5(str);
                    ...
                    if (next == 2) {
                        ...
                        if (file != null) {
                            ...
                            if (!TextUtils.isEmpty(attributeValue)) {
                                try {
                                    qi5.b.put(attributeValue, file.getCanonicalFile());
                                } catch (IOException e) {
