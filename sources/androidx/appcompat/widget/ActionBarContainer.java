...
public class ActionBarContainer extends FrameLayout {
    ...
    public ActionBarContainer(Context context, AttributeSet attributeSet) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, p3c.ActionBar);
        this.o = obtainStyledAttributes.getDrawable(p3c.ActionBar_background);
        this.s0 = obtainStyledAttributes.getDrawable(p3c.ActionBar_backgroundStacked);
        this.w0 = obtainStyledAttributes.getDimensionPixelSize(p3c.ActionBar_height, -1);
        boolean z = true;
        if (getId() == mvb.split_action_bar) {
            this.u0 = true;
            this.t0 = obtainStyledAttributes.getDrawable(p3c.ActionBar_backgroundSplit);
        }
    ...
    public void setTabContainer(hxc hxc) {
    }
