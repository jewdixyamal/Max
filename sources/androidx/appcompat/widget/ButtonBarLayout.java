...
public class ButtonBarLayout extends LinearLayout {
    ...
    public ButtonBarLayout(Context context, AttributeSet attributeSet) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, p3c.ButtonBarLayout);
        int[] iArr = p3c.ButtonBarLayout;
        WeakHashMap weakHashMap = zmf.a;
        umf.d(this, context, iArr, attributeSet, obtainStyledAttributes, 0, 0);
        this.a = obtainStyledAttributes.getBoolean(p3c.ButtonBarLayout_allowStacking, true);
    ...
    private void setStacked(boolean z) {
        ...
        if (!z || this.a) {
            ...
            View findViewById = findViewById(mvb.spacer);
