...
public class ActionBarContextView extends ViewGroup {
    ...
    public ActionBarContextView(android.content.Context r6, android.util.AttributeSet r7) {
        /*
            r5 = this;
            int r0 = defpackage.vsb.actionModeStyle
            r5.<init>(r6, r7, r0)
            w r1 = new w
            r1.<init>()
            r1.c = r5
            ...
            int r3 = defpackage.vsb.actionBarPopupTheme
            r4 = 1
        ...
        L_0x0031:
            r5.b = r6
        L_0x0033:
            int[] r1 = defpackage.p3c.ActionMode
            r2 = 0
            android.content.res.TypedArray r7 = r6.obtainStyledAttributes(r7, r1, r0, r2)
            int r0 = defpackage.p3c.ActionMode_background
            boolean r1 = r7.hasValue(r0)
            if (r1 == 0) goto L_0x004d
            int r1 = r7.getResourceId(r0, r2)
            if (r1 == 0) goto L_0x004d
            android.graphics.drawable.Drawable r6 = defpackage.s36.n(r6, r1)
            goto L_0x0051
        L_0x004d:
            android.graphics.drawable.Drawable r6 = r7.getDrawable(r0)
        L_0x0051:
            r5.setBackground(r6)
            int r6 = defpackage.p3c.ActionMode_titleTextStyle
            int r6 = r7.getResourceId(r6, r2)
            r5.E0 = r6
            int r6 = defpackage.p3c.ActionMode_subtitleTextStyle
            int r6 = r7.getResourceId(r6, r2)
            r5.F0 = r6
            int r6 = defpackage.p3c.ActionMode_height
            int r6 = r7.getLayoutDimension(r6, r2)
            r5.s0 = r6
            int r6 = defpackage.p3c.ActionMode_closeItemLayout
            int r0 = defpackage.zyb.abc_action_mode_close_item_material
    ...
    public final void c(j7 j7Var) {
        View view = this.y0;
        if (view == null) {
            View inflate = LayoutInflater.from(getContext()).inflate(this.H0, this, false);
            this.y0 = inflate;
            addView(inflate);
        } else if (view.getParent() == null) {
            addView(this.y0);
        }
        View findViewById = this.y0.findViewById(mvb.action_mode_close_button);
        this.z0 = findViewById;
        findViewById.setOnClickListener(new e0d(1, j7Var));
        wq8 c2 = j7Var.c();
        e7 e7Var = this.o;
        if (e7Var != null) {
            e7Var.f();
        ...
        qr8 qr8 = e7Var3.s0;
        if (qr8 == null) {
            qr8 qr82 = (qr8) e7Var3.o.inflate(e7Var3.Y, this, false);
            e7Var3.s0 = qr82;
            qr82.b(e7Var3.c);
            e7Var3.i();
        }
        qr8 qr83 = e7Var3.s0;
        if (qr8 != qr83) {
            ((ActionMenuView) qr83).setPresenter(e7Var3);
        }
        ActionMenuView actionMenuView = (ActionMenuView) qr83;
    ...
    public final vof i(int i, long j) {
        ...
        if (i == 0) {
            ...
            a2.a(1.0f);
            a2.c(j);
            ((ActionBarContextView) wVar.c).t0 = a2;
            wVar.a = i;
            a2.d(wVar);
            return a2;
        }
        ...
        a3.a(0.0f);
        a3.c(j);
        ((ActionBarContextView) wVar.c).t0 = a3;
        wVar.a = i;
        a3.d(wVar);
        return a3;
    }
    ...
    public final void onConfigurationChanged(Configuration configuration) {
        ...
        TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes((AttributeSet) null, p3c.ActionBar, vsb.actionBarStyle, 0);
        setContentHeight(obtainStyledAttributes.getLayoutDimension(p3c.ActionBar_height, 0));
    ...
    public final void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (!(view == null || view.getVisibility() == 8)) {
            ...
            int g = g(i7, paddingTop, paddingTop2, this.y0, z2) + i7;
    ...
    public final void onMeasure(int i, int i2) {
        ...
        if (View.MeasureSpec.getMode(i) != 1073741824) {
            ...
            if (linearLayout != null && this.A0 == null) {
                if (this.G0) {
                    this.B0.measure(View.MeasureSpec.makeMeasureSpec(0, 0), makeMeasureSpec);
            ...
            if (view2 != null) {
                ...
                this.A0.measure(View.MeasureSpec.makeMeasureSpec(paddingLeft, i7), View.MeasureSpec.makeMeasureSpec(i5, i3));
            }
            if (this.s0 <= 0) {
