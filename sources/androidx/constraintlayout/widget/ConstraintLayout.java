...
public class ConstraintLayout extends ViewGroup {
    ...
    public final dob C0 = new dob(this, this);
    public int D0 = 0;
    public int E0 = 0;
    public final SparseArray a = new SparseArray();
    public final ArrayList b = new ArrayList(4);
    public final ij3 c = new ij3();
    public int o = 0;
    public int s0 = 0;
    ...
    /* JADX WARNING: type inference failed for: r0v2, types: [java.lang.Object, uld] */
    ...
    /* JADX WARNING: type inference failed for: r0v0, types: [android.view.ViewGroup$LayoutParams, android.view.ViewGroup$MarginLayoutParams, java.lang.Object, ti3] */
    public final ViewGroup.LayoutParams generateLayoutParams(AttributeSet attributeSet) {
        ...
        marginLayoutParams.p0 = new hj3();
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, i3c.ConstraintLayout_Layout);
        ...
        for (int i = 0; i < indexCount; i++) {
            ...
            switch (i2) {
                ...
                default:
                    switch (i2) {
                        case 44:
                            dj3.k(marginLayoutParams, obtainStyledAttributes.getString(index));
                            break;
                        case 45:
                        ...
                        default:
                            switch (i2) {
                                case EglBase.EGL_OPENGL_ES3_BIT /*64*/:
                                    dj3.j(marginLayoutParams, obtainStyledAttributes, index, 0);
                                    break;
                                case 65:
                                    dj3.j(marginLayoutParams, obtainStyledAttributes, index, 1);
                                    break;
                                case 66:
    ...
    public String getSceneString() {
        ...
        if (ij3.j == null) {
            int id2 = getId();
            if (id2 != -1) {
                ij3.j = getContext().getResources().getResourceEntryName(id2);
            } else {
                ij3.j = "parent";
            }
        }
        ...
        while (it.hasNext()) {
            hj3 hj3 = (hj3) it.next();
            View view = (View) hj3.f0;
            if (view != null) {
                if (hj3.j == null && (id = view.getId()) != -1) {
                    hj3.j = getContext().getResources().getResourceEntryName(id);
                }
                if (hj3.h0 == null) {
                    hj3.h0 = hj3.j;
                }
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        for (int i5 = 0; i5 < childCount; i5++) {
            ...
            ti3 ti3 = (ti3) childAt.getLayoutParams();
            hj3 hj3 = ti3.p0;
            if (childAt.getVisibility() != 8 || ti3.d0 || ti3.e0 || isInEditMode) {
                int r = hj3.r();
                int s = hj3.s();
                childAt.layout(r, s, hj3.q() + r, hj3.k() + s);
            }
        }
        ArrayList arrayList = this.b;
    ...
    public void onMeasure(int r24, int r25) {
        ...
        L_0x00c1:
            r5 = r3
        L_0x00c2:
            java.util.HashMap r10 = r6.A0     // Catch:{ NotFoundException -> 0x0109 }
        ...
        L_0x00ff:
            ...
            ti3 r2 = (defpackage.ti3) r2     // Catch:{ NotFoundException -> 0x0109 }
            hj3 r2 = r2.p0     // Catch:{ NotFoundException -> 0x0109 }
        L_0x0107:
        ...
        L_0x01da:
            ...
            goto L_0x01da
        L_0x01e2:
            android.util.SparseArray r9 = r6.B0
            r9.clear()
            r0 = 0
            r9.put(r0, r11)
            int r0 = r23.getId()
        ...
        L_0x0235:
            ...
            r15.g0 = r1
            r15.f0 = r0
            boolean r1 = r0 instanceof defpackage.ri3
    ...
    public final void onViewAdded(View view) {
        ...
        hj3 q = q(view);
        if ((view instanceof Guideline) && !(q instanceof fh6)) {
    ...
    public final void r(AttributeSet attributeSet, int i) {
        ...
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, i3c.ConstraintLayout_Layout, i, 0);
            int indexCount = obtainStyledAttributes.getIndexCount();
    ...
    public final void s(int r10) {
        /*
            ...
            int r2 = r10.getEventType()     // Catch:{ XmlPullParserException -> 0x004b, IOException -> 0x0049 }
            r3 = 0
        L_0x0027:
            r4 = 1
            ...
            goto L_0x00a2
        L_0x0031:
            java.lang.String r2 = r10.getName()     // Catch:{ XmlPullParserException -> 0x004b, IOException -> 0x0049 }
            int r6 = r2.hashCode()     // Catch:{ XmlPullParserException -> 0x004b, IOException -> 0x0049 }
            r7 = 4
            r8 = 3
            switch(r6) {
                case -1349929691: goto L_0x006b;
                case 80204913: goto L_0x0061;
                case 1382829617: goto L_0x0058;
                case 1657696882: goto L_0x004e;
        ...
        L_0x003f:
            ...
            boolean r2 = r2.equals(r4)     // Catch:{ XmlPullParserException -> 0x004b, IOException -> 0x0049 }
        ...
        L_0x0076:
            ...
            goto L_0x00a2
        L_0x007d:
            r0.U(r1, r10)     // Catch:{ XmlPullParserException -> 0x004b, IOException -> 0x0049 }
            goto L_0x00a2
        L_0x0081:
            ui3 r2 = new ui3     // Catch:{ XmlPullParserException -> 0x004b, IOException -> 0x0049 }
            r2.<init>(r1, r10)     // Catch:{ XmlPullParserException -> 0x004b, IOException -> 0x0049 }
            if (r3 == 0) goto L_0x00a2
            java.lang.Object r4 = r3.o     // Catch:{ XmlPullParserException -> 0x004b, IOException -> 0x0049 }
            java.util.ArrayList r4 = (java.util.ArrayList) r4     // Catch:{ XmlPullParserException -> 0x004b, IOException -> 0x0049 }
            r4.add(r2)     // Catch:{ XmlPullParserException -> 0x004b, IOException -> 0x0049 }
            goto L_0x00a2
        L_0x0090:
            l2a r3 = new l2a     // Catch:{ XmlPullParserException -> 0x004b, IOException -> 0x0049 }
            r3.<init>((android.content.Context) r1, (android.content.res.XmlResourceParser) r10)     // Catch:{ XmlPullParserException -> 0x004b, IOException -> 0x0049 }
            java.lang.Object r2 = r0.b     // Catch:{ XmlPullParserException -> 0x004b, IOException -> 0x0049 }
            android.util.SparseArray r2 = (android.util.SparseArray) r2     // Catch:{ XmlPullParserException -> 0x004b, IOException -> 0x0049 }
            int r4 = r3.b     // Catch:{ XmlPullParserException -> 0x004b, IOException -> 0x0049 }
            r2.put(r4, r3)     // Catch:{ XmlPullParserException -> 0x004b, IOException -> 0x0049 }
            goto L_0x00a2
        L_0x009f:
            r10.getName()     // Catch:{ XmlPullParserException -> 0x004b, IOException -> 0x0049 }
        L_0x00a2:
            int r2 = r10.next()     // Catch:{ XmlPullParserException -> 0x004b, IOException -> 0x0049 }
            goto L_0x0027
        L_0x00a7:
            r10.printStackTrace()
            goto L_0x00ae
    ...
    public void setConstraintSet(dj3 dj3) {
        this.x0 = dj3;
    }
    ...
    public void setOnConstraintsChanged(lj3 lj3) {
        qz7 qz7 = this.y0;
        if (qz7 != null) {
            qz7.getClass();
        }
    ...
    public final void t(defpackage.ij3 r25, int r26, int r27, int r28) {
        ...
        L_0x0130:
            ...
            boolean r10 = defpackage.v3c.k(r2, r10)
            r11 = 64
            if (r10 != 0) goto L_0x015c
            boolean r2 = defpackage.v3c.k(r2, r11)
        ...
        L_0x019a:
            ...
            goto L_0x0196
        L_0x01a3:
            boolean r11 = r15 instanceof defpackage.nn5
        ...
        L_0x035f:
            ...
            boolean r8 = r7 instanceof defpackage.gh6
            if (r8 != 0) goto L_0x036a
            goto L_0x035d
        L_0x036a:
            ek4 r8 = r7.e
            ...
            boolean r8 = r7 instanceof defpackage.g12
            if (r8 != 0) goto L_0x0344
            boolean r7 = r7 instanceof defpackage.gh6
        ...
        L_0x044a:
            ...
            hj3 r7 = (defpackage.hj3) r7
            boolean r8 = r7 instanceof defpackage.fh6
        ...
        L_0x0458:
            ...
            goto L_0x04db
        L_0x045c:
            boolean r8 = r7 instanceof defpackage.nh0
        ...
        L_0x0497:
            ...
            boolean r8 = r7 instanceof defpackage.nn5
        ...
        L_0x054f:
            ...
            hj3 r14 = (defpackage.hj3) r14
            boolean r15 = r14 instanceof defpackage.nn5
        ...
        L_0x05e7:
            ...
            hj3 r13 = (defpackage.hj3) r13
            boolean r14 = r13 instanceof defpackage.uj6
            if (r14 == 0) goto L_0x05f7
            boolean r14 = r13 instanceof defpackage.nn5
            if (r14 == 0) goto L_0x061a
        L_0x05f7:
            boolean r14 = r13 instanceof defpackage.fh6
    ...
    public final void v(hj3 hj3, ti3 ti3, SparseArray sparseArray, int i, int i2) {
        View view = (View) this.a.get(i);
        hj3 hj32 = (hj3) sparseArray.get(i);
        if (hj32 != null && view != null && (view.getLayoutParams() instanceof ti3)) {
            ti3.c0 = true;
            if (i2 == 6) {
                ti3 ti32 = (ti3) view.getLayoutParams();
                ti32.c0 = true;
                ti32.p0.E = true;
            }
            hj3.i(6).b(hj32.i(i2), ti3.D, ti3.C, true);
            hj3.E = true;
            hj3.i(3).j();
            hj3.i(5).j();
        }
    ...
    /* JADX WARNING: type inference failed for: r6v1, types: [android.view.ViewGroup$LayoutParams, android.view.ViewGroup$MarginLayoutParams, ti3] */
