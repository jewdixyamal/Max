...
public abstract class WorkRequest {
    public static final d8g Companion = new Object();
    ...
    public WorkRequest(UUID uuid, h8g h8g, Set<String> set) {
        this.id = uuid;
        this.workSpec = h8g;
        this.tags = set;
    }
    ...
    public static abstract class Builder<B extends Builder<B, ?>, W extends WorkRequest> {
        ...
        public Builder(Class<? extends gm7> cls) {
            ...
            this.workSpec = new h8g(this.id.toString(), (m7g) null, cls.getName(), (String) null, (d24) null, (d24) null, 0, 0, 0, (kj3) null, 0, (mf0) null, 0, 0, 0, 0, false, (jna) null, 0, 1048570, 0);
            LinkedHashSet linkedHashSet = new LinkedHashSet(mz7.Z(1));
            ys.k0(new String[]{cls.getName()}, linkedHashSet);
        ...
        public final W build() {
            ...
            kj3 kj3 = this.workSpec.j;
            boolean z = (kj3.h.isEmpty() ^ true) || kj3.d || kj3.b || kj3.c;
            h8g h8g = this.workSpec;
            if (h8g.q) {
                if (!(!z)) {
        ...
        public final h8g getWorkSpec$work_runtime_release() {
            return this.workSpec;
        }
        ...
        public final B setBackoffCriteria(mf0 mf0, long j, TimeUnit timeUnit) {
            this.backoffCriteriaSet = true;
            h8g h8g = this.workSpec;
            h8g.l = mf0;
            h8g.e(timeUnit.toMillis(j));
            return getThisObject$work_runtime_release();
        }
        ...
        public final B setConstraints(kj3 kj3) {
            this.workSpec.j = kj3;
            return getThisObject$work_runtime_release();
        }

        @SuppressLint({"MissingGetterMatchingBuilder"})
        public B setExpedited(jna jna) {
            h8g h8g = this.workSpec;
            h8g.q = true;
            h8g.r = jna;
            return getThisObject$work_runtime_release();
        ...
        public final B setId(UUID uuid) {
            ...
            m7g m7g = h8g.b;
            String str2 = h8g.d;
            d24 d24 = new d24(h8g.e);
            d24 d242 = new d24(h8g.f);
            long j = h8g.g;
            long j2 = h8g.h;
            long j3 = h8g.i;
            kj3 kj3 = h8g.j;
            ...
            boolean z3 = kj3.d;
            h8g h8g2 = r1;
            h8g h8g3 = new h8g(uuid2, m7g, str, str2, d24, d243, j8, j6, j4, new kj3(i, z, z2, z3, kj3.e, j5, j7, kj3.h), h8g.k, h8g.l, h8g.m, h8g.n, h8g.o, h8g.p, h8g.q, h8g.r, h8g.s, 524288, 0);
            this.workSpec = h8g2;
            return getThisObject$work_runtime_release();
        }
        ...
        public final B setInitialState(m7g m7g) {
            this.workSpec.b = m7g;
            return getThisObject$work_runtime_release();
        }

        public final B setInputData(d24 d24) {
            this.workSpec.e = d24;
            return getThisObject$work_runtime_release();
        }
        ...
        public final void setWorkSpec$work_runtime_release(h8g h8g) {
            this.workSpec = h8g;
        }
        ...
        public final B setBackoffCriteria(mf0 mf0, Duration duration) {
            this.backoffCriteriaSet = true;
            h8g h8g = this.workSpec;
            h8g.l = mf0;
            h8g.e(gt4.a(duration));
            return getThisObject$work_runtime_release();
        }
