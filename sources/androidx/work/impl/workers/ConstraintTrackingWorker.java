...
public final class ConstraintTrackingWorker extends gm7 implements e7g {
    ...
    public final dcd o = new Object();

    /* JADX WARNING: type inference failed for: r1v2, types: [dcd, java.lang.Object] */
    ...
    public final void a(List list) {
        a14 u = a14.u();
        String str = gj3.a;
        u.n(str, "Constraints changed for " + list);
        synchronized (this.b) {
            this.c = true;
        }
    }
