...
public class GingerbreadPurgeableDecoder extends DalvikPurgeableDecoder {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r3v0, resolved type: q5b} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r3v1, resolved type: q5b} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r3v2, resolved type: q5b} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r3v3, resolved type: q5b} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r3v4, resolved type: java.io.OutputStream} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r3v5, resolved type: q5b} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r3v6, resolved type: q5b} */
    /* JADX WARNING: Multi-variable type inference failed */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static android.os.MemoryFile g(defpackage.o43 r8, int r9, byte[] r10) {
        /*
            r0 = 0
        ...
        L_0x0006:
            ...
            r2.<init>(r3, r1)
            r2.allowPurging(r0)
            q5b r1 = new q5b     // Catch:{ all -> 0x0052 }
            java.lang.Object r4 = r8.e0()     // Catch:{ all -> 0x0052 }
            qq8 r4 = (defpackage.qq8) r4     // Catch:{ all -> 0x0052 }
            r1.<init>(r4)     // Catch:{ all -> 0x0052 }
            lh7 r4 = new lh7     // Catch:{ all -> 0x004e }
        ...
        L_0x0055:
            ...
            defpackage.q43.b(r3)
            defpackage.q43.b(r4)
            defpackage.q43.a(r10)
            throw r9
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.imagepipeline.platform.GingerbreadPurgeableDecoder.g(o43, int, byte[]):android.os.MemoryFile");
    }

    public final Bitmap b(o43 o43, BitmapFactory.Options options) {
        return h(o43, ((qq8) o43.e0()).U(), (byte[]) null, options);
    }

    public final Bitmap c(o43 o43, int i, BitmapFactory.Options options) {
        return h(o43, i, DalvikPurgeableDecoder.e(i, o43) ? null : DalvikPurgeableDecoder.b, options);
    }

    /* JADX WARNING: Removed duplicated region for block: B:22:0x0032  */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final android.graphics.Bitmap h(defpackage.o43 r2, int r3, byte[] r4, android.graphics.BitmapFactory.Options r5) {
        /*
            r1 = this;
            r0 = 0
            ...
            defpackage.od2.o(r1, r3)     // Catch:{ IOException -> 0x001e }
            r2.close()
            return r1
        L_0x001a:
            r0 = r2
        ...
        L_0x002a:
            ...
            r2 = r0
        L_0x002c:
            defpackage.nu0.H(r1)     // Catch:{ all -> 0x001c }
