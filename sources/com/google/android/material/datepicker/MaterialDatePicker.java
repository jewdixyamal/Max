...
public final class MaterialDatePicker<S> extends DialogFragment {
    ...
    public static boolean n1(Context context, int i) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(kq0.G(tsb.materialCalendarStyle, context, MaterialCalendar.class.getCanonicalName()).data, new int[]{i});
        boolean z = obtainStyledAttributes.getBoolean(0, false);
        obtainStyledAttributes.recycle();
        return z;
    }

    /* JADX WARNING: type inference failed for: r2v2, types: [java.lang.Object, sx0] */
    public final void L0(Bundle bundle) {
        ...
        long j = tx0.a.Y;
        long j2 = tx0.b.Y;
        obj.a = Long.valueOf(tx0.o.Y);
        MaterialCalendar materialCalendar = this.G1;
        kc9 kc9 = materialCalendar == null ? null : materialCalendar.o1;
        if (kc9 != null) {
            obj.a = Long.valueOf(kc9.Y);
        }
        Bundle bundle3 = new Bundle();
        bundle3.putParcelable("DEEP_COPY_VALIDATOR_KEY", tx0.c);
        kc9 b = kc9.b(j);
        kc9 b2 = kc9.b(j2);
        v34 v34 = (v34) bundle3.getParcelable("DEEP_COPY_VALIDATOR_KEY");
        Long l = obj.a;
        bundle2.putParcelable("CALENDAR_CONSTRAINTS_KEY", new tx0(b, b2, v34, l == null ? null : kc9.b(l.longValue()), tx0.X));
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r6v6, resolved type: y6g} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r4v17, resolved type: y6g} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r4v21, resolved type: z6g} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r6v11, resolved type: z6g} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r4v30, resolved type: y6g} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r4v31, resolved type: y6g} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r6v15, resolved type: y6g} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r6v16, resolved type: y6g} */
    ...
    public final void M0() {
        /*
            ...
            int r4 = defpackage.ivb.fullscreen_header
            android.view.View r1 = r1.findViewById(r4)
            android.graphics.drawable.Drawable r4 = r1.getBackground()
            android.content.res.ColorStateList r4 = defpackage.oag.r(r4)
        ...
        L_0x0049:
            ...
            int r7 = defpackage.mr0.x(r8, r9, r7)
            if (r6 == 0) goto L_0x005c
            java.lang.Integer r4 = java.lang.Integer.valueOf(r7)
        L_0x005c:
            defpackage.kp.A(r0, r5)
            r0.getContext()
            r0.getContext()
            r0.setStatusBarColor(r5)
            r0.setNavigationBarColor(r5)
            int r4 = r4.intValue()
            boolean r4 = defpackage.mr0.J(r4)
            boolean r6 = defpackage.mr0.J(r5)
        ...
        L_0x009f:
            r6.v(r4)
            boolean r4 = defpackage.mr0.J(r7)
            boolean r6 = defpackage.mr0.J(r5)
        ...
        L_0x00cd:
            ...
            defpackage.omf.u(r1, r5)
            r11.W1 = r3
            goto L_0x0119
        L_0x00e8:
            r1 = -2
            r0.setLayout(r1, r1)
            android.content.res.Resources r1 = r11.g0()
            int r4 = defpackage.stb.mtrl_calendar_dialog_background_inset
        ...
        L_0x0194:
            ...
            throw r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.material.datepicker.MaterialDatePicker.M0():void");
    }
    ...
    public final Dialog h1() {
        ...
        if (i != 0) {
            ...
            this.J1 = n1(context, 16843277);
            this.V1 = new q18(context, (AttributeSet) null, tsb.materialCalendarStyle, m2c.Widget_MaterialComponents_MaterialCalendar);
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes((AttributeSet) null, z2c.MaterialCalendar, tsb.materialCalendarStyle, m2c.Widget_MaterialComponents_MaterialCalendar);
            int color = obtainStyledAttributes.getColor(z2c.MaterialCalendar_backgroundTint, 0);
            obtainStyledAttributes.recycle();
            this.V1.j(context);
    ...
    public final void v0(Bundle bundle) {
        ...
        if (charSequence == null) {
            charSequence = U0().getResources().getText(this.H1);
        }
    ...
    public final View x0(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        View inflate = layoutInflater.inflate(this.J1 ? vyb.mtrl_picker_fullscreen : vyb.mtrl_picker_dialog, viewGroup);
        Context context = inflate.getContext();
        if (this.J1) {
            inflate.findViewById(ivb.mtrl_calendar_frame).setLayoutParams(new LinearLayout.LayoutParams(m1(context), -2));
        } else {
            inflate.findViewById(ivb.mtrl_calendar_main_pane).setLayoutParams(new LinearLayout.LayoutParams(m1(context), -1));
        }
        WeakHashMap weakHashMap = zmf.a;
        ((TextView) inflate.findViewById(ivb.mtrl_picker_header_selection_text)).setAccessibilityLiveRegion(1);
        this.U1 = (CheckableImageButton) inflate.findViewById(ivb.mtrl_picker_header_toggle);
        this.T1 = (TextView) inflate.findViewById(ivb.mtrl_picker_title_text);
        this.U1.setTag("TOGGLE_BUTTON_TAG");
        CheckableImageButton checkableImageButton = this.U1;
        StateListDrawable stateListDrawable = new StateListDrawable();
        stateListDrawable.addState(new int[]{16842912}, s36.n(context, yub.material_ic_calendar_black_24dp));
        boolean z = false;
        ...
        zmf.j(this.U1, (a4) null);
        CheckableImageButton checkableImageButton3 = this.U1;
        this.U1.setContentDescription(this.K1 == 1 ? checkableImageButton3.getContext().getString(wzb.mtrl_picker_toggle_to_calendar_input_mode) : checkableImageButton3.getContext().getString(wzb.mtrl_picker_toggle_to_text_input_mode));
        this.U1.setOnClickListener(new xx5(10, this));
        Button button = (Button) inflate.findViewById(ivb.confirm_button);
        l1();
        throw null;
    }
}
