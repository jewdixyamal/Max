...
public final class zzd {
    ...
    /* JADX WARNING: type inference failed for: r0v2, types: [de6, noe] */
    private zzd(Context context, String str) {
        this.zzd = new de6(context, reg.v0, (nk) new ooe("ads_identifier:api"), ce6.c);
    }
    ...
    public static void zzb(zzd zzd2, long j, Exception exc) {
        ...
        if ((exc instanceof ApiException) && (ph3 = ((ApiException) exc).a.o) != null && ph3.b == 24) {
            zzd2.zze.set(j);
        }
    }
    ...
    public final synchronized void zzc(int r19, int r20, long r21, long r23, int r25) {
        ...
        L_0x002b:
            noe r0 = r1.zzd     // Catch:{ all -> 0x0069 }
            if (r0 != 0) goto L_0x0030
            goto L_0x006b
        L_0x0030:
            moe r4 = new moe     // Catch:{ all -> 0x0069 }
            y99 r17 = new y99     // Catch:{ all -> 0x0069 }
            r8 = 0
            r13 = 0
            r14 = 0
            r15 = 0
            ...
            y99[] r5 = new defpackage.y99[]{r17}     // Catch:{ all -> 0x0069 }
            java.util.List r5 = java.util.Arrays.asList(r5)     // Catch:{ all -> 0x0069 }
            r6 = 0
            r4.<init>(r6, r5)     // Catch:{ all -> 0x0069 }
            reg r0 = (defpackage.reg) r0     // Catch:{ all -> 0x0069 }
            ukg r0 = r0.d(r4)     // Catch:{ all -> 0x0069 }
            ...
            q67 r2 = defpackage.xne.a     // Catch:{ all -> 0x0069 }
