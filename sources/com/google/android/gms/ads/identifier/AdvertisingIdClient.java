...
public class AdvertisingIdClient {
    ...
    public static Info getAdvertisingIdInfo(Context context) throws IOException, IllegalStateException, GooglePlayServicesNotAvailableException, GooglePlayServicesRepairableException {
        ...
        try {
            ...
            advertisingIdClient.zze(zzf2, true, 0.0f, SystemClock.elapsedRealtime() - elapsedRealtime, "", (Throwable) null);
            zza2.zzc(35401, 0, elapsedRealtime, System.currentTimeMillis(), (int) (SystemClock.elapsedRealtime() - elapsedRealtime));
            return zzf2;
        } catch (Throwable th2) {
            Throwable th3 = th2;
            advertisingIdClient.zze((Info) null, true, 0.0f, -1, "", th3);
    ...
    public static boolean getIsAdIdFakeForDebugLogging(Context context) throws IOException, GooglePlayServicesNotAvailableException, GooglePlayServicesRepairableException {
        ...
        try {
            ...
            synchronized (advertisingIdClient) {
                ...
                ugg ugg = (ugg) advertisingIdClient.zzb;
                ugg.getClass();
                Parcel obtain = Parcel.obtain();
                obtain.writeInterfaceToken("com.google.android.gms.ads.identifier.internal.IAdvertisingIdService");
                Parcel k = ugg.k(obtain, 6);
                int i = hgg.a;
                if (k.readInt() != 0) {
                    z = true;
                }
    ...
    private final Info zzf(int i) throws IOException {
        ...
        synchronized (this) {
            ...
            fp3.n(this.zzb);
            try {
                ugg ugg = (ugg) this.zzb;
                ugg.getClass();
                Parcel obtain = Parcel.obtain();
                obtain.writeInterfaceToken("com.google.android.gms.ads.identifier.internal.IAdvertisingIdService");
                boolean z = true;
                Parcel k = ugg.k(obtain, 1);
                String readString = k.readString();
                k.recycle();
                ugg ugg2 = (ugg) this.zzb;
                ugg2.getClass();
                Parcel obtain2 = Parcel.obtain();
                obtain2.writeInterfaceToken("com.google.android.gms.ads.identifier.internal.IAdvertisingIdService");
                int i2 = hgg.a;
                obtain2.writeInt(1);
                Parcel k2 = ugg2.k(obtain2, 2);
                if (k2.readInt() == 0) {
                    z = false;
                }
                k2.recycle();
    ...
    public final void zza() {
        /*
            ...
            np0 r0 = r3.zza     // Catch:{ all -> 0x0028 }
            if (r0 != 0) goto L_0x000f
            goto L_0x002a
        L_0x000f:
            boolean r0 = r3.zzc     // Catch:{ all -> 0x001e }
            if (r0 == 0) goto L_0x001e
            xh3 r0 = defpackage.xh3.a()     // Catch:{ all -> 0x001e }
            android.content.Context r1 = r3.zzi     // Catch:{ all -> 0x001e }
            np0 r2 = r3.zza     // Catch:{ all -> 0x001e }
        ...
        synchronized (this) {
            try {
                if (!this.zzc) {
                    ...
                    int b = fe6.b.b(context, 12451000);
                    if (b != 0) {
                        if (b != 2) {
                    ...
                    if (xh3.a().c(context, context.getClass().getName(), intent, np0, 1, (Executor) null)) {
                        this.zza = np0;
                        IBinder a = np0.a(TimeUnit.MILLISECONDS);
                        int i = fhg.c;
                        IInterface queryLocalInterface = a.queryLocalInterface("com.google.android.gms.ads.identifier.internal.IAdvertisingIdService");
                        this.zzb = queryLocalInterface instanceof yhg ? (yhg) queryLocalInterface : new ugg(a);
                        this.zzc = true;
                        return;
                    }
