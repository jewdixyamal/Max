        ...
        for (Location location : list) {
            ...
            if (location == null) {
                ...
                if (location.hasAltitude()) {
                    ...
                    if (dr7.f(location)) {
                        sb.append("±");
                        sb.append(decimalFormat3.format((double) dr7.c(location)));
                    }
                    sb.append("m");
                }
                if (location.hasSpeed()) {
                    ...
                    if (dr7.e(location)) {
                        sb.append("±");
                        sb.append(decimalFormat3.format((double) dr7.b(location)));
                    }
                    sb.append("m/s");
                }
                if (location.hasBearing()) {
                    ...
                    if (dr7.d(location)) {
                        sb.append("±");
                        sb.append(decimalFormat3.format((double) dr7.a(location)));
                    }
                    sb.append("°");
                }
                ...
                if (millis >= 0) {
                    str = nhg.a.format(new Date(millis));
                } else {
