...
public final class DialogNotificationsSettingsScreen extends Widget {
    ...
    public final qm0 X = binding(new kj4(this, 1));
    public final x27 a = x27.d;
    public final je7 b = createViewModelLazy(pj4.class, new nj4(0, new zf3(17)));
    public final mfd c = new mfd(new gd1(8, this), sw9.a.getExecutors().a());
    public final qm0 o = binding(new kj4(this, 0));
    ...
    public final View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        v3c.y(new o(3, (Continuation) null, 3), linearLayout);
        return linearLayout;
    }

    public final void onViewCreated(View view) {
        od2.L(new zn5(tu0.g(((pj4) this.b.getValue()).Y, getViewLifecycleOwner().Q(), fg7.o), new lj4((Continuation) null, this), 5), getViewLifecycleScope());
    }
}
