...
public final class SavedMessagesIconDrawable extends Drawable implements kre {
    private static final bsc Companion = new Object();
    @Deprecated
    ...
    public void inflate(Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) {
        ...
        this.iconDrawable = qic.a(resources, i, (Resources.Theme) null);
    }
    ...
    public void onBoundsChange(Rect rect) {
        ...
        int G = rect.width() > tu0.G(((float) 40) * fk4.d().getDisplayMetrics().density) ? tu0.G(((float) 24) * fk4.d().getDisplayMetrics().density) : tu0.G(((float) 20) * fk4.d().getDisplayMetrics().density);
        Drawable drawable = this.iconDrawable;
        if (drawable != null) {
    ...
    public void onThemeChanged(fka fka) {
        this.backgroundDrawable.setTint(fka.b().a.m);
        Drawable drawable = this.iconDrawable;
        if (drawable != null) {
            drawable.setTint(-1);
        }
