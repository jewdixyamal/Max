...
public final class MissedRequiredQueryParamsException extends RuntimeException {
    ...
    public MissedRequiredQueryParamsException(android.net.Uri r3, java.util.Map r4, java.util.Set r5) {
        /*
            r2 = this;
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: one.me.deeplink.MissedRequiredQueryParamsException.<init>(android.net.Uri, java.util.Map, java.util.Set):void");
    }
}
