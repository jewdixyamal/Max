...
public final class ChatMediaRowLayout extends FrameLayout {
    ...
    public final void onMeasure(int i, int i2) {
        ...
        int G = (measuredWidth - (tu0.G(((float) 3) * fk4.d().getDisplayMetrics().density) * 2)) / 3;
        if (G < size) {
            i = View.MeasureSpec.makeMeasureSpec(G, 1073741824);
        }
        super.onMeasure(i, i);
    }

    public final void setListener(ah2 ah2) {
    }
}
