...
public final class EnhancedAnimatedVectorDrawable extends Drawable implements Animatable, ubf {
    private static final b25 Companion = new Object();
    @Deprecated
    public static final boolean SHOULD_IGNORE_INVALID_ANIMATION = true;
    /* access modifiers changed from: private */
    public List<le> animationCallbacks = new ArrayList();
    private c25 animator;
    private final je7 animatorListener$delegate = new khe(new es3(10, this));
    ...
    public EnhancedAnimatedVectorDrawable(android.content.Context r18, int r19) {
        /*
            ...
            khe r3 = new khe
            r3.<init>(r2)
            r0.animatorListener$delegate = r3
        ...
        L_0x0092:
            ...
            r9.<init>()
            int r10 = r4.getEventType()     // Catch:{ XmlPullParserException -> 0x00bf, IOException -> 0x00bc }
            int r11 = r4.getDepth()     // Catch:{ XmlPullParserException -> 0x00bf, IOException -> 0x00bc }
            r12 = 0
        L_0x00a7:
            if (r10 == r7) goto L_0x0127
            int r13 = r4.getDepth()     // Catch:{ XmlPullParserException -> 0x00bf, IOException -> 0x00bc }
            if (r13 >= r11) goto L_0x00b2
            r13 = 3
            if (r10 == r13) goto L_0x0127
        L_0x00b2:
            if (r10 == r8) goto L_0x00c2
            int r10 = r4.next()     // Catch:{ XmlPullParserException -> 0x00bf, IOException -> 0x00bc }
            goto L_0x00a7
        L_0x00b9:
            r0 = move-exception
            goto L_0x0173
        ...
        L_0x00bf:
            ...
            goto L_0x016f
        L_0x00c2:
            java.lang.String r10 = r4.getName()     // Catch:{ XmlPullParserException -> 0x00bf, IOException -> 0x00bc }
            java.lang.String r13 = "animated-vector"
            boolean r13 = defpackage.tpa.f(r10, r13)     // Catch:{ XmlPullParserException -> 0x00bf, IOException -> 0x00bc }
            if (r13 == 0) goto L_0x00d7
            one.me.sdk.richvector.EnhancedVectorDrawable r10 = r2.b(r4)     // Catch:{ XmlPullParserException -> 0x00bf, IOException -> 0x00bc }
            r10.getPixelSize()     // Catch:{ XmlPullParserException -> 0x00bf, IOException -> 0x00bc }
            r12 = r10
            goto L_0x0121
        L_0x00d7:
            java.lang.String r13 = "target"
            boolean r10 = defpackage.tpa.f(r10, r13)     // Catch:{ XmlPullParserException -> 0x00bf, IOException -> 0x00bc }
            if (r10 == 0) goto L_0x0121
            int r10 = r4.getAttributeCount()     // Catch:{ XmlPullParserException -> 0x00bf, IOException -> 0x00bc }
            r13 = 0
            r14 = r13
            r15 = 0
        L_0x00e6:
            if (r14 >= r10) goto L_0x0121
            java.lang.String r5 = r4.getAttributeName(r14)     // Catch:{ XmlPullParserException -> 0x00bf, IOException -> 0x00bc }
            java.lang.String r7 = "name"
            boolean r7 = defpackage.tpa.f(r5, r7)     // Catch:{ XmlPullParserException -> 0x00bf, IOException -> 0x00bc }
            if (r7 == 0) goto L_0x00f9
            java.lang.String r15 = r4.getAttributeValue(r14)     // Catch:{ XmlPullParserException -> 0x00bf, IOException -> 0x00bc }
            goto L_0x011d
        L_0x00f9:
            java.lang.String r7 = "animation"
            boolean r5 = defpackage.tpa.f(r5, r7)     // Catch:{ XmlPullParserException -> 0x00bf, IOException -> 0x00bc }
            if (r5 == 0) goto L_0x011d
            int r5 = r4.getAttributeResourceValue(r14, r13)     // Catch:{ XmlPullParserException -> 0x00bf, IOException -> 0x00bc }
            if (r5 == 0) goto L_0x011d
            android.content.Context r7 = r2.a     // Catch:{ XmlPullParserException -> 0x00bf, IOException -> 0x00bc }
            android.animation.Animator r7 = android.animation.AnimatorInflater.loadAnimator(r7, r5)     // Catch:{ XmlPullParserException -> 0x00bf, IOException -> 0x00bc }
            boolean r16 = defpackage.uf.c(r7)     // Catch:{ XmlPullParserException -> 0x00bf, IOException -> 0x00bc }
            if (r16 == 0) goto L_0x0117
            android.animation.Animator r7 = r2.a(r5)     // Catch:{ XmlPullParserException -> 0x00bf, IOException -> 0x00bc }
        L_0x0117:
            r6.add(r7)     // Catch:{ XmlPullParserException -> 0x00bf, IOException -> 0x00bc }
            r9.put(r7, r15)     // Catch:{ XmlPullParserException -> 0x00bf, IOException -> 0x00bc }
        L_0x011d:
            int r14 = r14 + 1
            r7 = 1
            goto L_0x00e6
    ...
    private final d25 getAnimatorListener() {
        return (d25) this.animatorListener$delegate.getValue();
    }
    ...
    public void clearAnimationCallbacks() {
        c25 c25 = this.animator;
        c25.b.removeListener(getAnimatorListener());
    ...
    public void draw(Canvas canvas) {
        c25 c25 = this.animator;
        if (c25.b.isStarted()) {
            c25.a.invalidateSelf();
        }
        this.drawable.draw(canvas);
    }

    public Animator findAnimations(String str) {
        Integer valueOf = Integer.valueOf(x53.k0(this.targetNameMap.values(), str));
    ...
    public void invalidateAnimations() {
        ...
        c25 c25 = this.animator;
        c25.b.removeListener(getAnimatorListener());
        c25 c252 = new c25(this, this.animatorSetFromXml);
        if (this.animationCallbacks.size() != 0) {
            c252.b.addListener(getAnimatorListener());
        }
        this.animator = c252;
    }
    ...
    public void registerAnimationCallback(le leVar) {
        if (this.animationCallbacks.size() == 0) {
            c25 c25 = this.animator;
            c25.b.addListener(getAnimatorListener());
        }
        if (!this.animationCallbacks.contains(leVar)) {
            this.animationCallbacks.add(leVar);
        }
    }
    ...
    public boolean unregisterAnimationCallback(le leVar) {
        boolean remove = this.animationCallbacks.remove(leVar);
        if (this.animationCallbacks.size() == 0) {
            c25 c25 = this.animator;
            c25.b.removeListener(getAnimatorListener());
        }
