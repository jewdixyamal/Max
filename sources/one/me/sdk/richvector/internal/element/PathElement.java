...
public final class PathElement implements VectorPath, AnimationTarget {
    ...
    private final je7 path$delegate;
    ...
    public PathElement(String str, int i, int i2, Path.FillType fillType2, String str2, int i3, int i4, Paint.Cap cap, Paint.Join join, float f, float f2, float f3, float f4, float f5) {
        ...
        this.strokeColor = i4;
        this.strokeAlpha = i3;
        this.path$delegate = new khe(new zj7(25, this));
    ...
    private final void updatePath() {
        sra[] sraArr = this.pathDataNodes;
        if (sraArr != null) {
            getPath().reset();
            m6d.A(sraArr, getPath());
            getPath().transform(this.scaleMatrix);
            return;
        }
        trimPath();
    ...
    public final void setPathData(sra[] sraArr) {
        this.pathDataNodes = m6d.j(sraArr);
        updatePath();
    }

    public final void setStrokeAlpha(float f) {
        setStrokeAlpha(Math.min(255, (int) (((float) 255) * f)));
    }
    ...
    public PathElement(one.me.sdk.richvector.internal.element.PathElement r18) {
        /*
            ...
            r1.strokeRatio = r0
            sra[] r0 = r2.pathDataNodes
            if (r0 == 0) goto L_0x006f
            sra[] r0 = defpackage.m6d.j(r0)
            goto L_0x0070
        L_0x006f:
            r0 = 0
        L_0x0070:
