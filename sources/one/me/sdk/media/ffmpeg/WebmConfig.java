...
public final class WebmConfig {
    ...
    public static final class Config {
        ...
        public Config() {
            this((FfmpegLibraryLoader) null, (lm9) null, 3, (z84) null);
        }
        ...
        public Config(FfmpegLibraryLoader ffmpegLibraryLoader) {
            this(ffmpegLibraryLoader, (lm9) null, 2, (z84) null);
        }

        public Config(FfmpegLibraryLoader ffmpegLibraryLoader, lm9 lm9) {
        ...
        public Config(one.me.sdk.media.ffmpeg.FfmpegLibraryLoader r1, defpackage.lm9 r2, int r3, defpackage.z84 r4) {
            /*
                r0 = this;
                r4 = r3 & 1
                if (r4 == 0) goto L_0x000b
                jf5 r1 = one.me.sdk.media.ffmpeg.FfmpegLibraryLoader.Companion
                r1.getClass()
                if5 r1 = defpackage.jf5.b
            L_0x000b:
                r3 = r3 & 2
                if (r3 == 0) goto L_0x0011
                buc r2 = defpackage.km9.a
            L_0x0011:
                r0.<init>(r1, r2)
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: one.me.sdk.media.ffmpeg.WebmConfig.Config.<init>(one.me.sdk.media.ffmpeg.FfmpegLibraryLoader, lm9, int, z84):void");
        }
    }
