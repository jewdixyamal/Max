...
public final class RLottieDrawableUtils {
    ...
    /* JADX WARNING: type inference failed for: r0v0, types: [w3c, java.lang.Object] */
    public static final w3c getLottieFrameAt(RLottieDrawable rLottieDrawable, int i, int i2, int i3) {
        ...
        if (bitmap2 != null) {
            RLottieDrawable.getFrame(rLottieDrawable.d1, i, bitmap2, i2, i3, bitmap2.getRowBytes(), true);
        }
        return obj;
    }
}
