...
public class MediaSessionCompat {
            ...
            public void handleMessage(Message message) {
                ...
                if (message.what == 1) {
                    ...
                    if (mediaSessionImpl != null && callback == mediaSessionImpl.getCallback() && callbackHandler != null) {
                        ...
                        mediaSessionImpl.setCurrentControllerInfo((wi8) null);
                    }
                }
            }
        }
        ...
        public class MediaSessionCallbackApi21 extends MediaSession.Callback {
            ...
            public void onCommand(java.lang.String r6, android.os.Bundle r7, android.os.ResultReceiver r8) {
                ...
                L_0x002c:
                    ...
                    lcf r7 = r7.getSession2Token()     // Catch:{ BadParcelableException -> 0x00b5 }
                    defpackage.tpa.E(r6, r7)     // Catch:{ BadParcelableException -> 0x00b5 }
                    r7 = 0
    ...
    public interface MediaSessionImpl {
        ...
        void setCurrentControllerInfo(wi8 wi8);
        ...
        void setPlaybackToRemote(uqf uqf);
    ...
    public static class MediaSessionImplApi18 extends MediaSessionImplBase {
        ...
        public MediaSessionImplApi18(Context context, String str, ComponentName componentName, PendingIntent pendingIntent, lcf lcf, Bundle bundle) {
            super(context, str, componentName, pendingIntent, lcf, bundle);
        }
    ...
    public static class MediaSessionImplApi19 extends MediaSessionImplApi18 {
        public MediaSessionImplApi19(Context context, String str, ComponentName componentName, PendingIntent pendingIntent, lcf lcf, Bundle bundle) {
            super(context, str, componentName, pendingIntent, lcf, bundle);
        }
    ...
    public static class MediaSessionImplApi22 extends MediaSessionImplApi21 {
        public MediaSessionImplApi22(Context context, String str, lcf lcf, Bundle bundle) {
            super(context, str, lcf, bundle);
        }
    ...
    public static class MediaSessionImplApi28 extends MediaSessionImplApi22 {
        public MediaSessionImplApi28(Context context, String str, lcf lcf, Bundle bundle) {
            super(context, str, lcf, bundle);
        }

        /* JADX WARNING: type inference failed for: r0v0, types: [wi8, java.lang.Object] */
        public final wi8 getCurrentControllerInfo() {
            ...
            if (packageName == null) {
                ...
                obj.a = new yi8(currentControllerInfo.getPackageName(), currentControllerInfo.getPid(), currentControllerInfo.getUid());
                return obj;
            } else {
        ...
        public void setCurrentControllerInfo(wi8 wi8) {
        }
    ...
    public static class MediaSessionImplApi29 extends MediaSessionImplApi28 {
        public MediaSessionImplApi29(Context context, String str, lcf lcf, Bundle bundle) {
            super(context, str, lcf, bundle);
        }
    ...
    public static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        private tqf mVolumeCallback = new tqf() {
            public void onVolumeChanged(uqf uqf) {
            ...
            public void handleMessage(Message message) {
                ...
                if (callback != null) {
                    ...
                    try {
                        ...
                        MediaSessionImplBase.this.setCurrentControllerInfo((wi8) null);
                    }
                }
            }
        }

        public MediaSessionImplBase(Context context, String str, ComponentName componentName, PendingIntent pendingIntent, lcf lcf, Bundle bundle) {
            if (componentName != null) {
                ...
                this.mToken = new Token(mediaSessionStub, (IMediaSession) null, lcf);
                this.mRatingType = 0;
                this.mVolumeType = 1;
                this.mLocalStream = 3;
        ...
        public void setPlaybackToRemote(uqf uqf) {
    ...
    public static final class Token implements Parcelable {
        ...
        public Token(Object obj) {
            this(obj, (IMediaSession) null, (lcf) null);
        }
        ...
        public static Token fromBundle(Bundle bundle) {
            ...
            return new Token(token.mInner, asInterface, w);
        }
        ...
        public void setSession2Token(lcf lcf) {
            synchronized (this.mLock) {
                this.mSession2Token = lcf;
            }
        }
        ...
        public Token(Object obj, IMediaSession iMediaSession) {
            this(obj, iMediaSession, (lcf) null);
        }
        ...
        public Token(Object obj, IMediaSession iMediaSession, lcf lcf) {
    ...
    public MediaSessionCompat(Context context, String str, ComponentName componentName, PendingIntent pendingIntent, Bundle bundle) {
        this(context, str, componentName, pendingIntent, bundle, (lcf) null);
    }

    public MediaSessionCompat(Context context, String str, ComponentName componentName, PendingIntent pendingIntent, Bundle bundle, lcf lcf) {
        ...
        if (context == null) {
            ...
            MediaSessionImplApi29 mediaSessionImplApi29 = new MediaSessionImplApi29(context, str, lcf, bundle);
    ...
    public static class MediaSessionImplApi21 implements MediaSessionImpl {
        ...
        public MediaSessionImplApi21(Context context, String str, lcf lcf, Bundle bundle) {
            ...
            this.mToken = new Token(createFwkMediaSession.getSessionToken(), extraSession, lcf);
            this.mSessionInfo = bundle;
            setFlags(3);
        }
