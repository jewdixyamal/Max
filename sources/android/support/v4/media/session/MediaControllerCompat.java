...
public final class MediaControllerCompat {
    ...
    public static abstract class Callback implements IBinder.DeathRecipient {
        ...
        public static class MediaControllerCallbackApi21 extends MediaController.Callback {
            ...
            /* JADX WARNING: type inference failed for: r3v0, types: [androidx.media.AudioAttributesImplApi26, androidx.media.AudioAttributesImplApi21] */
            public void onAudioInfoChanged(MediaController.PlaybackInfo playbackInfo) {
                Callback callback = this.mCallback.get();
                if (callback != null) {
                    callback.onAudioInfoChanged(new PlaybackInfo(playbackInfo.getPlaybackType(), new AudioAttributesCompat(new AudioAttributesImplApi21(playbackInfo.getAudioAttributes())), playbackInfo.getVolumeControl(), playbackInfo.getMaxVolume(), playbackInfo.getCurrentVolume()));
                }
            }
    ...
    public static class MediaControllerImplApi21 implements MediaControllerImpl {
        ...
        public PlaybackInfo getPlaybackInfo() {
            ...
            if (playbackInfo != null) {
                return new PlaybackInfo(playbackInfo.getPlaybackType(), new AudioAttributesCompat(new AudioAttributesImplApi21(playbackInfo.getAudioAttributes())), playbackInfo.getVolumeControl(), playbackInfo.getMaxVolume(), playbackInfo.getCurrentVolume());
            }
            return null;
        }
    ...
    public static final class PlaybackInfo {
        ...
        /* JADX WARNING: type inference failed for: r9v1, types: [androidx.media.AudioAttributesImplApi26, androidx.media.AudioAttributesImplApi21] */
        /* JADX WARNING: Illegal instructions before constructor call */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public PlaybackInfo(int r8, int r9, int r10, int r11, int r12) {
            /*
                r7 = this;
                int r0 = androidx.media.AudioAttributesCompat.b
