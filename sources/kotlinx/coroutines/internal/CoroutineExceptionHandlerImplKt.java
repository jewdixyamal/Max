...
public final class CoroutineExceptionHandlerImplKt {
    private static final Collection<ox3> platformExceptionHandlers = l6d.i0(new ni3(new at(6, Arrays.asList(new ox3[]{new AndroidExceptionPreHandler(), new n45()}).iterator())));
    ...
    public static final void ensurePlatformExceptionHandlerLoaded(ox3 ox3) {
        if (!platformExceptionHandlers.contains(ox3)) {
