...
public final class LockFreeTaskQueueCore<E> {
    ...
    public static final class Companion {
        ...
        public final <T> T withState(long j, a66 a66) {
            return a66.invoke(Integer.valueOf((int) (LockFreeTaskQueueCore.HEAD_MASK & j)), Integer.valueOf((int) ((j & LockFreeTaskQueueCore.TAIL_MASK) >> 30)));
        }
    ...
    private final /* synthetic */ void loop$atomicfu(Object obj, AtomicLongFieldUpdater atomicLongFieldUpdater, m56 m56) {
        while (true) {
            m56.invoke(Long.valueOf(atomicLongFieldUpdater.get(obj)));
        }
    }
    ...
    private final /* synthetic */ void update$atomicfu(Object obj, AtomicLongFieldUpdater atomicLongFieldUpdater, m56 m56) {
        long j;
        do {
            j = atomicLongFieldUpdater.get(obj);
        } while (!atomicLongFieldUpdater.compareAndSet(obj, j, ((Number) m56.invoke(Long.valueOf(j))).longValue()));
    }

    private final /* synthetic */ long updateAndGet$atomicfu(Object obj, AtomicLongFieldUpdater atomicLongFieldUpdater, m56 m56) {
        long j;
        Number number;
        do {
            j = atomicLongFieldUpdater.get(obj);
            number = (Number) m56.invoke(Long.valueOf(j));
