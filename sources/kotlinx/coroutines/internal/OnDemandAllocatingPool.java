...
public final class OnDemandAllocatingPool<T> {
    ...
    public OnDemandAllocatingPool(int i, m56 m56) {
        this.maxCapacity = i;
        this.create = m56;
    ...
    private final /* synthetic */ void loop$atomicfu(Object obj, AtomicIntegerFieldUpdater atomicIntegerFieldUpdater, m56 m56) {
        while (true) {
            m56.invoke(Integer.valueOf(atomicIntegerFieldUpdater.get(obj)));
        }
    }
    ...
    public final String stateRepresentation$kotlinx_coroutines_core() {
        ...
        j37 Y = ote.Y(0, Integer.MAX_VALUE & i);
        ArrayList arrayList = new ArrayList(z53.S(Y, 10));
        Iterator it = Y.iterator();
        while (it.hasNext()) {
