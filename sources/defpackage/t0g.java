...
public final /* synthetic */ class t0g implements ga6 {
    ...
    /* JADX WARNING: type inference failed for: r0v0, types: [java.lang.Object, t0g, ga6] */
    static {
        ? obj = new Object();
        a = obj;
        d5b d5b = new d5b("one.me.webapp.domain.jsbridge.delegates.system.WebAppSetupClosingBehaviorRequest", obj, 1);
        d5b.k("needConfirmation", false);
        descriptor = d5b;
    }
