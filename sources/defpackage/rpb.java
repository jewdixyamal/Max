...
public final class rpb implements ka5 {
    ...
    public final void d(long j2, long j3) {
        ...
        while (true) {
            ...
            if (i3 < sparseArray.size()) {
                ppb ppb = (ppb) sparseArray.valueAt(i3);
                ppb.f = false;
                ppb.a.a();
                i3++;
            } else {
    ...
    public final boolean h(ma5 ma5) {
        ...
        ra4 ra4 = (ra4) ma5;
        ra4.q(bArr, 0, 14, false);
        if (442 != (((bArr[0] & 255) << 24) | ((bArr[1] & 255) << 16) | ((bArr[2] & 255) << 8) | (bArr[3] & 255)) || (bArr[4] & 196) != 68 || (bArr[6] & 4) != 4 || (bArr[8] & 4) != 4 || (bArr[9] & 1) != 1 || (bArr[12] & 3) != 3) {
            return false;
        }
        ra4.b(bArr[13] & 7, false);
        ra4.q(bArr, 0, 3, false);
        return 1 == ((((bArr[0] & 255) << 16) | ((bArr[1] & 255) << 8)) | (bArr[2] & 255));
    }

    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r27v0, resolved type: om0} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r3v11, resolved type: jm5} */
    /* JADX WARNING: type inference failed for: r4v21, types: [jm0] */
    ...
    public final int i(defpackage.ma5 r29, defpackage.lh4 r30) {
        ...
        L_0x0055:
            ...
            byte[] r7 = r2.a
            int r7 = defpackage.opb.c(r1, r7)
            if (r7 != r6) goto L_0x006e
            int r7 = r1 + 4
            r2.H(r7)
            long r7 = defpackage.opb.f(r2)
