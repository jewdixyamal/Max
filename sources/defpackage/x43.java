...
public final class x43 {
    ...
    public final int n() {
        ...
        byte l2 = l();
        byte l3 = l();
        return ((l() & 255) << 24) | (l & 255) | ((l2 & 255) << 8) | ((l3 & 255) << 16);
    }
    ...
    public final String r() {
        ...
        int i2 = this.e;
        if (p > i - i2 || p <= 0) {
            return new String(m(p), y37.a);
        }
        String str = new String(this.a, i2, p, y37.a);
        this.e += p;
        return str;
    }
    ...
    public final void t(int i) {
        ...
        int i3 = this.b;
        if (i > i2 - i3) {
            StringBuilder n = rh4.n(i, "Position ", " is beyond current ");
            n.append(this.e - i3);
