...
public class xm6 extends zm6 {
    public static final xm6 n = new xm6("", Collections.emptyList(), Collections.emptyList(), Collections.emptyList(), Collections.emptyList(), Collections.emptyList(), Collections.emptyList(), (oy5) null, Collections.emptyList(), false, Collections.emptyMap(), Collections.emptyList());
    public final List d;
    public final List e;
    public final List f;
    public final List g;
    ...
    public xm6(String str, List list, List list2, List list3, List list4, List list5, List list6, oy5 oy5, List list7, boolean z, Map map, List list8) {
        super(str, z, list);
        ArrayList arrayList = new ArrayList();
        for (int i2 = 0; i2 < list2.size(); i2++) {
            Uri uri = ((vm6) list2.get(i2)).a;
    ...
    public static ArrayList c(int i2, List list, List list2) {
        ...
        for (int i3 = 0; i3 < list.size(); i3++) {
            ...
            while (true) {
                ...
                w8e w8e = (w8e) list2.get(i4);
                if (w8e.b == i2 && w8e.c == i3) {
                    arrayList.add(obj);
                    break;
                }
                i4++;
