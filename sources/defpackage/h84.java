...
public final class h84 implements gg0, y0f {
    ...
    public h84(Context context, Map map, int i2, rhe rhe, boolean z) {
        go9 go9;
        int i3;
        this.a = cx6.b(map);
        this.c = new btd(i2, 0);
        ...
        if (context != null) {
            ...
            this.i = i3;
            this.l = c(i3);
            f84 f84 = new f84(this);
            CopyOnWriteArrayList copyOnWriteArrayList = (CopyOnWriteArrayList) go9.e;
            ...
            copyOnWriteArrayList.add(new WeakReference(f84));
            ((Handler) go9.d).post(new do9(go9, 0, f84));
            return;
        }
        this.i = 0;
        this.l = c(0);
    ...
    public final void b(h74 h74, Handler handler) {
        h74.getClass();
        wd6 wd6 = this.b;
        wd6.getClass();
        CopyOnWriteArrayList copyOnWriteArrayList = (CopyOnWriteArrayList) wd6.b;
        Iterator it = copyOnWriteArrayList.iterator();
        while (it.hasNext()) {
            eg0 eg0 = (eg0) it.next();
            if (eg0.b == h74) {
        ...
        copyOnWriteArrayList.add(new eg0(h74, handler));
    }
    ...
    public final long c(int r1) {
        ...
        L_0x0023:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.h84.c(int):long");
    }
    ...
    public final void d(int i2, long j2, long j3) {
        if (i2 != 0 || j2 != 0 || j3 != this.m) {
            ...
            while (it.hasNext()) {
                eg0 eg0 = (eg0) it.next();
                if (!eg0.c) {
                    eg0.a.post(new t60(i2, 2, j2, j3, eg0));
                }
            }
        }
    }
    ...
    public final synchronized void f(defpackage.z24 r11, boolean r12) {
        ...
        L_0x0014:
            ...
            r0 = r1
        L_0x0019:
            defpackage.np8.f(r0)     // Catch:{ all -> 0x005c }
            rhe r11 = r10.d     // Catch:{ all -> 0x005c }
