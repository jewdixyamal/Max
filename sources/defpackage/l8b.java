...
public final class l8b {
    ...
    public final Matrix a(Size size, int i, Rect rect) {
        ...
        matrix3.setRectToRect(new RectF(0.0f, 0.0f, (float) rect.width(), (float) rect.height()), new RectF(0.0f, 0.0f, 1.0f, 1.0f), Matrix.ScaleToFit.FILL);
    ...
    public final android.graphics.Matrix c(android.util.Size r8, int r9) {
        /*
            ...
            r1 = 1
            boolean r0 = defpackage.e1f.d(r8, r1, r0)
            r2 = 0
        ...
        L_0x0070:
            o8b r6 = defpackage.o8b.FIT_CENTER
            if (r3 == r6) goto L_0x0084
            o8b r6 = defpackage.o8b.FIT_START
            if (r3 == r6) goto L_0x0084
            o8b r6 = defpackage.o8b.FIT_END
        ...
        L_0x00a7:
            ...
            int r0 = r7.c
            r1 = 0
            android.graphics.Matrix r8 = defpackage.e1f.a(r8, r9, r0, r1)
            boolean r9 = r7.f
            if (r9 == 0) goto L_0x00ec
            boolean r9 = r7.g
            if (r9 == 0) goto L_0x00ec
            int r9 = r7.c
            boolean r9 = defpackage.e1f.c(r9)
    ...
    public final Matrix d() {
        c54.p((String) null, f());
        RectF rectF = new RectF(0.0f, 0.0f, (float) this.a.getWidth(), (float) this.a.getHeight());
