...
public final class gc implements dw4 {
    ...
    public gc(boolean z, String str, int i2) {
        this.a = z;
        this.d = str;
        this.e = i2;
    }
    ...
    /* JADX WARNING: type inference failed for: r4v1, types: [int, byte, boolean] */
    ...
    public final void d(defpackage.wpa r22) {
        ...
        L_0x00c0:
            ...
            r8[r6] = r7
            s02 r2 = new s02
            r2.<init>((byte[]) r8, (int) r5, (int) r5, (byte) r4)
            e r2 = defpackage.kp.s(r2, r4)
            ny5 r7 = new ny5
            r7.<init>()
