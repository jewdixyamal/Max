...
public final class b07 {
    ...
    public b07(TextInputLayout textInputLayout) {
        ...
        this.m = (float) context.getResources().getDimensionPixelSize(stb.design_textinput_caption_translate_y);
        ...
        int i2 = tsb.motionEasingEmphasizedDecelerateInterpolator;
        LinearInterpolator linearInterpolator = og.a;
        this.e = z7.Q(context, i2, linearInterpolator);
    ...
    public final void b() {
        if (this.i != null) {
            ...
            if (textInputLayout.getEditText() != null) {
                ...
                Context context = this.g;
                boolean A2 = ju0.A(context);
                LinearLayout linearLayout = this.i;
                int i2 = stb.material_helper_text_font_1_3_padding_horizontal;
                WeakHashMap weakHashMap = zmf.a;
                int paddingStart = editText.getPaddingStart();
                if (A2) {
                    paddingStart = context.getResources().getDimensionPixelSize(i2);
                }
                int i3 = stb.material_helper_text_font_1_3_padding_top;
                ...
                int i4 = stb.material_helper_text_font_1_3_padding_horizontal;
    ...
    public final void i(int i2, int i3, boolean z2) {
        ...
        if (i4 != i5) {
            if (z3) {
                ...
                animatorSet.addListener(new zz6(this, i3, e(i2), i2, e(i5)));
                animatorSet.start();
            } else if (i4 != i5) {
