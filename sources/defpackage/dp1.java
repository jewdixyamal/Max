    ...
    public final void a(a4c a4c) {
        ...
        if (j2 > 0) {
            ...
            if (!booleanValue || atomicInteger2.get() != 0) {
                ...
                a4c.log(this.e, this.a + " -> Duration: " + millis + " ms. received: " + i2 + ", dropped: " + i3 + ", rendered: " + i4 + ", fps: " + format + ",avg render time: " + str + ", avg swapBuffer time: " + str2 + ".");
                this.g = j;
                this.f = 0;
                this.h = 0;
                this.i = 0;
