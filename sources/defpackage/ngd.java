...
public final /* synthetic */ class ngd implements k64 {
    ...
    public final Object a() {
        switch (this.a) {
            ...
            case 3:
                return new ChatTitleIconScreen((long[]) null, pyd.CHANNEL);
            case 4:
                return new StickersSettingsScreen();
            case 5:
                return new StickersScreen(a5e.RECENT, 0, 2, (z84) null);
            case 6:
                return new StickersScreen(a5e.FAVORITE, 0, 2, (z84) null);
            case 7:
