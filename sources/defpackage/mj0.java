...
public abstract class mj0 implements l5b {
    ...
    public mj0(sq8 sq8, n5b n5b, o5b o5b) {
        sq8.getClass();
        this.b = sq8;
        n5b.getClass();
        this.c = n5b;
        ...
        synchronized (this) {
            try {
                sparseArray.clear();
                SparseIntArray sparseIntArray2 = n5b.c;
                if (sparseIntArray2 != null) {
                    for (int i = 0; i < sparseIntArray2.size(); i++) {
                        ...
                        int h = h(keyAt);
                        this.c.getClass();
                        sparseArray2.put(keyAt, new ps0(h, valueAt, i2));
                    }
                    this.Y = false;
                } else {
                    this.Y = true;
    ...
    public final synchronized defpackage.ps0 d(int r4) {
        ...
        L_0x0010:
            ...
            defpackage.ta5.d(r0, r2, r1)     // Catch:{ all -> 0x0025 }
            goto L_0x0027
        L_0x0025:
            r4 = move-exception
            goto L_0x0034
        L_0x0027:
            ps0 r0 = r3.m(r4)     // Catch:{ all -> 0x0025 }
        ...
        L_0x0034:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.mj0.d(int):ps0");
    }
    ...
    public final void e(java.lang.Object r8) {
        /*
            ...
            ps0 r2 = (defpackage.ps0) r2     // Catch:{ all -> 0x00d4 }
            ...
            defpackage.ta5.b(r1, r2, r0)     // Catch:{ all -> 0x003f }
            r7.c(r8)     // Catch:{ all -> 0x003f }
            o5b r8 = r7.t0     // Catch:{ all -> 0x003f }
        ...
        L_0x0061:
            ...
            jt r2 = r7.Z     // Catch:{ all -> 0x003f }
            r2.a(r1)     // Catch:{ all -> 0x003f }
            o5b r1 = r7.t0     // Catch:{ all -> 0x003f }
            r1.getClass()     // Catch:{ all -> 0x003f }
            ft7 r1 = defpackage.ta5.a     // Catch:{ all -> 0x003f }
            ...
            java.lang.Integer r0 = java.lang.Integer.valueOf(r0)     // Catch:{ all -> 0x003f }
            defpackage.ta5.e(r1, r2, r8, r0)     // Catch:{ all -> 0x003f }
            goto L_0x00cf
        L_0x0096:
        ...
        L_0x009e:
            r5 = 0
        L_0x009f:
            defpackage.od2.p(r5)     // Catch:{ all -> 0x003f }
            int r5 = r2.e     // Catch:{ all -> 0x003f }
            int r5 = r5 - r3
            r2.e = r5     // Catch:{ all -> 0x003f }
        L_0x00a7:
            ft7 r2 = defpackage.ta5.a     // Catch:{ all -> 0x003f }
            ...
            java.lang.Integer r0 = java.lang.Integer.valueOf(r0)     // Catch:{ all -> 0x003f }
            defpackage.ta5.e(r2, r3, r4, r0)     // Catch:{ all -> 0x003f }
        L_0x00c2:
            r7.c(r8)     // Catch:{ all -> 0x003f }
            jt r8 = r7.Z     // Catch:{ all -> 0x003f }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:62:0x00f0, code lost:
        if (defpackage.ta5.a.i(2) != false) goto L_0x00f2;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:63:0x00f2, code lost:
        defpackage.ta5.e(r7.a, "get (alloc) (object, size) = (%x, %s)", java.lang.Integer.valueOf(java.lang.System.identityHashCode(r0)), java.lang.Integer.valueOf(r8));
     */
    ...
    public final java.lang.Object get(int r8) {
        ...
        L_0x0015:
            r0 = r2
        L_0x0016:
            defpackage.od2.p(r0)     // Catch:{ all -> 0x0012 }
            monitor-exit(r7)
            int r8 = r7.f(r8)
            monitor-enter(r7)
            ps0 r0 = r7.d(r8)     // Catch:{ all -> 0x0072 }
            r3 = 2
            ...
            defpackage.od2.p(r8)     // Catch:{ all -> 0x0072 }
            int r8 = r7.g(r4)     // Catch:{ all -> 0x0072 }
            int r0 = r7.h(r8)     // Catch:{ all -> 0x0072 }
            jt r1 = r7.Z     // Catch:{ all -> 0x0072 }
            ...
            jt r1 = r7.s0     // Catch:{ all -> 0x0072 }
            r1.a(r0)     // Catch:{ all -> 0x0072 }
            o5b r0 = r7.t0     // Catch:{ all -> 0x0072 }
            r0.getClass()     // Catch:{ all -> 0x0072 }
            r7.l()     // Catch:{ all -> 0x0072 }
            ft7 r0 = defpackage.ta5.a     // Catch:{ all -> 0x0072 }
            ...
            defpackage.ta5.e(r0, r1, r2, r8)     // Catch:{ all -> 0x0072 }
            goto L_0x0075
        L_0x0072:
            r8 = move-exception
            goto L_0x014a
        ...
        L_0x009a:
            r0 = move-exception
            monitor-enter(r7)
            jt r5 = r7.Z     // Catch:{ all -> 0x011c }
            r5.a(r4)     // Catch:{ all -> 0x011c }
            ps0 r4 = r7.d(r8)     // Catch:{ all -> 0x011c }
            if (r4 == 0) goto L_0x00b4
            int r5 = r4.e     // Catch:{ all -> 0x011c }
            if (r5 <= 0) goto L_0x00ac
            r1 = r2
        L_0x00ac:
            defpackage.od2.p(r1)     // Catch:{ all -> 0x011c }
        ...
        L_0x00e1:
            ...
            o5b r1 = r7.t0     // Catch:{ all -> 0x0106 }
            r1.getClass()     // Catch:{ all -> 0x0106 }
            r7.l()     // Catch:{ all -> 0x0106 }
            ft7 r1 = defpackage.ta5.a     // Catch:{ all -> 0x0106 }
            ...
            defpackage.ta5.e(r1, r2, r3, r8)     // Catch:{ all -> 0x0106 }
            goto L_0x0108
        L_0x0106:
            r8 = move-exception
            goto L_0x010c
        ...
        L_0x011f:
            ...
            n5b r0 = r7.c     // Catch:{ all -> 0x0072 }
            int r0 = r0.a     // Catch:{ all -> 0x0072 }
            jt r1 = r7.Z     // Catch:{ all -> 0x0072 }
            int r1 = r1.c     // Catch:{ all -> 0x0072 }
            jt r2 = r7.s0     // Catch:{ all -> 0x0072 }
            ...
            java.lang.StringBuilder r0 = defpackage.wg0.j(r3, r0, r5, r1, r6)     // Catch:{ all -> 0x0072 }
        ...
        L_0x014c:
            ...
            throw r8
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.mj0.get(int):java.lang.Object");
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public synchronized java.lang.Object i(defpackage.ps0 r3) {
        /*
            r2 = this;
            monitor-enter(r2)
        ...
        L_0x0011:
            ...
            goto L_0x000f
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.mj0.i(ps0):java.lang.Object");
    }
    ...
    public ps0 m(int i) {
        int h = h(i);
        this.c.getClass();
        return new ps0(h, Integer.MAX_VALUE, 0);
    }
    ...
    public final synchronized void n(int r8) {
        /*
            r7 = this;
            monitor-enter(r7)
            jt r0 = r7.Z     // Catch:{ all -> 0x0039 }
            int r0 = r0.c     // Catch:{ all -> 0x0039 }
            jt r1 = r7.s0     // Catch:{ all -> 0x0039 }
            ...
            return
        L_0x0013:
            ft7 r1 = defpackage.ta5.a     // Catch:{ all -> 0x0039 }
            r2 = 2
            ...
            jt r5 = r7.Z     // Catch:{ all -> 0x0039 }
            int r5 = r5.c     // Catch:{ all -> 0x0039 }
            jt r6 = r7.s0     // Catch:{ all -> 0x0039 }
            ...
            defpackage.ta5.f(r1, r3, r4, r5, r6)     // Catch:{ all -> 0x0039 }
            goto L_0x003b
        L_0x0039:
            r8 = move-exception
            goto L_0x0092
        ...
        L_0x004a:
            ...
            ps0 r3 = (defpackage.ps0) r3     // Catch:{ all -> 0x0039 }
        ...
        L_0x006d:
            r7.l()     // Catch:{ all -> 0x0039 }
            ft7 r0 = defpackage.ta5.a     // Catch:{ all -> 0x0039 }
        ...
        L_0x0092:
            ...
            throw r8
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.mj0.n(int):void");
    }
}
