...
public final class ij3 extends hj3 {
    ...
    /* JADX WARNING: type inference failed for: r0v1, types: [java.lang.Object, adb] */
    /* JADX WARNING: type inference failed for: r0v2, types: [java.lang.Object, qh4] */
    public ij3() {
        ? obj = new Object();
        obj.a = new ArrayList();
        obj.b = new xk0(0);
    ...
    public static void V(hj3 hj3, dob dob, xk0 xk0) {
        int i;
        int i2;
        if (dob != null) {
            if (hj3.g0 == 8 || (hj3 instanceof fh6) || (hj3 instanceof nh0)) {
                xk0.g = 0;
                xk0.h = 0;
                return;
            }
            ...
            if (z4) {
                if (iArr2[1] == 4) {
                    ...
                    xk0.d = 1;
                    if (hj3.X == -1) {
                        xk0.f = (int) (((float) i) / hj3.W);
                    } else {
                        xk0.f = (int) (hj3.W * ((float) i));
                    }
                }
            }
            dob.c(hj3, xk0);
    ...
    public final void F(cjg cjg) {
        super.F(cjg);
        int size = this.q0.size();
        for (int i = 0; i < size; i++) {
            ((hj3) this.q0.get(i)).F(cjg);
        }
    }
    ...
    public final void R(hj3 hj3, int i) {
        if (i == 0) {
            int i2 = this.z0 + 1;
            f12[] f12Arr = this.C0;
            if (i2 >= f12Arr.length) {
                this.C0 = (f12[]) Arrays.copyOf(f12Arr, f12Arr.length * 2);
            }
            f12[] f12Arr2 = this.C0;
            int i3 = this.z0;
            f12Arr2[i3] = new f12(hj3, 0, this.v0);
            this.z0 = i3 + 1;
        } else if (i == 1) {
            int i4 = this.A0 + 1;
            f12[] f12Arr3 = this.B0;
            if (i4 >= f12Arr3.length) {
                this.B0 = (f12[]) Arrays.copyOf(f12Arr3, f12Arr3.length * 2);
            }
            f12[] f12Arr4 = this.B0;
            int i5 = this.A0;
            f12Arr4[i5] = new f12(hj3, 1, this.v0);
            this.A0 = i5 + 1;
        }
    }

    public final void S(zh7 zh7) {
        boolean W = W(64);
        b(zh7, W);
        int size = this.q0.size();
        boolean z = false;
        for (int i = 0; i < size; i++) {
            hj3 hj3 = (hj3) this.q0.get(i);
            boolean[] zArr = hj3.S;
            zArr[0] = false;
            zArr[1] = false;
        ...
        if (z) {
            for (int i2 = 0; i2 < size; i2++) {
                hj3 hj32 = (hj3) this.q0.get(i2);
                if (hj32 instanceof nh0) {
                    nh0 nh0 = (nh0) hj32;
                    for (int i3 = 0; i3 < nh0.r0; i3++) {
                        hj3 hj33 = nh0.q0[i3];
                        if (nh0.t0 || hj33.c()) {
                            int i4 = nh0.s0;
                            if (i4 == 0 || i4 == 1) {
        ...
        for (int i5 = 0; i5 < size; i5++) {
            hj3 hj34 = (hj3) this.q0.get(i5);
            hj34.getClass();
            boolean z2 = hj34 instanceof nn5;
            if (z2 || (hj34 instanceof fh6)) {
                if (z2) {
                    hashSet.add(hj34);
                } else {
                    hj34.b(zh7, W);
        ...
        while (hashSet.size() > 0) {
            ...
            while (true) {
                ...
                nn5 nn5 = (nn5) ((hj3) it.next());
                int i6 = 0;
                while (true) {
                    if (i6 < nn5.r0) {
                        if (hashSet.contains(nn5.q0[i6])) {
                            nn5.b(zh7, W);
                            hashSet.remove(nn5);
                            break;
                        }
        ...
        if (zh7.p) {
            ...
            for (int i7 = 0; i7 < size; i7++) {
                hj3 hj35 = (hj3) this.q0.get(i7);
                hj35.getClass();
                if (!(hj35 instanceof nn5) && !(hj35 instanceof fh6)) {
                    hashSet2.add(hj35);
                }
            }
            a(this, zh7, hashSet2, this.p0[0] == 2 ? 0 : 1, false);
            Iterator it3 = hashSet2.iterator();
            while (it3.hasNext()) {
                hj3 hj36 = (hj3) it3.next();
                v3c.f(this, zh7, hj36);
                hj36.b(zh7, W);
            }
        } else {
            for (int i8 = 0; i8 < size; i8++) {
                hj3 hj37 = (hj3) this.q0.get(i8);
                if (hj37 instanceof ij3) {
                    int[] iArr = hj37.p0;
                    int i9 = iArr[0];
                    int i10 = iArr[1];
                    if (i9 == 2) {
                    ...
                    v3c.f(this, zh7, hj37);
                    if (!(hj37 instanceof nn5) && !(hj37 instanceof fh6)) {
                        hj37.b(zh7, W);
                    }
                }
            }
        ...
        if (this.z0 > 0) {
            i24.a(this, zh7, (ArrayList) null, 0);
        }
        if (this.A0 > 0) {
            i24.a(this, zh7, (ArrayList) null, 1);
        }
    }
    ...
    public final boolean T(int r13, boolean r14) {
        ...
        L_0x00fa:
            ...
            goto L_0x010d
        L_0x0101:
            boolean r6 = r5 instanceof defpackage.g12
        ...
        L_0x010d:
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.ij3.T(int, boolean):boolean");
    }
    ...
    public final void U() {
        /*
            ...
            int r9 = r1.D0
            boolean r9 = defpackage.v3c.k(r9, r6)
            if (r9 == 0) goto L_0x0255
            dob r9 = r1.u0
            r14 = r5[r2]
            r15 = r5[r6]
        ...
        L_0x006c:
            ...
            r22 = r11
            r11 = r21
            hj3 r11 = (defpackage.hj3) r11
            r21 = r4
            boolean r4 = r11 instanceof defpackage.fh6
            if (r4 == 0) goto L_0x00bd
            fh6 r11 = (defpackage.fh6) r11
            int r4 = r11.u0
            r23 = r5
            r5 = 1
        ...
        L_0x00bd:
            r23 = r5
            boolean r4 = r11 instanceof defpackage.nh0
            if (r4 == 0) goto L_0x00cd
            nh0 r11 = (defpackage.nh0) r11
            int r4 = r11.U()
            if (r4 != 0) goto L_0x00cd
            r19 = 1
        L_0x00cd:
        ...
        L_0x00df:
            ...
            boolean r6 = r5 instanceof defpackage.fh6
            if (r6 == 0) goto L_0x00f7
            fh6 r5 = (defpackage.fh6) r5
            int r6 = r5.u0
            r11 = 1
            if (r6 != r11) goto L_0x00f7
            r6 = 0
            defpackage.np8.z(r6, r5, r9, r2)
            goto L_0x00f8
        L_0x00f7:
            r6 = 0
        L_0x00f8:
        ...
        L_0x0102:
            ...
            java.lang.Object r5 = r12.get(r4)
            hj3 r5 = (defpackage.hj3) r5
            boolean r6 = r5 instanceof defpackage.nh0
            if (r6 == 0) goto L_0x0121
            nh0 r5 = (defpackage.nh0) r5
            int r6 = r5.U()
            if (r6 != 0) goto L_0x0121
            boolean r6 = r5.T()
            if (r6 == 0) goto L_0x0121
        ...
        L_0x013a:
            ...
            hj3 r11 = (defpackage.hj3) r11
            boolean r14 = r11 instanceof defpackage.fh6
        ...
        L_0x017e:
            ...
            goto L_0x018e
        L_0x0180:
            boolean r14 = r11 instanceof defpackage.nh0
            if (r14 == 0) goto L_0x018e
            nh0 r11 = (defpackage.nh0) r11
            int r11 = r11.U()
            r14 = 1
        ...
        L_0x0194:
            ...
            java.lang.Object r5 = r12.get(r4)
            hj3 r5 = (defpackage.hj3) r5
            boolean r11 = r5 instanceof defpackage.fh6
            if (r11 == 0) goto L_0x01aa
            fh6 r5 = (defpackage.fh6) r5
            int r11 = r5.u0
            if (r11 != 0) goto L_0x01aa
            r11 = 1
            defpackage.np8.P(r11, r5, r9)
        L_0x01aa:
            int r4 = r4 + 1
            goto L_0x0194
        L_0x01ad:
            r4 = 0
            defpackage.np8.P(r4, r1, r9)
        ...
        L_0x01d6:
            ...
            boolean r6 = defpackage.np8.b(r5)
            if (r6 == 0) goto L_0x020b
            xk0 r6 = defpackage.np8.a
            V(r5, r9, r6)
            boolean r6 = r5 instanceof defpackage.fh6
            if (r6 == 0) goto L_0x0204
            r6 = r5
            fh6 r6 = (defpackage.fh6) r6
            int r6 = r6.u0
            if (r6 != 0) goto L_0x01ff
            r6 = 0
            defpackage.np8.P(r6, r5, r9)
            goto L_0x020b
        L_0x01ff:
            r6 = 0
            defpackage.np8.z(r6, r5, r9, r2)
        ...
        L_0x020f:
            ...
            hj3 r4 = (defpackage.hj3) r4
            boolean r5 = r4.z()
            if (r5 == 0) goto L_0x0252
            boolean r5 = r4 instanceof defpackage.fh6
            if (r5 != 0) goto L_0x0252
            boolean r5 = r4 instanceof defpackage.nh0
            if (r5 != 0) goto L_0x0252
            boolean r5 = r4 instanceof defpackage.nn5
            if (r5 != 0) goto L_0x0252
            boolean r5 = r4.F
            if (r5 != 0) goto L_0x0252
            r5 = 0
        ...
        L_0x0274:
            ...
            boolean r9 = defpackage.v3c.k(r9, r11)
        ...
        L_0x0287:
            ...
            r10 = r4[r15]
            r4 = r4[r18]
            boolean r4 = defpackage.f8.E(r6, r5, r10, r4)
        ...
        L_0x02a4:
            ...
            goto L_0x0610
        L_0x02af:
            boolean r4 = r14 instanceof defpackage.nn5
        ...
        L_0x02c3:
            ...
            r2 = r8[r17]
            r8 = r8[r18]
            boolean r0 = defpackage.f8.E(r7, r0, r2, r8)
            if (r0 != 0) goto L_0x02f0
            xk0 r0 = r1.L0
            V(r3, r9, r0)
        L_0x02f0:
            boolean r0 = r3 instanceof defpackage.fh6
        ...
        L_0x0311:
            r5.add(r2)
        L_0x0314:
            boolean r2 = r3 instanceof defpackage.uj6
            if (r2 == 0) goto L_0x0358
            boolean r2 = r3 instanceof defpackage.nh0
            if (r2 == 0) goto L_0x0341
            r2 = r3
            nh0 r2 = (defpackage.nh0) r2
            int r7 = r2.U()
        ...
        L_0x0374:
            ...
            boolean r0 = r3 instanceof defpackage.nh0
            if (r0 != 0) goto L_0x0396
        ...
        L_0x03b9:
            ...
            fh6 r3 = (defpackage.fh6) r3
            r4 = 0
            r5 = 0
            defpackage.f8.e(r3, r4, r0, r5)
            goto L_0x03b9
        L_0x03cb:
            r4 = 0
            r5 = 0
        ...
        L_0x03d3:
            ...
            o5g r6 = defpackage.f8.e(r3, r4, r0, r5)
            r3.R(r4, r6, r0)
            r6.a(r0)
            r4 = 0
            r5 = 0
        ...
        L_0x0485:
            ...
            java.lang.Object r4 = r3.next()
            uj6 r4 = (defpackage.uj6) r4
            o5g r7 = defpackage.f8.e(r4, r5, r0, r6)
            r4.R(r5, r7, r0)
            r7.a(r0)
            r5 = 1
            r6 = 0
        ...
        L_0x0693:
            ...
            hj3 r12 = (defpackage.hj3) r12
            boolean r13 = r12 instanceof defpackage.ij3
            if (r13 == 0) goto L_0x06a6
            ij3 r12 = (defpackage.ij3) r12
            r12.U()
        L_0x06a6:
            int r9 = r9 + 1
            goto L_0x0693
        ...
        L_0x06c1:
            ...
            hj3 r14 = (defpackage.hj3) r14     // Catch:{ Exception -> 0x06d1 }
        ...
        L_0x06d8:
            ...
            java.lang.Object r0 = r0.get()     // Catch:{ Exception -> 0x0710 }
            oi3 r0 = (defpackage.oi3) r0     // Catch:{ Exception -> 0x0710 }
            r14 = r24
            sud r13 = r8.k(r14)     // Catch:{ Exception -> 0x070a }
            zh7 r6 = r1.w0     // Catch:{ Exception -> 0x070a }
            sud r0 = r6.k(r0)     // Catch:{ Exception -> 0x070a }
            r21 = r12
            r24 = r14
            r12 = 5
            r14 = 0
        ...
        L_0x0716:
            ...
            java.lang.Object r0 = r0.get()     // Catch:{ Exception -> 0x0706 }
            oi3 r0 = (defpackage.oi3) r0     // Catch:{ Exception -> 0x0706 }
            oi3 r6 = r1.L     // Catch:{ Exception -> 0x0706 }
            sud r6 = r8.k(r6)     // Catch:{ Exception -> 0x0706 }
            zh7 r12 = r1.w0     // Catch:{ Exception -> 0x0706 }
            sud r0 = r12.k(r0)     // Catch:{ Exception -> 0x0706 }
            r13 = 0
            r14 = 5
        ...
        L_0x073c:
            ...
            oi3 r0 = (defpackage.oi3) r0     // Catch:{ Exception -> 0x0706 }
            r6 = r22
            sud r12 = r8.k(r6)     // Catch:{ Exception -> 0x0765 }
            zh7 r13 = r1.w0     // Catch:{ Exception -> 0x0765 }
            sud r0 = r13.k(r0)     // Catch:{ Exception -> 0x0765 }
            r22 = r6
            r6 = 5
            r14 = 0
        ...
        L_0x0769:
            ...
            java.lang.ref.WeakReference r0 = r1.J0     // Catch:{ Exception -> 0x0798 }
            java.lang.Object r0 = r0.get()     // Catch:{ Exception -> 0x0798 }
            oi3 r0 = (defpackage.oi3) r0     // Catch:{ Exception -> 0x0798 }
            oi3 r6 = r1.K     // Catch:{ Exception -> 0x0798 }
            sud r6 = r8.k(r6)     // Catch:{ Exception -> 0x0798 }
            zh7 r12 = r1.w0     // Catch:{ Exception -> 0x0796 }
            sud r0 = r12.k(r0)     // Catch:{ Exception -> 0x0796 }
            r13 = 0
            r14 = 5
