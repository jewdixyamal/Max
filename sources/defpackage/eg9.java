...
public final class eg9 {
    ...
    static {
        oi9 oi9 = new oi9(eg9.class, "newSelectionJob", "getNewSelectionJob()Lkotlinx/coroutines/Job;");
        nec.a.getClass();
        i = new bc7[]{oi9};
    }

    public eg9(je7 je7, sx3 sx3, kke kke, j0e j0e, vw vwVar) {
        this.a = sx3;
        this.b = kke;
        this.c = j0e;
        this.d = vwVar;
        this.e = je7;
        q0e a2 = r0e.a(new yf9());
        this.f = a2;
        this.g = new w7c(a2);
    }

    public static zka a(gs8 gs8) {
        int ordinal = gs8.ordinal();
        if (ordinal == 0) {
    ...
    public final void e(long j) {
        vxd S = j47.S(this.a, ((w9a) this.b).a(), vx3.b, new cg9(j, this, (Continuation) null));
        this.h.o1(this, i[0], S);
    }
}
