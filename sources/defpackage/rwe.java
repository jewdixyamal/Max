...
public final class rwe implements v54 {
    ...
    public rwe(Toolbar toolbar, boolean z) {
        int i2;
        Drawable drawable;
        int i3 = i2c.abc_action_bar_up_description;
        this.a = toolbar;
        ...
        String str = null;
        k8g x = k8g.x(toolbar.getContext(), (AttributeSet) null, p3c.ActionBar, vsb.actionBarStyle, 0);
        this.o = x.n(p3c.ActionBar_homeAsUpIndicator);
        if (z) {
            int i4 = p3c.ActionBar_title;
            ...
            Drawable n2 = x.n(p3c.ActionBar_logo);
            if (n2 != null) {
                this.e = n2;
                c();
            }
            Drawable n3 = x.n(p3c.ActionBar_icon);
            if (n3 != null) {
                this.d = n3;
                c();
            }
