...
public abstract class maf {
    ...
    public static boolean A(yaf yaf, yaf yaf2, Inflater inflater) {
        if (yaf.c() <= 0) {
            return false;
        }
        if (yaf2.a.length < yaf.c()) {
            yaf2.d(yaf.c() * 2);
        }
        if (inflater == null) {
            inflater = new Inflater();
        }
        inflater.setInput(yaf.a, yaf.b, yaf.c());
        int i2 = 0;
        while (true) {
            try {
                byte[] bArr = yaf2.a;
    ...
    public static String E(String str) {
        ...
        if (str4 != null) {
            String valueOf = String.valueOf(T.substring(str2.length()));
            T = valueOf.length() != 0 ? str4.concat(valueOf) : new String(str4);
            str2 = str4;
        }
        ...
        while (true) {
            ...
            if (T.startsWith(strArr2[i2])) {
                ...
                String valueOf3 = String.valueOf(T.substring(strArr2[i2].length()));
    ...
    public static int b(long[] r4, long r5, boolean r7) {
        ...
        L_0x001a:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.maf.b(long[], long, boolean):int");
    }
    ...
    public static int d(nv7 nv7, long j2) {
        int i2 = nv7.b - 1;
        int i3 = 0;
        while (i3 <= i2) {
            int i4 = (i3 + i2) >>> 1;
