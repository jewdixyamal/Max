...
public class hj3 {
    ...
    public hj3() {
        ...
        this.G = 0;
        this.H = 0;
        oi3 oi3 = new oi3(this, 2);
        this.I = oi3;
        oi3 oi32 = new oi3(this, 3);
        this.J = oi32;
        oi3 oi33 = new oi3(this, 4);
        this.K = oi33;
        oi3 oi34 = new oi3(this, 5);
        this.L = oi34;
        oi3 oi35 = new oi3(this, 6);
        this.M = oi35;
        oi3 oi36 = new oi3(this, 8);
        this.N = oi36;
        oi3 oi37 = new oi3(this, 9);
        this.O = oi37;
        oi3 oi38 = new oi3(this, 7);
        this.P = oi38;
        oi3 oi39 = oi38;
        this.Q = new oi3[]{oi3, oi33, oi32, oi34, oi35, oi39};
    ...
    public static void p(StringBuilder sb, String str, oi3 oi3) {
        if (oi3.f != null) {
            sb.append("    ");
            sb.append(str);
            sb.append(" : [ '");
            sb.append(oi3.f);
            sb.append("'");
            if (!(oi3.h == Integer.MIN_VALUE && oi3.g == 0)) {
                sb.append(",");
                sb.append(oi3.g);
                if (oi3.h != Integer.MIN_VALUE) {
                    sb.append(",");
                    sb.append(oi3.h);
                    sb.append(",");
                }
    ...
    public final void D() {
        hj3 hj3 = this.T;
        if (hj3 != null && (hj3 instanceof ij3)) {
            ((ij3) hj3).getClass();
        }
        ArrayList arrayList = this.R;
        int size = arrayList.size();
        for (int i2 = 0; i2 < size; i2++) {
            ((oi3) arrayList.get(i2)).j();
        }
    }
    ...
    public final void E() {
        ...
        int size = arrayList.size();
        for (int i2 = 0; i2 < size; i2++) {
            oi3 oi3 = (oi3) arrayList.get(i2);
            oi3.c = false;
            oi3.b = 0;
        }
    }

    public void F(cjg cjg) {
        this.I.k();
        this.J.k();
        this.K.k();
        this.L.k();
    ...
    public void Q(zh7 zh7, boolean z2) {
        int i2;
        int i3;
        ocf ocf;
        eo6 eo6;
    ...
    public final void a(ij3 ij3, zh7 zh7, HashSet hashSet, int i2, boolean z2) {
        if (z2) {
        ...
        if (i2 == 0) {
            ...
            if (hashSet2 != null) {
                ...
                while (it.hasNext()) {
                    ((oi3) it.next()).d.a(ij3, zh7, hashSet, i2, true);
                }
            }
            ...
            if (hashSet3 != null) {
                ...
                while (it2.hasNext()) {
                    ((oi3) it2.next()).d.a(ij3, zh7, hashSet, i2, true);
                }
                return;
            }
            return;
        ...
        if (hashSet4 != null) {
            ...
            while (it3.hasNext()) {
                ((oi3) it3.next()).d.a(ij3, zh7, hashSet, i2, true);
            }
        }
        ...
        if (hashSet5 != null) {
            ...
            while (it4.hasNext()) {
                ((oi3) it4.next()).d.a(ij3, zh7, hashSet, i2, true);
            }
        }
        ...
        if (hashSet6 != null) {
            ...
            while (it5.hasNext()) {
                ((oi3) it5.next()).d.a(ij3, zh7, hashSet, i2, true);
            }
        }
    }
    ...
    public void b(defpackage.zh7 r59, boolean r60) {
        ...
        L_0x041f:
            ...
            boolean r0 = r15 instanceof defpackage.ij3
    ...
    public final void d(defpackage.zh7 r31, boolean r32, boolean r33, boolean r34, boolean r35, defpackage.sud r36, defpackage.sud r37, int r38, boolean r39, defpackage.oi3 r40, defpackage.oi3 r41, int r42, int r43, int r44, int r45, float r46, boolean r47, boolean r48, boolean r49, boolean r50, boolean r51, int r52, int r53, int r54, int r55, float r56, boolean r57) {
        ...
        L_0x01cd:
            ...
            boolean r0 = r0 instanceof defpackage.nh0
        ...
        L_0x0257:
            ...
            r22 = 5
        L_0x0261:
            boolean r4 = r3 instanceof defpackage.nh0
        ...
        L_0x042b:
            ...
            boolean r1 = r11 instanceof defpackage.nh0
            if (r1 != 0) goto L_0x043d
            boolean r1 = r15 instanceof defpackage.nh0
        ...
        L_0x047a:
            r16 = r3
        L_0x047c:
            boolean r5 = r11 instanceof defpackage.fh6
            if (r5 != 0) goto L_0x0484
            boolean r5 = r15 instanceof defpackage.fh6
            if (r5 == 0) goto L_0x0486
        L_0x0484:
            r16 = 5
        L_0x0486:
            boolean r5 = r11 instanceof defpackage.nh0
            if (r5 != 0) goto L_0x048e
            boolean r5 = r15 instanceof defpackage.nh0
    ...
    public final void e(int i2, hj3 hj3, int i3, int i4) {
        boolean z2;
        if (i2 == 7) {
            if (i3 == 7) {
                oi3 i5 = i(2);
    ...
    public final void f(oi3 oi3, oi3 oi32, int i2) {
        if (oi3.d == this) {
            e(oi3.e, oi32.d, oi32.e, i2);
        }
    }

    public final void g(zh7 zh7) {
        zh7.k(this.I);
        zh7.k(this.J);
        zh7.k(this.K);
        zh7.k(this.L);
    ...
    /* JADX WARNING: type inference failed for: r0v2, types: [ocf, r5g] */
    /* JADX WARNING: type inference failed for: r0v3, types: [r5g, eo6] */
    public final void h() {
        if (this.d == null) {
            ? r5g = new r5g(this);
            r5g.h.e = 4;
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final defpackage.hj3 l(int r2) {
        /*
            r1 = this;
        ...
        L_0x001f:
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.hj3.l(int):hj3");
    }
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final defpackage.hj3 m(int r2) {
        /*
            r1 = this;
            if (r2 != 0) goto L_0x000f
            oi3 r1 = r1.I
        ...
        L_0x001f:
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.hj3.m(int):hj3");
    }
    ...
    public final int r() {
        hj3 hj3 = this.T;
        return (hj3 == null || !(hj3 instanceof ij3)) ? this.Y : ((ij3) hj3).x0 + this.Y;
    }

    public final int s() {
        hj3 hj3 = this.T;
        return (hj3 == null || !(hj3 instanceof ij3)) ? this.Z : ((ij3) hj3).y0 + this.Z;
    }
    ...
    public String toString() {
        String str = "";
        StringBuilder l2 = au1.l(str);
        if (this.h0 != null) {
            str = zr6.l(new StringBuilder("id: "), this.h0, " ");
        }
        l2.append(str);
        l2.append("(");
        l2.append(this.Y);
    ...
    public final boolean u(int i2, int i3) {
        ...
        if (i2 == 0) {
            oi3 oi35 = this.I;
            oi3 oi36 = oi35.f;
            if (oi36 != null && oi36.c && (oi34 = oi33.f) != null && oi34.c) {
                return (oi34.d() - (oi33 = this.K).e()) - (oi35.e() + oi35.f.d()) >= i3;
            }
        } else {
            oi3 oi37 = this.J;
            oi3 oi38 = oi37.f;
            if (oi38 != null && oi38.c && (oi32 = (oi3 = this.L).f) != null && oi32.c) {
                return (oi32.d() - oi3.e()) - (oi37.e() + oi37.f.d()) >= i3;
            }
        }
        return false;
    }

    public final void v(int i2, int i3, int i4, int i5, hj3 hj3) {
        i(i2).b(hj3.i(i3), i4, i5, true);
    }
    ...
    public final boolean w(int r3) {
        ...
        L_0x001c:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.hj3.w(int):boolean");
    }

    public final boolean x() {
        oi3 oi3 = this.I;
        oi3 oi32 = oi3.f;
        if (oi32 != null && oi32.f == oi3) {
            return true;
        }
        oi3 oi33 = this.K;
        oi3 oi34 = oi33.f;
        return oi34 != null && oi34.f == oi33;
    }
