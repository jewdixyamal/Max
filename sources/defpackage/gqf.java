...
public abstract class gqf extends w1f {
    ...
    public static void Q(g2f g2f) {
        int visibility = g2f.b.getVisibility();
    ...
    /* JADX WARNING: type inference failed for: r0v0, types: [java.lang.Object, fqf] */
    ...
    public abstract ObjectAnimator S(ViewGroup viewGroup, View view, g2f g2f, g2f g2f2);

    public abstract ObjectAnimator T(ViewGroup viewGroup, View view, g2f g2f, g2f g2f2);

    public void e(g2f g2f) {
        Q(g2f);
    }
    ...
    public final android.animation.Animator l(android.view.ViewGroup r21, defpackage.g2f r22, defpackage.g2f r23) {
        ...
        L_0x005e:
            r5 = 0
        L_0x005f:
            int r10 = defpackage.gvb.save_overlay_view
        ...
        L_0x0143:
            ...
            r11.draw(r0)
            r2.endRecording()
            android.graphics.Bitmap r0 = defpackage.f2f.a(r2)
            goto L_0x0196
        L_0x0195:
            r0 = 0
        L_0x0196:
        ...
        L_0x0214:
            ...
            goto L_0x026e
        L_0x0228:
            int r0 = defpackage.gvb.save_overlay_view
            r11.setTag(r0, r10)
            eqf r0 = new eqf
    ...
    public final boolean x(g2f g2f, g2f g2f2) {
        if (g2f == null && g2f2 == null) {
            return false;
        }
        if (g2f != null && g2f2 != null && g2f2.a.containsKey("android:visibility:visibility") != g2f.a.containsKey("android:visibility:visibility")) {
            return false;
        }
        fqf R = R(g2f, g2f2);
        if (R.a) {
