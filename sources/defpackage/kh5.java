...
public final class kh5 {
    ...
    public final boolean equals(Object obj) {
        ...
        kh5 kh5 = (kh5) obj;
        return this.a == kh5.a && this.b == kh5.b && tpa.f(this.c, kh5.c) && this.d == kh5.d && tpa.f(this.e, kh5.e) && tpa.f(this.f, kh5.f);
    }

    public final int hashCode() {
        int m = h4f.m(Long.hashCode(this.a) * 31, 31, this.b);
        String str = this.c;
        return this.f.hashCode() + rh4.d(h4f.m((m + (str == null ? 0 : str.hashCode())) * 31, 31, this.d), 31, this.e);
    }
