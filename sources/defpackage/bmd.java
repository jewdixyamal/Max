...
public class bmd extends Drawable {
    public final z00 a = new z00(16, (Object) this);
    ...
    public final void b(yld yld) {
        ...
        paint.setXfermode(new PorterDuffXfermode(yld2.l ? PorterDuff.Mode.DST_IN : PorterDuff.Mode.SRC_IN));
        e();
        ...
        ValueAnimator valueAnimator3 = yld3.r;
        if (valueAnimator3 == null) {
            valueAnimator3 = ValueAnimator.ofFloat(new float[]{0.0f, ((float) (yld3.p / yld3.o)) + 1.0f});
            valueAnimator3.setRepeatMode(yld3.n);
            valueAnimator3.setRepeatCount(yld3.m);
            valueAnimator3.setDuration(yld3.o);
            valueAnimator3.setInterpolator(yld3.q);
            yld3.r = valueAnimator3;
        }
