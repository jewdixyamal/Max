...
public final class pf8 extends ArrayAdapter implements AdapterView.OnItemClickListener {
    ...
    public pf8(Context context, ArrayList arrayList) {
        ...
        TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(new int[]{qsb.mediaRouteDefaultIconDrawable, qsb.mediaRouteTvIconDrawable, qsb.mediaRouteSpeakerIconDrawable, qsb.mediaRouteSpeakerGroupIconDrawable});
        this.b = s36.n(context, obtainStyledAttributes.getResourceId(0, 0));
        this.c = s36.n(context, obtainStyledAttributes.getResourceId(1, 0));
        this.o = s36.n(context, obtainStyledAttributes.getResourceId(2, 0));
        this.X = s36.n(context, obtainStyledAttributes.getResourceId(3, 0));
