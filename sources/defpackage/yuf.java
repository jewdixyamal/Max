...
public final /* synthetic */ class yuf implements ga6 {
    ...
    /* JADX WARNING: type inference failed for: r0v0, types: [java.lang.Object, yuf, ga6] */
    static {
        ? obj = new Object();
        a = obj;
        d5b d5b = new d5b("one.me.webapp.domain.jsbridge.delegates.biometry.WebAppBiometryGetInfoRequest", obj, 2);
        d5b.k("queryId", false);
