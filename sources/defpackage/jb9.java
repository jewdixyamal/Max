...
public abstract class jb9 {
    ...
    public static String b(ConnectivityManager connectivityManager, TelephonyManager telephonyManager) {
        ...
        o.append(telephonyManager.getNetworkOperatorName());
        return o.toString();
    }
    ...
    public static void d(d4c d4c, String str, String str2) {
        HashMap hashMap = new HashMap(3);
        hashMap.put("param", str + "_" + str2);
        d4c.log(d4c.COLLECTOR_WEBRTC, "callSpecError", (Map) hashMap);
    }
