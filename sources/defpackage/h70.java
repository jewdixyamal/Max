...
public final class h70 implements f70 {
    ...
    public h70(defpackage.n90 r10, android.content.Context r11) {
        /*
            r9 = this;
            r9.<init>()
    ...
    public static AudioRecord c(int i2, n90 n90, Context context) {
        int i3 = Build.VERSION.SDK_INT;
        AudioFormat build = new AudioFormat.Builder().setSampleRate(n90.b).setChannelMask(n90.c == 1 ? 16 : 12).setEncoding(n90.d).build();
        AudioRecord.Builder builder = new AudioRecord.Builder();
        if (i3 >= 31 && context != null) {
            sk.c(builder, context);
        }
        builder.setAudioSource(n90.a);
    ...
    public final void a(ey1 ey1, q6d q6d) {
        ...
        g70 g70 = this.k;
        if (g70 != null) {
            this.a.unregisterAudioRecordingCallback(g70);
        }
        if (this.k == null) {
            this.k = new g70(this);
        }
        this.a.registerAudioRecordingCallback(q6d, this.k);
    }
    ...
    public final void d(boolean z) {
        ...
        ey1 ey1 = this.h;
        if (executor != null && ey1 != null && !Objects.equals(this.e.getAndSet(Boolean.valueOf(z)), Boolean.valueOf(z))) {
            executor.execute(new u60((Object) ey1, z, 3));
        }
    }
