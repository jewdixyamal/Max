...
public final class vq3 extends cm5 {
    ...
    public vq3(n16 n16, ArrayList arrayList, boolean z, int i2) {
        super(n16);
        this.i = arrayList;
        this.j = z;
        this.k = i2;
    ...
    public final String h(int i2) {
        jy2 jy2 = new jy2(28, new kp7(2));
        StringBuilder sb = new StringBuilder();
        x53.l0((Iterable) ((AbstractMap.SimpleEntry) this.i.get(i2)).getKey(), sb, ",", "[", "]", -1, "", jy2);
        return sb.toString();
    }
}
