...
public final class zy {
    ...
    public zy(File file, q64 q64) {
        this.b = q64 == null ? yy.f : q64;
        this.c = file;
    ...
    public final void a(FileOutputStream fileOutputStream) {
        ...
        yy yyVar = this.b;
        if (!z) {
            yyVar.a(str + ": Failed to sync file output stream", (Throwable) null);
        }
        try {
            fileOutputStream.close();
        } catch (IOException e2) {
            yyVar.a(str + ": Failed to close file output stream", e2);
        }
        File file = this.d;
        if (!file.delete()) {
            yyVar.a(str + ": Failed to delete new file " + file, (Throwable) null);
        }
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:5:0x000c, code lost:
        r3.b.a(defpackage.zr6.l(new java.lang.StringBuilder(), r3.a, ": Failed to close file output stream"), r4);
     */
    ...
    public final void b(java.io.FileOutputStream r4) {
        ...
        L_0x000b:
            ...
            java.lang.String r0 = defpackage.zr6.l(r0, r1, r2)
            yy r1 = r3.b
            r1.a(r0, r4)
        L_0x001e:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.zy.b(java.io.FileOutputStream):void");
    }
    ...
    public final FileInputStream c() {
        ...
        if (exists2 && file2.exists() && !file3.delete()) {
            yyVar.a(str + ": Failed to delete outdated new file " + file3, (Throwable) null);
        }
        try {
            if (file2.canRead()) {
    ...
    public final void e(File file, File file2) {
        ...
        if (isDirectory && !file2.delete()) {
            yyVar.a(str + ": Failed to delete file which is a directory " + file2, (Throwable) null);
        }
        if (!file.renameTo(file2)) {
            yyVar.a(str + ": Failed to rename " + file + " to " + file2, (Throwable) null);
        }
    }
    ...
    public final java.io.FileOutputStream f() {
        ...
        L_0x0065:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.zy.f():java.io.FileOutputStream");
    }
}
