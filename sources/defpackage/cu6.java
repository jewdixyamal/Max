...
public final class cu6 {
    ...
    public final void b(Bitmap bitmap, int i) {
        ...
        hm9.m("cu6", "checkRsSpeedAndForceOldBlur: time for old blur %d, tempWidth=%d", Long.valueOf(abs), Integer.valueOf(c2.getWidth()));
        long nanoTime2 = System.nanoTime();
        d(bitmap, i);
        long abs2 = Math.abs(System.nanoTime() - nanoTime2);
        hm9.m("cu6", "checkRsSpeedAndForceOldBlur: time for rs blur %d", Long.valueOf(abs2));
        if (abs2 > abs * 3) {
            c = true;
        }
    }
    ...
    public final void d(android.graphics.Bitmap r6, int r7) {
        ...
        L_0x0061:
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.cu6.d(android.graphics.Bitmap, int):void");
    }
}
