...
public final class c5f extends vr5 {
    ...
    public final void g(vae vae) {
        if (this.t0.get() || !this.t0.compareAndSet(false, true)) {
            b05.b(new IllegalStateException("This processor allows only a single Subscriber"), vae);
            return;
        }
        vae.f(this.u0);
        this.Z.set(vae);
    ...
    public final boolean h(boolean z, boolean z2, boolean z3, vae vae, pwd pwd) {
        if (this.s0) {
            pwd.clear();
            this.Z.lazySet((Object) null);
            return true;
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r8v2, resolved type: vae} */
    ...
    public final void i() {
        ...
        L_0x0069:
            ...
            r11 = r7
        L_0x0070:
            java.util.concurrent.atomic.AtomicLong r0 = r6.v0
            long r12 = r0.get()
            r4 = 0
        L_0x0078:
        ...
        L_0x00e6:
            ...
            r8 = r1
            vae r8 = (defpackage.vae) r8
            r7 = 1
            goto L_0x0016
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.c5f.i():void");
    }
