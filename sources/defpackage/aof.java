...
public final class aof implements View.OnAttachStateChangeListener, TextWatcher {
    ...
    public static void a(TextView textView) {
        ...
        for (Object obj : spans) {
            yl5 yl5 = (yl5) ((znf) obj);
            Drawable drawable = yl5.getDrawable();
            WeakHashMap weakHashMap = yl5.Y;
            if (weakHashMap.put(textView, e5f.a) == null || drawable.getCallback() == null) {
                drawable.setCallback(new wl5(yl5, weakHashMap));
    ...
    public final void onViewDetachedFromWindow(View view) {
        ...
        Spanned spanned = text instanceof Spanned ? (Spanned) text : null;
        if (spanned != null) {
            objArr = spanned.getSpans(0, textView.getText().length(), znf.class);
        }
        if (objArr == null) {
            objArr = new znf[0];
        }
