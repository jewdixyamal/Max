...
public final class x8a extends ConstraintLayout implements kre {
    public static final int V0 = tu0.G(((float) 16) * fk4.d().getDisplayMetrics().density);
    public static final int W0 = tu0.G(((float) 12) * fk4.d().getDisplayMetrics().density);
    public static final int X0 = tu0.G(((float) 24) * fk4.d().getDisplayMetrics().density);
    public static final int Y0 = tu0.G(((float) 56) * fk4.d().getDisplayMetrics().density);
    public static final int Z0 = 52;
    public final int G0 = getContext().getResources().getDimensionPixelSize(xfa.c);
    ...
    public x8a(Context context, AttributeSet attributeSet) {
        ...
        this.P0 = view;
        ms6 ms6 = new ms6(context, new ww9(5));
        ms6.setId(View.generateViewId());
        ti3 ti32 = new ti3(0, tu0.G(((float) 100) * fk4.d().getDisplayMetrics().density));
        ti32.i = 0;
        ti32.l = 0;
        ms6.setLayoutParams(ti32);
        ms6.setInitialRadius$common_release(fk4.d().getDisplayMetrics().density * 42.0f);
        this.Q0 = ms6;
    ...
    public static ImageView w(x8a x8a, Context context) {
        ImageView imageView = new ImageView(context);
        imageView.setId(xoc.m);
        imageView.setImageDrawable(x8a.getCloseBadgeDrawable());
        float f = (float) 24;
    ...
    public final void A() {
        ...
        if (layoutParams != null) {
            ...
            if (this.O0.a()) {
                ti3.t = this.P0.getId();
                ti3.setMarginStart(-tu0.G(((float) ((Z0 / 2) + 24)) * fk4.d().getDisplayMetrics().density));
            }
    ...
    public final void setChevronAppearance(w8a w8a) {
        this.U0 = w8a;
        invalidate();
    }
    ...
    public final void y() {
        ...
        if (je72.a()) {
            ...
            if (layoutParams2 != null) {
                ...
                ti32.j = i;
                if (br7.H(je73)) {
                    i5 = ((FrameLayout) je73.getValue()).getId();
                } else {
                    ti32.v = 0;
                }
                ti32.u = i5;
