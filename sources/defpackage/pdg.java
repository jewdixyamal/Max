...
public abstract class pdg {
    ...
    public static String b(Context context, int i) {
        ...
        return i != 1 ? i != 2 ? i != 3 ? resources.getString(17039370) : resources.getString(g2c.common_google_play_services_enable_button) : resources.getString(g2c.common_google_play_services_update_button) : resources.getString(g2c.common_google_play_services_install_button);
    }
    ...
    public static String c(Context context, int i) {
        ...
        String a2 = a(context);
        if (i == 1) {
            return resources.getString(g2c.common_google_play_services_install_text, new Object[]{a2});
        }
        if (i == 2) {
            return np8.A(context) ? resources.getString(g2c.common_google_play_services_wear_update_text) : resources.getString(g2c.common_google_play_services_update_text, new Object[]{a2});
        }
        if (i == 3) {
            return resources.getString(g2c.common_google_play_services_enable_text, new Object[]{a2});
        }
        if (i == 5) {
        ...
        if (i == 9) {
            return resources.getString(g2c.common_google_play_services_unsupported_text, new Object[]{a2});
        }
        if (i == 20) {
        ...
        switch (i) {
            ...
            case 18:
                return resources.getString(g2c.common_google_play_services_updating_text, new Object[]{a2});
            default:
                return resources.getString(h2c.common_google_play_services_unknown_issue, new Object[]{a2});
        }
    }
    ...
    public static String e(Context context, String str, String str2) {
        ...
        if (f == null) {
            f = resources.getString(h2c.common_google_play_services_unknown_issue);
        }
    ...
    public static String f(Context context, String str) {
        ...
        synchronized (qpd) {
            try {
                ...
                String str2 = (String) qpd.get(str);
                if (str2 != null) {
                    return str2;
                }
                int i = pe6.e;
