...
public final class wv0 {
    ...
    public final int c(int i2) {
        ...
        if (i5 > 65536) {
            ...
            if (i9 != i4) {
                throw new IllegalStateException(rh4.h("Failed rehash(): old count=", i4, i9, ", copyCount="));
            }
        }
        int a2 = a(i2);
        int[] iArr3 = this.f;
    ...
    public final String m(int i2, int[] iArr) {
        ...
        int[] iArr2 = this.f;
        int i4 = iArr2[a2 + 3];
        if (i3 == iArr2[a2] && i4 == i2 && e(i2, iArr2[a2 + 1], iArr)) {
            return this.l[a2 >> 2];
        }
        if (i4 == 0) {
            return null;
        ...
        int i5 = this.h + ((a2 >> 3) << 2);
        int i6 = iArr2[i5 + 3];
        if (i3 == iArr2[i5] && i6 == i2 && e(i2, iArr2[i5 + 1], iArr)) {
            return this.l[i5 >> 2];
        }
        int i7 = this.i;
        int i8 = this.j;
        ...
        while (i9 < i10) {
            int i11 = iArr3[i9 + 3];
            if (i3 == iArr3[i9] && i2 == i11 && e(i2, iArr3[i9 + 1], iArr)) {
                return this.l[i9 >> 2];
            }
            if (i11 == 0) {
                return null;
        ...
        for (int d2 = d(); d2 < this.m; d2 += 4) {
            if (i3 == iArr3[d2] && i2 == iArr3[d2 + 3] && e(i2, iArr3[d2 + 1], iArr)) {
                return this.l[d2 >> 2];
            }
        }
        return null;
    ...
    public final String toString() {
        ...
        return String.format("[%s: size=%d, hashSize=%d, %d/%d/%d/%d pri/sec/ter/spill (=%s), total:%d]", new Object[]{wv0.class.getName(), Integer.valueOf(this.k), Integer.valueOf(this.g), Integer.valueOf(i4), Integer.valueOf(i7), Integer.valueOf(i11), Integer.valueOf(d2), Integer.valueOf(i4 + i7 + i11 + d2), Integer.valueOf(i3)});
    }

    public wv0(wv0 wv0, boolean z, int i2, boolean z2, vv0 vv0) {
        this.a = wv0;
        this.c = i2;
        this.d = z;
        this.e = z2;
