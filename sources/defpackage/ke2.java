    ...
    public void k() {
        switch (this.c) {
            case 0:
                ...
                od2.L(new zn5(tu0.g(((ye2) chatMediaDownloadBottomSheet.y0.getValue()).v0, chatMediaDownloadBottomSheet.getViewLifecycleOwner().Q(), fg7.X), new je2((Continuation) null, chatMediaDownloadBottomSheet), 5), chatMediaDownloadBottomSheet.getViewLifecycleScope());
                return;
            default:
                super.k();
                return;
