...
public final class yz3 {
    ...
    static {
        new yz3("", (Layout.Alignment) null, (Layout.Alignment) null, (Bitmap) null, -3.4028235E38f, Integer.MIN_VALUE, Integer.MIN_VALUE, -3.4028235E38f, Integer.MIN_VALUE, Integer.MIN_VALUE, -3.4028235E38f, -3.4028235E38f, -3.4028235E38f, false, -16777216, Integer.MIN_VALUE, 0.0f);
        int i2 = oaf.a;
    }

    public yz3(CharSequence charSequence, Layout.Alignment alignment, Layout.Alignment alignment2, Bitmap bitmap, float f2, int i2, int i3, float f3, int i4, int i5, float f4, float f5, float f6, boolean z2, int i6, int i7, float f7) {
    ...
    public static defpackage.yz3 a(android.os.Bundle r29) {
        ...
        L_0x001c:
            ...
            java.lang.String r6 = defpackage.q04.a
            int r6 = r5.getInt(r6)
            java.lang.String r7 = defpackage.q04.b
            int r7 = r5.getInt(r7)
            java.lang.String r8 = defpackage.q04.c
            int r8 = r5.getInt(r8)
            java.lang.String r9 = defpackage.q04.d
            r10 = -1
            int r9 = r5.getInt(r9, r10)
            java.lang.String r10 = defpackage.q04.e
        ...
        L_0x0059:
            r5.getClass()
            hpe r9 = new hpe
            java.lang.String r10 = defpackage.hpe.d
            int r10 = r5.getInt(r10)
            java.lang.String r11 = defpackage.hpe.e
            int r11 = r5.getInt(r11)
            java.lang.String r12 = defpackage.hpe.f
        ...
        L_0x0077:
            r5.getClass()
            npc r9 = new npc
            java.lang.String r10 = defpackage.npc.c
            java.lang.String r10 = r5.getString(r10)
            r10.getClass()
            java.lang.String r11 = defpackage.npc.d
    ...
    public final Bundle b() {
        ...
        if (charSequence != null) {
            ...
            if (charSequence instanceof Spanned) {
                ...
                for (npc npc : (npc[]) spanned.getSpans(0, spanned.length(), npc.class)) {
                    npc.getClass();
                    Bundle bundle2 = new Bundle();
                    bundle2.putString(npc.c, npc.a);
                    bundle2.putInt(npc.d, npc.b);
                    arrayList.add(q04.a(spanned, npc, 1, bundle2));
                }
                for (hpe hpe : (hpe[]) spanned.getSpans(0, spanned.length(), hpe.class)) {
                    hpe.getClass();
                    Bundle bundle3 = new Bundle();
                    bundle3.putInt(hpe.d, hpe.a);
                    bundle3.putInt(hpe.e, hpe.b);
                    bundle3.putInt(hpe.f, hpe.c);
                    arrayList.add(q04.a(spanned, hpe, 2, bundle3));
                }
                for (do6 a2 : (do6[]) spanned.getSpans(0, spanned.length(), do6.class)) {
                    arrayList.add(q04.a(spanned, a2, 3, (Bundle) null));
                }
    ...
    public final boolean equals(Object obj) {
        ...
        yz3 yz3 = (yz3) obj;
        if (TextUtils.equals(this.a, yz3.a) && this.b == yz3.b && this.c == yz3.c) {
            Bitmap bitmap = yz3.d;
            Bitmap bitmap2 = this.d;
            if (bitmap2 != null ? !(bitmap == null || !bitmap2.sameAs(bitmap)) : bitmap == null) {
                if (this.e == yz3.e && this.f == yz3.f && this.g == yz3.g && this.h == yz3.h && this.i == yz3.i && this.j == yz3.j && this.k == yz3.k && this.l == yz3.l && this.m == yz3.m && this.n == yz3.n && this.o == yz3.o && this.p == yz3.p && this.q == yz3.q) {
                    return true;
                }
            }
        }
