...
public abstract class dy7 implements qsd {
    ...
    static {
        pe5 pe5 = new pe5("CLIENT_TELEMETRY", 1);
        k = pe5;
        l = new pe5[]{pe5};
    }
    ...
    public static final java.lang.String F(android.content.Context r7) {
        ...
        L_0x0014:
            ...
            java.io.File r7 = defpackage.lk5.J(r7, r0)     // Catch:{ IOException -> 0x007b }
            defpackage.m6d.y(r7)     // Catch:{ IOException -> 0x007b }
        ...
        L_0x002b:
            ...
            goto L_0x003f
        L_0x002d:
            java.lang.String r0 = defpackage.lk5.I(r7)     // Catch:{ IOException -> 0x002b }
            java.lang.CharSequence r0 = defpackage.w9e.b1(r0)     // Catch:{ IOException -> 0x002b }
        ...
        L_0x004e:
            ...
            r6.<init>(r7)     // Catch:{  }
            java.nio.charset.Charset r7 = defpackage.a52.a     // Catch:{ all -> 0x0074 }
    ...
    public static final void G(y3d y3d, long j2, m56 m56) {
        z3a z3a = new z3a(j2);
        y3a y3a = y3a.a;
        f8.c(3, y3a);
        Symbol symbol = b4d.a;
        w3d w3d = new w3d(y3d, z3a, y3a, a4d.a, b4d.e, (ffe) m56, (c66) null);
    ...
    public static final EnumSet I(String str) {
        ...
        while (((i37) it).c) {
            try {
                obj = pa2.valueOf(jSONArray.getString(((i37) it).a()));
            } catch (Throwable th) {
                obj = new njc(th);
            }
    ...
    public static hhg N(Context context) {
        fp3.n(context);
        ...
        if (a2 == 0) {
            ...
            try {
                ...
                try {
                    hhg hhg3 = n;
                    oy9 oy92 = new oy9(O(context, 0).getResources());
                    Parcel G02 = hhg3.G0();
                    agg.c(G02, oy92);
    ...
    public static Context O(Context context, int i2) {
        Context context2;
        Context context3 = m;
        if (context3 != null) {
            return context3;
        ...
        try {
            context2 = lu4.b(context, lu4.b, str).a;
        } catch (Exception unused) {
            if (!str.equals("com.google.android.gms.maps_dynamite")) {
                try {
                    context2 = lu4.b(context, lu4.b, "com.google.android.gms.maps_dynamite").a;
    ...
    /* JADX WARNING: type inference failed for: r0v4, types: [hhg, cdg] */
    public static hhg P(Context context, int i2) {
        Class<?> loadClass;
        ...
        try {
            ...
            if (iBinder != null) {
                ...
                return queryLocalInterface instanceof hhg ? (hhg) queryLocalInterface : new cdg(iBinder, "com.google.android.gms.maps.internal.ICreator", 3);
            }
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static final void d(java.io.File r3, java.util.List r4) {
        /*
        ...
        L_0x002d:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.dy7.d(java.io.File, java.util.List):void");
    }

    public static void e(n16 n16, int i2, FrgBase frgBase, String str) {
        n16.getClass();
        he0 he0 = new he0(n16);
        he0.f(i2, frgBase, str, 1);
        he0.d(false);
    }
    ...
    public static final java.lang.CharSequence f(java.lang.CharSequence r9, android.widget.TextView r10, int r11) {
        /*
            ...
            boolean r0 = defpackage.w9e.C0(r9)
        ...
        L_0x0066:
            ...
            if (r2 == 0) goto L_0x0071
            java.lang.Object r2 = defpackage.ys.e0(r2)     // Catch:{ Exception -> 0x0134 }
            android.text.style.ImageSpan r2 = (android.text.style.ImageSpan) r2     // Catch:{ Exception -> 0x0134 }
            goto L_0x0072
        L_0x0071:
            r2 = r1
        ...
        L_0x00d0:
            ...
            defpackage.w9e.b1(r1)     // Catch:{ Exception -> 0x0134 }
    ...
    public static final Bundle g(kpa... kpaArr) {
        Bundle bundle = new Bundle(kpaArr.length);
        for (kpa kpa : kpaArr) {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r0v3, resolved type: y6g} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r0v5, resolved type: z6g} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r0v6, resolved type: y6g} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r0v7, resolved type: y6g} */
    /* JADX WARNING: Multi-variable type inference failed */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static final void i(android.app.Activity r6, boolean r7) {
        /*
        ...
        L_0x0033:
            ...
            z6g r0 = new z6g
            android.view.WindowInsetsController r3 = r6.getInsetsController()
            r0.<init>(r3, r1)
            r0.k = r6
            goto L_0x0056
        L_0x0051:
        ...
        L_0x005c:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.dy7.i(android.app.Activity, boolean):void");
    }
    ...
    public static final void j(android.app.Activity r6, boolean r7) {
        ...
        L_0x0045:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.dy7.j(android.app.Activity, boolean):void");
    }
    ...
    public static ty4 n(n85 n85) {
        long elapsedRealtime = SystemClock.elapsedRealtime();
        int length = n85.length();
        int i2 = 0;
        for (int i3 = 0; i3 < length; i3++) {
            if (n85.q(i3, elapsedRealtime)) {
                i2++;
            }
        }
    ...
    public static final Map q(byte[] bArr) {
        if (bArr == null) {
            return oz4.a;
        }
        zw5 zw5 = new zw5(0);
        qw8.mergeFrom(zw5, bArr);
        EnumMap enumMap = new EnumMap(pa2.class);
        long[] jArr = (long[]) zw5.b;
        if (!(!(jArr.length == 0))) {
            return enumMap;
        }
        enumMap.put(pa2.A0, jArr);
        return enumMap;
    }

    public static final Set r(byte[] bArr) {
        if (bArr == null) {
            return wz4.a;
        }
        zw5 zw5 = new zw5(1);
    ...
    public static final List s(byte[] bArr) {
        if (bArr == null) {
            return nz4.a;
        }
        zw5 zw5 = new zw5(2);
    ...
    public static int t(java.lang.String r72, int r73, int r74, float r75) {
        /*
            ...
            java.lang.String r10 = defpackage.rh4.h(r10, r1, r2, r11)
    ...
    public static final ArrayList x(p4d p4d) {
        aqd aqd;
        p4d.getClass();
        ArrayList arrayList = new ArrayList(p4d.a);
        ...
        while (it2.hasNext()) {
            ...
            Uri a2 = awa.b(r4d.c, up7) ? awa.a(r4d.c, up7) : I.v0;
            boolean z = up7.a == 7;
            Uri parse = Uri.parse(aqd.b);
            awa awa = r4d.c;
            arrayList3.add(new q4d(I, z, parse, a2, (String) null, (RectF) null, (Rect) null, awa != null ? awa.X : null));
        }
        return arrayList3;
    }
    ...
    public static final PointF y(Context context) {
        ivc u = tpa.u(context);
        int G = u.b - tu0.G(((float) 118) * fk4.d().getDisplayMetrics().density);
        float f2 = (float) 16;
        return new PointF((float) rh4.q(f2, fk4.d().getDisplayMetrics().density, G), (float) (rh4.q(f2, fk4.d().getDisplayMetrics().density, u.a - tu0.G(((float) 174) * fk4.d().getDisplayMetrics().density)) - u.d));
    }
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static void z(java.io.File r2, java.io.File r3) {
        /*
            ...
            defpackage.ema.l(r0, r3, r2)     // Catch:{ all -> 0x001e }
            r2 = 0
            defpackage.v3c.i(r3, r2)     // Catch:{ all -> 0x001c }
            defpackage.v3c.i(r0, r2)
            return
        L_0x001c:
            r2 = move-exception
        ...
        L_0x0026:
            ...
            throw r3
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.dy7.z(java.io.File, java.io.File):void");
    }
