...
public final /* synthetic */ class oig implements Runnable {
    ...
    public /* synthetic */ oig(vjg vjg, int i) {
        this.a = i;
        this.b = vjg;
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:34:0x0071, code lost:
        ...
        r4.putString("pkg", ((android.content.Context) r3.a).getPackageName());
        r4.putBundle("data", r1.d);
        r6.setData(r4);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:36:?, code lost:
        r1 = r0.c;
        r3 = (android.os.Messenger) r1.b;
     */
    ...
    public final void run() {
        ...
        L_0x003c:
            ...
            ckg r1 = (defpackage.ckg) r1     // Catch:{ all -> 0x002c }
            android.util.SparseArray r3 = r0.X     // Catch:{ all -> 0x002c }
            int r4 = r1.a     // Catch:{ all -> 0x002c }
            r3.put(r4, r1)     // Catch:{ all -> 0x002c }
            pkg r3 = r0.Y     // Catch:{ all -> 0x002c }
            java.lang.Object r3 = r3.c     // Catch:{ all -> 0x002c }
            java.util.concurrent.ScheduledExecutorService r3 = (java.util.concurrent.ScheduledExecutorService) r3     // Catch:{ all -> 0x002c }
            ihg r4 = new ihg     // Catch:{ all -> 0x002c }
            r5 = 3
            r4.<init>((java.lang.Object) r0, (int) r5, (java.lang.Object) r1)     // Catch:{ all -> 0x002c }
        ...
        L_0x0071:
            ...
            r4.putBundle(r3, r1)
            r6.setData(r4)
            djb r1 = r0.c     // Catch:{ RemoteException -> 0x00cd }
            java.lang.Object r3 = r1.b     // Catch:{ RemoteException -> 0x00cd }
            android.os.Messenger r3 = (android.os.Messenger) r3     // Catch:{ RemoteException -> 0x00cd }
            if (r3 == 0) goto L_0x00b5
            r3.send(r6)     // Catch:{ RemoteException -> 0x00cd }
            goto L_0x0022
        L_0x00b5:
            java.lang.Object r1 = r1.c     // Catch:{ RemoteException -> 0x00cd }
            sgg r1 = (defpackage.sgg) r1     // Catch:{ RemoteException -> 0x00cd }
        ...
        L_0x00d7:
            ...
            throw r8
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.oig.run():void");
    }
}
