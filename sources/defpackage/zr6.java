...
public abstract /* synthetic */ class zr6 {
    ...
    public static hob e(oec oec, Class cls, String str, String str2, int i) {
        oec.getClass();
        return new hob(cls, str, str2, i);
    }

    public static hob f(Class cls, String str, String str2, int i, oec oec) {
        hob hob = new hob(cls, str, str2, i);
        oec.getClass();
        return hob;
    }
