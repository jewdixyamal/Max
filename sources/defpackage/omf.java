...
public abstract class omf {
    ...
    public static x6g b(View view, x6g x6g, Rect rect) {
        WindowInsets e = x6g.e();
        if (e != null) {
            return x6g.f(view, view.computeSystemWindowInsets(e, rect));
        }
        rect.setEmpty();
        return x6g;
    }
    ...
    public static x6g j(View view) {
        ...
        try {
            ...
            m6g n6g = Build.VERSION.SDK_INT >= 30 ? new n6g() : new m6g();
            n6g.i(v27.b(rect.left, rect.top, rect.right, rect.bottom));
            n6g.f(v27.b(rect2.left, rect2.top, rect2.right, rect2.bottom));
            x6g b = n6g.b();
            b.a.q(b);
    ...
    public static void u(View view, y2a y2a) {
        if (Build.VERSION.SDK_INT < 30) {
            view.setTag(twb.tag_on_apply_window_listener, y2a);
        }
        if (y2a == null) {
            ...
            view.setOnApplyWindowInsetsListener(new nmf(view, y2a));
        }
    }
