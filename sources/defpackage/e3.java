...
public abstract class e3 {
    ...
    public e3(Context context, String str, mi5 mi5) {
        this.f = context;
        this.e = "Prefs/" + str.replace(".prefs", "");
        this.g = new ne7(context, new li5(str), mi5, new fd7(this));
    }
    ...
    public final void l(String str, Long l) {
        ji5 ji5 = (ji5) this.g.edit();
        ji5.putLong(str, l.longValue());
        ji5.apply();
    }

    public final void m(String str, String str2) {
        ji5 ji5 = (ji5) this.g.edit();
        ji5.putString(str, str2);
        ji5.apply();
    }
}
