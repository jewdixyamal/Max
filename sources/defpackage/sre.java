...
public abstract class sre {
    ...
    public static void a(Context context, AttributeSet attributeSet, int i, int i2) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, z2c.ThemeEnforcement, i, i2);
        boolean z = obtainStyledAttributes.getBoolean(z2c.ThemeEnforcement_enforceMaterialTheme, false);
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:7:0x001e, code lost:
        if (r0.getResourceId(defpackage.z2c.ThemeEnforcement_android_textAppearance, -1) != -1) goto L_0x0020;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static void b(android.content.Context r5, android.util.AttributeSet r6, int[] r7, int r8, int r9, int... r10) {
        /*
            int[] r0 = defpackage.z2c.ThemeEnforcement
            android.content.res.TypedArray r0 = r5.obtainStyledAttributes(r6, r0, r8, r9)
            int r1 = defpackage.z2c.ThemeEnforcement_enforceTextAppearance
            r2 = 0
        ...
        L_0x0013:
            ...
            int r5 = defpackage.z2c.ThemeEnforcement_android_textAppearance
        ...
        L_0x0043:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.sre.b(android.content.Context, android.util.AttributeSet, int[], int, int, int[]):void");
    }
