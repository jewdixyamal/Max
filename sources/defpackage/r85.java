...
public abstract class r85 extends a4 {
    ...
    public static final hx9 o = new Object();
    public static final buc p = new Object();
    ...
    public final l4 l(int i2) {
        AccessibilityNodeInfo obtain = AccessibilityNodeInfo.obtain();
        l4 l4Var = new l4(obtain);
        ...
        u(i2, l4Var);
        if (l4Var.g() == null && obtain.getContentDescription() == null) {
            ...
            if ((actions & 64) != 0) {
                ...
                if (rect3.equals(rect)) {
                    ...
                    if (l4Var.b != -1) {
                        ...
                        for (int i3 = l4Var.b; i3 != -1; i3 = l4Var2.b) {
                            l4Var2.b = -1;
    ...
    public final void p(int r4) {
        ...
        L_0x0021:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.r85.p(int):void");
    }

    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r7v3, resolved type: l4} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r7v4, resolved type: java.lang.Object} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r7v5, resolved type: l4} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r7v6, resolved type: java.lang.Object} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r7v18, resolved type: l4} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r7v19, resolved type: l4} */
    ...
    public final boolean q(int r20, android.graphics.Rect r21) {
        ...
        L_0x0106:
            ...
            r10 = r10[r11]
            l4 r10 = (defpackage.l4) r10
            if (r10 != r4) goto L_0x0111
            goto L_0x0156
        L_0x0111:
            r9.getClass()
            r10.f(r7)
            boolean r12 = defpackage.c54.J(r1, r3, r7)
            if (r12 != 0) goto L_0x011e
            goto L_0x0156
        L_0x011e:
            boolean r12 = defpackage.c54.J(r1, r3, r2)
            if (r12 != 0) goto L_0x0125
            goto L_0x0151
        L_0x0125:
            boolean r12 = defpackage.c54.f(r1, r3, r7, r2)
            if (r12 == 0) goto L_0x012c
            goto L_0x0151
        L_0x012c:
            boolean r12 = defpackage.c54.f(r1, r3, r2, r7)
            if (r12 == 0) goto L_0x0133
            goto L_0x0156
        L_0x0133:
            int r12 = defpackage.c54.M(r1, r3, r7)
            int r13 = defpackage.c54.N(r1, r3, r7)
            int r15 = r12 * 13
            int r15 = r15 * r12
            int r13 = r13 * r13
            int r13 = r13 + r15
            int r12 = defpackage.c54.M(r1, r3, r2)
            int r15 = defpackage.c54.N(r1, r3, r2)
            int r17 = r12 * 13
            int r17 = r17 * r12
            int r15 = r15 * r15
            int r15 = r15 + r17
    ...
    public final l4 r(int i2) {
        ...
        if (obtain.getChildCount() <= 0 || arrayList.size() <= 0) {
            ...
            for (int i3 = 0; i3 < size; i3++) {
                l4Var.a.addChild(view, ((Integer) arrayList.get(i3)).intValue());
            }
            return l4Var;
        }
    ...
    public abstract void u(int i2, l4 l4Var);
    ...
    public final void x(int r3, int r4) {
        ...
        L_0x001d:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.r85.x(int, int):void");
    }
}
