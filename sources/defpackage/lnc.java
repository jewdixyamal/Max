...
public final class lnc extends Drawable {
    ...
    public lnc(ColorStateList colorStateList, float f2) {
        this.a = f2;
    ...
    public final void b(Rect rect) {
        ...
        rect2.set(rect);
        if (this.f) {
            rect2.inset((int) Math.ceil((double) mnc.a(this.e, this.a, this.g)), (int) Math.ceil((double) mnc.b(this.e, this.a, this.g)));
            rectF.set(rect2);
        }
    }
    ...
    public final boolean isStateful() {
        ...
        L_0x001d:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.lnc.isStateful():boolean");
    }
