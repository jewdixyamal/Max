...
public final class ewa implements View.OnClickListener, o63 {
    ...
    public ewa(View view, jp jpVar) {
        ...
        yr0 yr0 = (yr0) view.findViewById(xxb.act_photo_editor__view_brush_width);
        this.t0 = yr0;
        ((BrushWidthViewImpl) yr0).D0.add(this);
        Context context = view.getContext();
        khe khe = sme.a0;
        sme R = fm9.R(context);
        view.setBackgroundColor(R.m);
        View findViewById = view.findViewById(xxb.act_photo_editor__rl_buttons);
        int i = R.H;
        ...
        imageButton3.setColorFilter(R.k);
        imageButton3.setBackground(R.a());
        imageButton2.setColorFilter(i2);
        imageButton2.setBackground(R.a());
        textView.setTextColor(new ColorStateList(new int[][]{new int[]{-16842910}, new int[0]}, new int[]{R.M, R.F}));
        textView.setBackground(hm9.L(0, R.i));
        ...
        Drawable a2 = qic.a(resources, i4, (Resources.Theme) null);
        a2.setColorFilter(-1, PorterDuff.Mode.SRC_ATOP);
        this.u0.setCompoundDrawablesRelativeWithIntrinsicBounds(a2, (Drawable) null, (Drawable) null, (Drawable) null);
        this.u0.setCompoundDrawablePadding(b2.h);
    ...
    public final void b(tj3 tj3) {
        Iterator it = this.a.iterator();
        while (it.hasNext()) {
            tj3.accept((zva) it.next());
        }
    }
    ...
    public final void c(int i) {
        ...
        imageButton.setBackground(hm9.S(Integer.valueOf(i), (Integer) null, (Integer) null));
    ...
    public final void onClick(View view) {
        ...
        if (id == xxb.act_photo_editor__btn_undo) {
            b(new al9(14));
        } else if (id == xxb.act_photo_editor__btn_close) {
            b(new al9(15));
        } else if (id == xxb.act_photo_editor__btn_done) {
            b(new al9(16));
        } else if (id == xxb.act_photo_editor__btn_clear) {
            b(new al9(17));
        } else if (id == xxb.act_photo_editor__btn_line_width) {
