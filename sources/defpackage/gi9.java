...
public final class gi9 {
    ...
    public static String k(gi9 gi9, String str, String str2, int i) {
        gi9 gi92 = gi9;
        String str3 = "";
    ...
    public final int e(long r29) {
        ...
        L_0x01c9:
            ...
            goto L_0x0016
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.gi9.e(long):int");
    }
        ...
        if (length >= 0) {
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & -9187201950435737472L) != -9187201950435737472L) {
                    int i2 = 8 - ((~(i - length)) >>> 31);
                    for (int i3 = 0; i3 < i2; i3++) {
                        if ((255 & j) < 128 && !gi9.d(jArr[(i << 3) + i3])) {
                            return false;
                        }
                        j >>= 8;
                    }
