...
public final /* synthetic */ class g1g implements ga6 {
    ...
    /* JADX WARNING: type inference failed for: r0v0, types: [java.lang.Object, g1g, ga6] */
    static {
        ? obj = new Object();
        a = obj;
        d5b d5b = new d5b("one.me.webapp.domain.jsbridge.delegates.storage.WebAppStorageClearRequest", obj, 2);
        d5b.k("queryId", false);
