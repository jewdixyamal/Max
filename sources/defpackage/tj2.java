...
public final class tj2 extends ffe implements a66 {
    ...
    public tj2(ck2 ck2, long j, String str, long j2, long j3, boolean z, Continuation continuation) {
    ...
    public final Object o(Object obj) {
        ...
        if (i == 0) {
            od2.a0(obj);
            this.X = 1;
            if (((wrc) this.Y.C0.getValue()).a(this.Z, this.s0, this.t0, this.u0, this.v0, this) == tx3) {
                return tx3;
            }
        } else if (i == 1) {
            od2.a0(obj);
