...
public final class h3f implements ka5 {
    ...
    public h3f() {
        /*
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.h3f.<init>():void");
    }
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r3v6, resolved type: om0} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r2v13, resolved type: jm5} */
    /* JADX WARNING: type inference failed for: r6v4, types: [ty, java.lang.Object] */
    /* JADX WARNING: type inference failed for: r4v15, types: [jm0] */
    ...
    public final int i(defpackage.ma5 r32, defpackage.lh4 r33) {
        ...
        L_0x007a:
            ...
            long r6 = defpackage.s5c.X(r8, r3, r0)
        ...
        L_0x00db:
            ...
            goto L_0x00f2
        L_0x00e4:
            long r3 = defpackage.s5c.X(r8, r1, r0)
        ...
        L_0x0136:
            ...
            r14 = r26
            r16 = r23
            r3.<init>((defpackage.jm0) r4, (defpackage.mm0) r5, (long) r6, (long) r8, (long) r10, (long) r12, (long) r14, (int) r16)
            r0.j = r2
            oa5 r3 = r0.k
        ...
        L_0x02ea:
            ...
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.h3f.i(ma5, lh4):int");
    }

    public final void release() {
    }

    public h3f(int i2, sue sue, df4 df4) {
        this.e = df4;
        this.a = i2;
        if (i2 == 1 || i2 == 2) {
            this.b = Collections.singletonList(sue);
        } else {
        ...
        for (int i3 = 0; i3 < size; i3++) {
            sparseArray.put(sparseArray2.keyAt(i3), (m3f) sparseArray2.valueAt(i3));
        }
