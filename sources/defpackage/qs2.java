...
public abstract class qs2 {
    public static rs2 a(byte[] bArr) {
        try {
            ...
            return new rs2(j, j2, j3, 0, (String) null, false, str, (HashMap) null, str2, str3, a20, l, chatUpdate.notifyPin, 0);
