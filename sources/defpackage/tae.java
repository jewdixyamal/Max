...
public final class tae implements obe {
    ...
    public final void G(byte[] bArr, int i, int i2, nbe nbe, pj3 pj3) {
        ...
        long j = nbe2.b;
        ArrayList<b04> arrayList = (j == -9223372036854775807L || !nbe2.a) ? null : new ArrayList<>();
        while (true) {
            String h = wpa.h(C);
            if (h == null) {
                break;
                ...
                try {
                    ...
                    if (matcher.matches()) {
                        long b2 = b(matcher, 1);
                        long b3 = b(matcher, 6);
                        StringBuilder sb = tae.a;
                        sb.setLength(0);
                        ArrayList arrayList2 = tae.b;
                        arrayList2.clear();
                        String h3 = wpa.h(C);
                        ...
                        if (j == -9223372036854775807L || b2 >= j) {
                            pj32 = pj3;
                            pj32.accept(new b04(b2, j2 - b2, zw6.n(a(fromHtml, str))));
                        } else {
                            if (arrayList != null) {
                                arrayList.add(new b04(b2, j2 - b2, zw6.n(a(fromHtml, str))));
                            }
                            pj32 = pj3;
                        }
                    } else {
                        pj32 = pj33;
                        z04.c0("Skipping invalid timing: ".concat(h2));
                    }
                    pj33 = pj32;
                    tae = this;
                } catch (NumberFormatException unused) {
                    pj32 = pj33;
                    z04.c0("Skipping invalid index: ".concat(h));
                }
            }
        }
        pj3 pj36 = pj33;
        if (arrayList != null) {
            for (b04 accept : arrayList) {
                pj36.accept(accept);
            }
        }
    }
