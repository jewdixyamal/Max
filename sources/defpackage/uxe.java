...
public final class uxe {
    ...
    public final us e = new qpd(0);
    public final ScheduledExecutorService f;
    public boolean g = false;
    public final sxe h;

    /* JADX WARNING: type inference failed for: r0v0, types: [qpd, us] */
    public uxe(FirebaseMessaging firebaseMessaging, jjf jjf, sxe sxe, bwf bwf, Context context, ScheduledThreadPoolExecutor scheduledThreadPoolExecutor) {
    ...
    public static void a(ukg ukg) {
        try {
            j1e.c(ukg, 30, TimeUnit.SECONDS);
    ...
    public final void b(String str) {
        ...
        a(bwf.g(bwf.n(a2, "/topics/" + str, bundle)));
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:38:0x005a, code lost:
        if (((java.util.ArrayDeque) r2.o).remove(r3) == false) goto L_0x006a;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:39:0x005c, code lost:
        ((java.util.concurrent.Executor) r2.X).execute(new defpackage.u3c(14, r2));
     */
    ...
    public final boolean e() {
        ...
        L_0x0000:
            monitor-enter(r6)
            sxe r0 = r6.h     // Catch:{ all -> 0x000c }
            rxe r0 = r0.a()     // Catch:{ all -> 0x000c }
            r1 = 1
        ...
        L_0x007d:
            ...
            qne r3 = (defpackage.qne) r3     // Catch:{ all -> 0x007b }
    ...
    public final void f(long j2) {
        this.f.schedule(new wxe(this, this.a, this.b, Math.min(Math.max(30, 2 * j2), i)), j2, TimeUnit.SECONDS);
        d(true);
    }
}
