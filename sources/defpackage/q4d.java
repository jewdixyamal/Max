...
public final class q4d implements Parcelable {
    ...
    public q4d(zp7 zp7, boolean z, Uri uri, Uri uri2, String str, RectF rectF, Rect rect, Uri uri3) {
        this.a = zp7;
        this.b = z;
        this.c = uri;
        this.o = uri2;
    ...
    public final boolean equals(Object obj) {
        ...
        q4d q4d = (q4d) obj;
        return tpa.f(this.a, q4d.a) && this.b == q4d.b && tpa.f(this.c, q4d.c) && tpa.f(this.o, q4d.o) && tpa.f(this.X, q4d.X) && tpa.f(this.Y, q4d.Y) && tpa.f(this.Z, q4d.Z) && tpa.f(this.s0, q4d.s0);
    }

    public final int hashCode() {
        int hashCode = (this.o.hashCode() + ((this.c.hashCode() + ms2.d(this.a.hashCode() * 31, 31, this.b)) * 31)) * 31;
        int i = 0;
        String str = this.X;
