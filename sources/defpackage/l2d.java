...
public abstract class l2d extends v2d {
    ...
    public l2d(q4c q4c, long j, long j2, long j3, long j4, List list, long j5, long j6, long j7) {
        super(q4c, j, j2);
        this.d = j3;
        this.e = j4;
        this.f = list;
    ...
    public final long h(long j) {
        long j2 = this.d;
        List list = this.f;
        return maf.J(list != null ? ((r2d) list.get((int) (j - j2))).a - this.b : (j - j2) * this.e, 1000000, this.a);
    }

    public abstract q4c i(long j, khc khc);
