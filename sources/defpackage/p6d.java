...
public final class p6d implements Executor {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:19:0x0033, code lost:
        if (r7.o != r3) goto L_0x003e;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:21:0x0037, code lost:
        if (r7.c != 2) goto L_0x003e;
     */
    ...
    public final void execute(java.lang.Runnable r8) {
        /*
            ...
            goto L_0x0066
        L_0x000f:
            long r3 = r7.o     // Catch:{ all -> 0x0064 }
            tqc r1 = new tqc     // Catch:{ all -> 0x0064 }
            r5 = 1
            r1.<init>(r8, r5)     // Catch:{ all -> 0x0064 }
            java.util.ArrayDeque r8 = r7.b     // Catch:{ all -> 0x0064 }
            r8.add(r1)     // Catch:{ all -> 0x0064 }
            r8 = 2
            r7.c = r8     // Catch:{ all -> 0x0064 }
            monitor-exit(r0)     // Catch:{ all -> 0x0064 }
            java.util.concurrent.Executor r0 = r7.a     // Catch:{ Error | RuntimeException -> 0x0042 }
            h76 r5 = r7.X     // Catch:{ Error | RuntimeException -> 0x0042 }
        ...
        L_0x002c:
            java.util.ArrayDeque r0 = r7.b
            monitor-enter(r0)
            long r5 = r7.o     // Catch:{ all -> 0x003c }
            int r1 = (r5 > r3 ? 1 : (r5 == r3 ? 0 : -1))
            if (r1 != 0) goto L_0x003e
            int r1 = r7.c     // Catch:{ all -> 0x003c }
            if (r1 != r8) goto L_0x003e
            r7.c = r2     // Catch:{ all -> 0x003c }
            goto L_0x003e
        L_0x003c:
            r7 = move-exception
            goto L_0x0040
        ...
        L_0x0042:
            ...
            monitor-enter(r2)
            int r3 = r7.c     // Catch:{ all -> 0x005f }
            r4 = 1
            if (r3 == r4) goto L_0x004d
            if (r3 != r8) goto L_0x0056
        L_0x004d:
            java.util.ArrayDeque r7 = r7.b     // Catch:{ all -> 0x005f }
        ...
        L_0x0064:
            ...
            goto L_0x006d
        L_0x0066:
            java.util.ArrayDeque r7 = r7.b     // Catch:{ all -> 0x0064 }
        ...
        L_0x006d:
            ...
            throw r7
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.p6d.execute(java.lang.Runnable):void");
    }
