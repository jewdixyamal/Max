...
public abstract class fmb {
    public static final nic a = new Object();
    ...
    /* JADX WARNING: type inference failed for: r0v0, types: [yb9, java.lang.Object] */
    public static yb9 b() {
        ? obj = new Object();
        c = obj;
        a.i(obj);
    ...
    public static void c(android.content.Context r18, boolean r19) {
        ...
        L_0x006a:
            ...
            emb r8 = defpackage.emb.a(r6)     // Catch:{ IOException -> 0x0084 }
            goto L_0x008a
        L_0x0084:
            b()     // Catch:{ all -> 0x0012 }
            monitor-exit(r1)     // Catch:{ all -> 0x0012 }
        ...
        L_0x00b9:
            r13 = r4
        L_0x00ba:
            emb r0 = new emb     // Catch:{ all -> 0x0012 }
            r12 = 1
            r11 = r0
        ...
        L_0x00d6:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.fmb.c(android.content.Context, boolean):void");
    }
}
