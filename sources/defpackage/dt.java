...
public final class dt {
    ...
    /* JADX WARNING: type inference failed for: r0v0, types: [nva, ova] */
    static {
        ? ova = new ova();
        ova.T0 = "<ignored>";
        ova.V0 = "NA";
    ...
    public final String b() {
        ...
        for (mva mva : (!this.g || this.p.length() != 0 || this.l.i1.size() <= 0) ? this.l.h1 : this.l.i1) {
            if (this.p.length() > 0) {
                String str = mva.X;
                if ((str.length() == 0 || zua.x.matcher(str).matches()) && !mva.Y && !mva.Z) {
                }
            }
            if (this.p.length() == 0 && !this.g) {
                String str2 = mva.X;
                if (str2.length() != 0 && !zua.x.matcher(str2).matches() && !mva.Y) {
                }
            }
            if (u.matcher(mva.b).matches()) {
                this.r.add(mva);
            }
        }
        l(sb2);
    ...
    public final boolean c() {
        ...
        L_0x003f:
            ...
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.dt.c():boolean");
    }

    public final boolean d() {
        Pattern w2 = this.s.w("\\+|" + this.l.V0);
        StringBuilder sb = this.d;
        Matcher matcher = w2.matcher(sb);
    ...
    public final String e() {
        ...
        while (it.hasNext()) {
            mva mva = (mva) it.next();
            Matcher matcher = this.s.w(mva.a).matcher(this.q);
            if (matcher.matches()) {
                this.o = v.matcher(mva.X).find();
                String a2 = a(matcher.replaceAll(mva.b));
                if (zua.s(a2, zua.i).contentEquals(this.d)) {
                    return a2;
                }
            }
        }
    ...
    public final String i(char c2) {
        ...
        if (!isDigit && (sb.length() != 1 || !zua.l.matcher(Character.toString(c2)).matches())) {
            this.e = false;
            this.f = true;
        } else if (c2 == '+') {
            sb2.append(c2);
    ...
    public final void l(String str) {
        ...
        while (it.hasNext()) {
            mva mva = (mva) it.next();
            if (mva.c.size() != 0) {
                if (!this.s.w((String) mva.c.get(Math.min(length, mva.c.size() - 1))).matcher(str).lookingAt()) {
                    it.remove();
                }
            }
        }
    ...
    public final String m() {
        ...
        if (i2 != 1 || sb2.charAt(0) != '1' || sb2.charAt(1) == '0' || sb2.charAt(1) == '1') {
            ova ova = this.l;
            if (ova.c1) {
                Matcher matcher = this.s.w(ova.d1).matcher(sb2);
