...
public final class o2b extends Surface {
    ...
    public o2b(bt4 bt4, SurfaceTexture surfaceTexture, boolean z) {
    ...
    public static synchronized boolean a(android.content.Context r7) {
        /*
            java.lang.Class<o2b> r0 = defpackage.o2b.class
            monitor-enter(r0)
            boolean r1 = X     // Catch:{ all -> 0x0053 }
            r2 = 0
            r3 = 1
            if (r1 != 0) goto L_0x0055
            int r1 = defpackage.oaf.a     // Catch:{ all -> 0x0053 }
            r4 = 24
        ...
        L_0x0011:
            ...
            java.lang.String r6 = defpackage.oaf.c     // Catch:{ all -> 0x0053 }
            boolean r5 = r5.equals(r6)     // Catch:{ all -> 0x0053 }
            if (r5 != 0) goto L_0x000f
            java.lang.String r5 = "XT1650"
            java.lang.String r6 = defpackage.oaf.d     // Catch:{ all -> 0x0053 }
            boolean r5 = r5.equals(r6)     // Catch:{ all -> 0x0053 }
        ...
        L_0x0039:
            ...
            boolean r7 = defpackage.mr0.L(r7)     // Catch:{ all -> 0x0053 }
        L_0x003f:
        ...
        L_0x005c:
            ...
            throw r7
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.o2b.a(android.content.Context):boolean");
    }

    public static o2b b(Context context, boolean z) {
        boolean z2 = false;
        fm9.k(!z || a(context));
        bt4 bt4 = new bt4("ExoPlayer:PlaceholderSurface", 1);
        int i = z ? o : 0;
        bt4.start();
        Handler handler = new Handler(bt4.getLooper(), bt4);
        bt4.b = handler;
        bt4.X = new mu4(handler, 1);
        synchronized (bt4) {
            bt4.b.obtainMessage(1, i, 0).sendToTarget();
            while (((o2b) bt4.Y) == null && bt4.o == null && bt4.c == null) {
                try {
                    bt4.wait();
