...
public final class l02 {
    ...
    public final void b() {
        ...
        if (length > 0) {
            ...
            while (size >= 0) {
                j02 j02 = (j02) arrayList.get(size);
                int i = j02.c;
                if (i == length) {
                    j02.c = i - 1;
                    size--;
    ...
    public final yz3 c(int i) {
        ...
        return new yz3(spannableStringBuilder, Layout.Alignment.ALIGN_NORMAL, (Layout.Alignment) null, (Bitmap) null, (float) i6, 1, Integer.MIN_VALUE, f2, i5, Integer.MIN_VALUE, -3.4028235E38f, -3.4028235E38f, -3.4028235E38f, false, -16777216, Integer.MIN_VALUE, 0.0f);
    }
