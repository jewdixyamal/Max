...
public final class s53 {
    ...
    public final boolean b(CharSequence charSequence) {
        ...
        return (z2 ? bpe.d : bpe.c).T1(charSequence.length(), charSequence);
    }
    ...
    public final void c(float f2, boolean z2) {
        ...
        if (this.G != null) {
            ...
            if (this.H == null || z3) {
                ...
                i1e i1e = new i1e(this.G, textPaint, (int) width);
                i1e.l = this.F;
                i1e.k = b2;
                i1e.e = alignment;
                i1e.j = false;
    ...
    public final void i(boolean z2) {
        ...
        if ((view.getHeight() > 0 && view.getWidth() > 0) || z3) {
            ...
            wb5 wb5 = og.b;
            this.k0 = 1.0f - g(0.0f, 1.0f, 1.0f - f4, wb5);
            WeakHashMap weakHashMap = zmf.a;
            view.postInvalidateOnAnimation();
            this.l0 = g(1.0f, 0.0f, f4, wb5);
            view.postInvalidateOnAnimation();
            ...
            float f6 = this.g0;
            if (f5 != f6) {
                textPaint.setLetterSpacing(g(f6, f5, f4, wb5));
            } else {
    ...
    public final void k(int i2) {
        View view = this.a;
        voe voe = new voe(view.getContext(), i2);
        ColorStateList colorStateList = voe.j;
        if (colorStateList != null) {
            this.o = colorStateList;
        }
        float f2 = voe.k;
        ...
        ColorStateList colorStateList2 = voe.a;
        ...
        voe.a();
        this.E = new py1(fd7, voe.n);
        voe.c(view.getContext(), this.E);
        i(false);
    }
    ...
    public final boolean m(Typeface typeface) {
        ...
        this.y = typeface;
        Typeface x2 = m6d.x(this.a.getContext().getResources().getConfiguration(), typeface);
        this.x = x2;
        if (x2 == null) {
            x2 = this.y;
        }
    ...
    public final void n(int i2) {
        ...
        voe.a();
        this.D = new py1(gaa, voe.n);
        voe.c(view.getContext(), this.D);
        i(false);
    }
    ...
    public final void p(float f2) {
        ...
        if (o2 != this.b) {
            ...
            if (z2) {
                ...
                rectF.left = g((float) rect2.left, (float) rect.left, o2, this.V);
                rectF.top = g(this.q, this.r, o2, this.V);
                rectF.right = g((float) rect2.right, (float) rect.right, o2, this.V);
                rectF.bottom = g((float) rect2.bottom, (float) rect.bottom, o2, this.V);
            }
            if (!this.c) {
                this.u = g(this.s, this.t, o2, this.V);
                this.v = g(this.q, this.r, o2, this.V);
                q(o2);
                f3 = o2;
            } else if (o2 < this.e) {
                this.u = this.s;
            ...
            wb5 wb5 = og.b;
            this.k0 = 1.0f - g(0.0f, 1.0f, 1.0f - o2, wb5);
            WeakHashMap weakHashMap = zmf.a;
            View view = this.a;
            view.postInvalidateOnAnimation();
            this.l0 = g(1.0f, 0.0f, o2, wb5);
            view.postInvalidateOnAnimation();
            ColorStateList colorStateList = this.o;
            ColorStateList colorStateList2 = this.n;
            TextPaint textPaint = this.T;
            ...
            float f5 = this.g0;
            if (f4 != f5) {
                textPaint.setLetterSpacing(g(f5, f4, o2, wb5));
            } else {
                textPaint.setLetterSpacing(f4);
            }
            this.N = og.a(this.b0, this.X, o2);
            this.O = og.a(this.c0, this.Y, o2);
            this.P = og.a(this.d0, this.Z, o2);
            int a2 = a(f(this.e0), o2, f(this.a0));
            this.Q = a2;
            textPaint.setShadowLayer(this.N, this.O, this.P, a2);
            if (this.c) {
                int alpha = textPaint.getAlpha();
                float f6 = this.e;
                textPaint.setAlpha((int) ((o2 <= f6 ? og.b(1.0f, 0.0f, this.d, f6, o2) : og.b(0.0f, 1.0f, f6, 1.0f, o2)) * ((float) alpha)));
                if (i2 >= 31) {
                    textPaint.setShadowLayer(this.N, this.O, this.P, mr0.j(this.Q, textPaint.getAlpha()));
                }
            }
