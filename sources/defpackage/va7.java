...
public final class va7 implements Closeable {
                                ...
                                if (o2 != 44) {
                                    ...
                                    switch (o2) {
                                        ...
                                        case 58:
                                            return 58;
                                        default:
                                            throw JsonSyntaxException.a((long) this.o, m(), this.b);
                                    }
                                }
                            }
                        }
        ...
        if (o2 == -1) {
            ...
            if (!(o2 == 91 || o2 == 93 || o2 == 102 || o2 == 110 || o2 == 116 || o2 == 123 || o2 == 125 || o2 == 44)) {
                ...
                if (i2 == 48) {
                    ...
                    throw JsonSyntaxException.a((long) this.o, m(), i2);
                } else {
                    appendable2.append((char) i2);
                    i = n();
                    while (i >= 48 && i <= 57) {
                ...
                if (i == 46) {
                    ...
                    int n2 = n();
                    if (n2 < 48 || n2 > 57) {
                        throw JsonSyntaxException.a((long) this.o, m(), n2);
                    }
                ...
                if (i == 101 || i == 69) {
                    ...
                    if (n4 < 48 || n4 > 57) {
                        throw JsonSyntaxException.a((long) this.o, m(), n4);
                    }
                    appendable2.append((char) n4);
                    int n5 = n();
                    while (i >= 48 && i <= 57) {
            ...
            if (i3 == 44) {
                ...
                g(108);
                g(115);
                g(HttpStatus.SC_SWITCHING_PROTOCOLS);
                str = "false";
            } else if (i3 == 110) {
                g(117);
                g(108);
            ...
            while (true) {
                ...
                if (n6 > 31) {
                        ...
                        if (n7 != 34 && n7 != 47 && n7 != 92 && n7 != 98 && n7 != 102 && n7 != 110) {
                            if (!(n7 == 114 || n7 == 116)) {
                                if (n7 == 117) {
                                    ...
                                    throw JsonSyntaxException.a((long) this.o, m(), n7);
                                }
                            }
                        }
                        appendable2.append((char) n7);
                    ...
                    throw JsonSyntaxException.a((long) this.o, m(), n6);
                }
            }
            throw JsonSyntaxException.a((long) this.o, m(), n);
        }
    }
    ...
    public final void d(int i) {
        int S = S();
        if (S != i) {
            throw JsonSyntaxException.b((long) this.o, m(), S);
        }
    }
