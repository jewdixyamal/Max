...
public final class mo4 implements cfe {
    ...
    public final void a() {
        ...
        if (ir6 != null && ir6.c()) {
            us7 us7 = us7.X;
            yne c = downloadFileFromWebAppWorker.c();
            ir6.d(us7, "ru.ok.tamtam.upload.workers.DownloadFileFromWebAppWorker", "onFileDownloadFailed: " + c, (Throwable) null);
        }
        av0 d = this.a.d();
        long j = this.a.c().a;
    ...
    public final e5f b() {
        ir6 ir6 = hm9.m;
        if (ir6 != null && ir6.c()) {
            ir6.d(us7.X, "ru.ok.tamtam.upload.workers.DownloadFileFromWebAppWorker", "onUrlExpired", (Throwable) null);
        }
        av0 d = this.a.d();
        long j = this.a.c().a;
        String str = this.a.c().c;
    ...
    public final Object d(Continuation continuation) {
        ...
        if (ir6 != null && ir6.c()) {
            us7 us7 = us7.X;
            yne c = downloadFileFromWebAppWorker.c();
            ir6.d(us7, "ru.ok.tamtam.upload.workers.DownloadFileFromWebAppWorker", "onFileDownloadCancelled: " + c, (Throwable) null);
        }
        av0 d = this.a.d();
        long j = this.a.c().a;
        String str = this.a.c().c;
    ...
    public final void e(boolean z, boolean z2) {
        ...
        if (ir6 != null && ir6.c()) {
            us7 us7 = us7.X;
            yne c = downloadFileFromWebAppWorker.c();
            int i = downloadFileFromWebAppWorker.v0.get();
            ir6.d(us7, "ru.ok.tamtam.upload.workers.DownloadFileFromWebAppWorker", "onFileDownloadInterrupted: " + c + ", isNetworkProblem:" + z + ", retryCount:" + i, (Throwable) null);
        }
        av0 d = this.a.d();
        long j = this.a.c().a;
        String str = this.a.c().c;
        d.c(new zg5(j));
        int incrementAndGet = z ? this.a.v0.incrementAndGet() : 0;
        this.a.x0 = (!z || incrementAndGet > 10) ? new go4(false) : new go4(true);
    }
