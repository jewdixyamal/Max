...
public final class k02 {
    ...
    public final void b() {
        ...
        if (length > 0) {
            ...
            while (size >= 0) {
                i02 i02 = (i02) arrayList.get(size);
                int i = i02.c;
                if (i == length) {
                    i02.c = i - 1;
                    size--;
    ...
    public final xz3 c(int i) {
        ...
        return new xz3(spannableStringBuilder, Layout.Alignment.ALIGN_NORMAL, (Layout.Alignment) null, (Bitmap) null, (float) i10, 1, Integer.MIN_VALUE, f3, i9, Integer.MIN_VALUE, -3.4028235E38f, -3.4028235E38f, -3.4028235E38f, false, -16777216, Integer.MIN_VALUE, 0.0f);
    }
