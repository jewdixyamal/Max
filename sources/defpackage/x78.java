...
public final class x78 {
    ...
    public final r54 b(oy5 oy5, oy5 oy52) {
        int i = !maf.a(oy5.w0, oy52.w0) ? 8 : 0;
        if (this.h) {
            if (oy5.E0 != oy52.E0) {
                i |= LockFreeTaskQueueCore.MIN_ADD_SPIN_CAPACITY;
            }
            if (!this.e && !(oy5.B0 == oy52.B0 && oy5.C0 == oy52.C0)) {
                i |= 512;
            }
            if (!maf.a(oy5.I0, oy52.I0)) {
                i |= 2048;
            }
            if (maf.d.startsWith("SM-T230") && "OMX.MARVELL.VIDEO.HW.CODA7542DECODER".equals(this.a) && !oy5.c(oy52)) {
                i |= 2;
            }
            if (i == 0) {
                return new r54(this.a, oy5, oy52, oy5.c(oy52) ? 3 : 2, 0);
            }
        } else {
            if (oy5.J0 != oy52.J0) {
                i |= 4096;
            ...
            if (i == 0 && "audio/mp4a-latm".equals(str)) {
                ...
                if (!(d2 == null || d3 == null)) {
                    ...
                    if (intValue == 42 && intValue2 == 42) {
                        return new r54(this.a, oy5, oy52, 3, 0);
                    }
                }
            }
            if (!oy5.c(oy52)) {
            ...
            if (i == 0) {
                return new r54(this.a, oy5, oy52, 1, 0);
            }
        }
        return new r54(this.a, oy5, oy52, 0, i);
    }
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final boolean c(defpackage.oy5 r15) {
        /*
            r14 = this;
            java.lang.String r0 = r15.w0
            java.lang.String r1 = r14.b
            boolean r0 = r1.equals(r0)
            r2 = 0
            if (r0 != 0) goto L_0x0017
            java.lang.String r0 = defpackage.o88.b(r15)
            boolean r0 = r1.equals(r0)
        ...
        L_0x0017:
            ...
            r4 = 16
            boolean r5 = r14.h
            java.lang.String r6 = r15.t0
            if (r6 != 0) goto L_0x0024
            goto L_0x00fe
        L_0x0024:
            android.util.Pair r7 = defpackage.o88.d(r15)
        ...
        L_0x0242:
            ...
            int r15 = defpackage.rh4.e(r15, r0)
            ...
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.x78.c(oy5):boolean");
    }

    public final boolean d(oy5 oy5) {
        if (this.h) {
            return this.e;
        }
        Pair d2 = o88.d(oy5);
    ...
    public final boolean e(int i, int i2, double d2) {
        ...
        if (videoCapabilities == null) {
            ...
            if (i < i2) {
                String str = this.a;
                if ((!"OMX.MTK.VIDEO.DECODER.HEVC".equals(str) || !"mcv5a".equals(maf.b)) && a(videoCapabilities, i2, i, d2)) {
                    ...
                    new StringBuilder(rh4.e(rh4.e(rh4.e(rh4.e(25, sb2), str), this.b), maf.e));
                    return true;
                }
            }
