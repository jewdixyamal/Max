...
public abstract class p5f extends qk4 {
    ...
    public final void d(int r10) {
        ...
        L_0x0050:
            ...
            rh5 r7 = defpackage.mhe.d(r1, r7)     // Catch:{ all -> 0x00c9 }
        ...
        L_0x00fc:
            throw r9
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.p5f.d(int):void");
    }
    ...
    public byte[] e() {
        ...
        try {
            ...
            for (dle dle : m) {
                obtain.writeString((String) dle.b);
                obtain.writeString((String) dle.c);
            }
            g.close();
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final boolean h(defpackage.rh5 r16, int r17) {
        /*
            r15 = this;
            r1 = r15
