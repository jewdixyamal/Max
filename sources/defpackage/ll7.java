...
public final class ll7 implements vd0 {
    ...
    public ll7(int i, ffc ffc) {
        this.b = i;
        this.a = ffc;
    }

    /* JADX WARNING: type inference failed for: r13v0 */
    /* JADX WARNING: type inference failed for: r13v2, types: [v8e] */
    /* JADX WARNING: type inference failed for: r13v3, types: [v8e] */
    /* JADX WARNING: type inference failed for: r11v5, types: [yd0] */
    /* JADX WARNING: type inference failed for: r7v13, types: [y8e] */
    /* JADX WARNING: type inference failed for: r13v6 */
    /* JADX WARNING: type inference failed for: r7v16, types: [ll7] */
    /* JADX WARNING: Multi-variable type inference failed */
    /* JADX WARNING: Unknown variable types count: 1 */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static defpackage.ll7 b(int r19, defpackage.wpa r20) {
        /*
            r0 = r20
            r1 = 4
            java.lang.String r2 = "initialCapacity"
            defpackage.wmd.i(r1, r2)
        ...
        L_0x0135:
            ...
            ny5 r4 = new ny5
            r4.<init>()
            java.lang.String r12 = defpackage.ia9.l(r14)
            r4.m = r12
            r4.A = r7
            r4.B = r13
        ...
        L_0x016d:
            ...
            r1.<init>(r4)
            java.lang.String r4 = defpackage.oaf.H(r5)
            r1.append(r4)
        ...
        L_0x01db:
            ll7 r0 = new ll7
            ffc r1 = defpackage.zw6.h(r6, r2)
            r2 = r19
            r0.<init>(r2, r1)
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.ll7.b(int, wpa):ll7");
    }

    public final vd0 a(Class cls) {
        ls5 l = this.a.listIterator(0);
        while (l.hasNext()) {
            vd0 vd0 = (vd0) l.next();
            if (vd0.getClass() == cls) {
                return vd0;
