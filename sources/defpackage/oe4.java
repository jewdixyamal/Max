...
public final class oe4 extends j0f {
    ...
    public final Bundle c() {
        ...
        while (true) {
            ...
            if (i < sparseArray2.size()) {
                ...
                c.putIntArray(J0, s5c.c0(arrayList));
                c.putParcelableArrayList(K0, nu0.R(arrayList2, new ta4(2)));
    ...
    public final boolean equals(Object obj) {
        ...
        oe4 oe4 = (oe4) obj;
        if (super.equals(oe4) && this.i0 == oe4.i0 && this.j0 == oe4.j0 && this.k0 == oe4.k0 && this.l0 == oe4.l0 && this.m0 == oe4.m0 && this.n0 == oe4.n0 && this.o0 == oe4.o0 && this.p0 == oe4.p0 && this.q0 == oe4.q0 && this.r0 == oe4.r0 && this.s0 == oe4.s0 && this.t0 == oe4.t0 && this.u0 == oe4.u0 && this.v0 == oe4.v0 && this.w0 == oe4.w0) {
            SparseBooleanArray sparseBooleanArray = this.y0;
            int size = sparseBooleanArray.size();
            SparseBooleanArray sparseBooleanArray2 = oe4.y0;
                                ...
                                if (indexOfKey >= 0) {
                                    ...
                                    if (map2.size() == map.size()) {
                                        for (Map.Entry entry : map.entrySet()) {
                                            tze tze = (tze) entry.getKey();
                                            if (map2.containsKey(tze)) {
                                                if (!oaf.a(entry.getValue(), map2.get(tze))) {
                                                }
                                            }
                                        }
                                        i2++;
