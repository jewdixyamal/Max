...
public final class lpd extends vh0 {
    ...
    public final void m(boolean z) {
        ...
        if (i4 == bArr.length || z) {
            ...
            fm9.j("bytesConsumed is not aligned to frame size: %s" + i2, i2 % this.n == 0);
            if (i4 >= i3) {
                z2 = true;
            }
            fm9.k(z2);
    ...
    public final void n(int i2, int i3) {
        if (i2 != 0) {
            ...
            fm9.e("sizeToOutput is not aligned to frame size: " + i2, i2 % this.n == 0);
            fm9.k(this.t < this.s.length);
            byte[] bArr3 = this.v;
            if (i2 % this.n != 0) {
                z = false;
            }
            fm9.e("byteOutput size is not aligned to frame size " + i2, z);
            if (i3 != 3) {
                for (int i10 = 0; i10 < i2; i10 += 2) {
                    int i11 = i10 + 1;
                    byte b = (bArr3[i11] << 8) | (bArr3[i10] & 255);
                    int i12 = this.k;
                    if (i3 == 0) {
