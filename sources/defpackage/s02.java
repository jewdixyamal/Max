...
public final class s02 {
    ...
    public /* synthetic */ s02(byte[] bArr, int i, int i2, byte b2) {
        this.a = i2;
        this.b = bArr;
        this.e = i;
    }
    ...
    public void a() {
        ...
        L_0x0055:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.s02.a():void");
    }
    ...
    public int i(int i) {
        switch (this.a) {
            ...
            case 2:
                ...
                while (true) {
                    ...
                    if (i9 > 8) {
                        ...
                        int i11 = this.c;
                        this.c = i11 + 1;
                        i8 |= (bArr3[i11] & 255) << i10;
                    } else {
                        byte[] bArr4 = this.b;
                        int i12 = this.c;
                        int i13 = (-1 >>> (32 - i)) & (i8 | ((bArr4[i12] & 255) >> (8 - i9)));
                        if (i9 == 8) {
                            this.d = 0;
                            this.c = i12 + 1;
                        }
            ...
            case 3:
                ...
                while (true) {
                    ...
                    if (i15 > 8) {
                        ...
                        byte[] bArr6 = this.b;
                        int i19 = this.d;
                        int i20 = (-1 >>> (32 - i)) & (i14 | ((bArr6[i19] & 255) >> (8 - i15)));
                        if (i15 == 8) {
                            this.e = 0;
                            if (!r(i19 + 1)) {
                                i16 = 1;
            ...
            case 4:
                ...
                while (true) {
                    ...
                    if (i22 > 8) {
                        ...
                        byte[] bArr8 = this.b;
                        int i26 = this.d;
                        int i27 = (-1 >>> (32 - i)) & (i21 | ((bArr8[i26] & 255) >> (8 - i22)));
                        if (i22 == 8) {
                            this.e = 0;
                            if (!r(i26 + 1)) {
                                i23 = 1;
            ...
            case 5:
                ...
                int i29 = i28 + 1;
                byte[] bArr9 = this.b;
                int i30 = ((bArr9[i28] & 255) >> this.e) & (255 >> (8 - min));
                while (min < i) {
                    i30 |= (bArr9[i29] & 255) << min;
                    min += 8;
                    i29++;
                }
                int i31 = i30 & (-1 >>> (32 - i));
            ...
            default:
                ...
                int i33 = i32 + 1;
                byte[] bArr10 = this.b;
                int i34 = ((bArr10[i32] & 255) >> this.e) & (255 >> (8 - min2));
                while (min2 < i) {
                    i34 |= (bArr10[i33] & 255) << min2;
                    min2 += 8;
                    i33++;
                }
                int i35 = i34 & (-1 >>> (32 - i));
            ...
            default:
                ...
                if (i17 != 0) {
                    ...
                    if (i18 + i17 > 8) {
                        ...
                        int i19 = this.c;
                        this.c = i19 + 1;
                        bArr[i12] = (byte) (b7 | ((bArr6[i19] & 255) << i18));
                        this.d = i18 - 8;
                    }
                    int i20 = this.d + i17;
                    this.d = i20;
