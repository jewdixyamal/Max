...
public final class b9 extends ek0 {
    ...
    public b9(qze qze, int[] iArr, int i2, gg0 gg0, long j2, long j3, long j4, int i3, int i4, float f, float f2, zw6 zw6, rhe rhe) {
        super(qze, iArr);
        gg0 gg02 = gg0;
        long j5 = j4 < j2 ? j2 : j4;
        this.g = gg02;
    ...
    public final int g(long j2, List list) {
        ...
        long j3 = this.t;
        if (j3 != -9223372036854775807L && elapsedRealtime - j3 < 1000 && (list.isEmpty() || ((f78) mqd.m(list)).equals(this.u))) {
            return list.size();
        }
        ...
        int size = list.size();
        long w = maf.w(this.q, ((f78) list.get(size - 1)).Z - j2);
        long j4 = this.j;
        if (w < j4) {
            return size;
        }
        x(list);
        oy5 oy5 = this.d[w(elapsedRealtime)];
        for (int i4 = 0; i4 < size; i4++) {
            f78 f78 = (f78) list.get(i4);
            oy5 oy52 = f78.o;
            if (maf.w(this.q, f78.Z - j2) >= j4 && oy52.s0 < oy5.s0 && (i2 = oy52.C0) != -1 && i2 <= this.l && (i3 = oy52.B0) != -1 && i3 <= this.k && i2 < oy5.C0) {
                return i4;
            }
        }
        return size;
    ...
    public final int w(long j2) {
        ...
        if (!this.o.isEmpty()) {
            int i2 = 1;
            while (i2 < this.o.size() - 1 && ((z8) this.o.get(i2)).a < j4) {
                i2++;
            }
            z8 z8Var = (z8) this.o.get(i2 - 1);
            z8 z8Var2 = (z8) this.o.get(i2);
            long j5 = z8Var.a;
            float f = ((float) (j4 - j5)) / ((float) (z8Var2.a - j5));
            long j6 = z8Var.b;
            j4 = j6 + ((long) (f * ((float) (z8Var2.b - j6))));
        }
        int i3 = 0;
