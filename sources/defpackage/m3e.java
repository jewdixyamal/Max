...
public final class m3e {
    ...
    public m3e(defpackage.k3e r4) {
        ...
        L_0x0044:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.m3e.<init>(k3e):void");
    }
    ...
    public final boolean equals(Object obj) {
        ...
        m3e m3e = (m3e) obj;
        if (this.a != m3e.a || this.d != m3e.d || this.e != m3e.e || this.f != m3e.f || this.i != m3e.i) {
            return false;
        }
        String str = m3e.b;
        String str2 = this.b;
        ...
        if (!this.g.equals(m3e.g)) {
            return false;
        }
        return this.h.equals(m3e.h);
    }
    ...
    public final int hashCode() {
        ...
        long j4 = this.e;
        long j5 = this.f;
        return ((this.h.hashCode() + rh4.d((((((((hashCode + i3) * 31) + ((int) (j3 ^ (j3 >>> 32)))) * 31) + ((int) (j4 ^ (j4 >>> 32)))) * 31) + ((int) (j5 ^ (j5 >>> 32)))) * 31, 31, this.g)) * 31) + (this.i ? 1 : 0);
    }
