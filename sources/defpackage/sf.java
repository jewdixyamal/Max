...
public final class sf extends hbf implements Animatable {
    ...
    /* JADX WARNING: type inference failed for: r7v8, types: [qpd, us] */
            ...
            if (eventType != 1 && (xmlPullParser.getDepth() >= depth || eventType != 3)) {
                if (eventType == 2) {
                    ...
                    if ("animated-vector".equals(name)) {
                        TypedArray G = ote.G(resources, theme, attributeSet, tu0.e);
                        int resourceId = G.getResourceId(0, 0);
                        if (resourceId != 0) {
                            qbf qbf = new qbf();
                            ThreadLocal threadLocal = vic.a;
                            qbf.a = qic.a(resources, resourceId, theme);
                            new pbf(qbf.a.getConstantState());
                            qbf.Y = false;
                            qbf.setCallback(this.Y);
                            qbf qbf2 = qfVar.a;
                            if (qbf2 != null) {
                                qbf2.setCallback((Drawable.Callback) null);
                            }
                            qfVar.a = qbf;
                        }
                        G.recycle();
                    } else if ("target".equals(name)) {
                        TypedArray obtainAttributes = resources.obtainAttributes(attributeSet, tu0.f);
