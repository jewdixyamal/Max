...
public final class pje {
    ...
    public final void a(int r8) {
        ...
        L_0x0009:
            ...
            int r2 = defpackage.au1.b(r1, r8)     // Catch:{ all -> 0x0078 }
            if (r2 < 0) goto L_0x0016
            monitor-exit(r0)
            return
        L_0x0016:
            android.content.Context r2 = r7.a     // Catch:{ all -> 0x0078 }
            java.lang.String r3 = defpackage.c37.q()     // Catch:{ all -> 0x0078 }
        ...
        L_0x0043:
            ...
            java.io.File r2 = defpackage.lk5.J(r4, r2)     // Catch:{ all -> 0x0078 }
            int r1 = defpackage.au1.s(r1)     // Catch:{ all -> 0x0078 }
            r3 = 2
            r4 = 1
            if (r1 == 0) goto L_0x008a
            if (r1 != r4) goto L_0x0082
            int[] r1 = defpackage.oje.$EnumSwitchMapping$0     // Catch:{ all -> 0x0078 }
            int r8 = defpackage.au1.s(r8)     // Catch:{ all -> 0x0078 }
            ...
            goto L_0x0074
        L_0x006d:
            defpackage.m6d.k(r2)     // Catch:{ IOException -> 0x0071 }
            goto L_0x0074
        L_0x0071:
        ...
        L_0x008a:
            ...
            goto L_0x00bb
        L_0x0099:
            defpackage.m6d.k(r2)     // Catch:{ IOException -> 0x009d }
            goto L_0x00bb
        L_0x009d:
            r2.toString()     // Catch:{ all -> 0x0078 }
            goto L_0x00bb
        ...
        L_0x00a9:
            ...
            java.util.ArrayList r8 = defpackage.lk5.H(r2)     // Catch:{ IOException -> 0x00b4 }
            goto L_0x00b9
        L_0x00b4:
            r2.toString()     // Catch:{ all -> 0x0078 }
        L_0x00b7:
            nz4 r8 = defpackage.nz4.a     // Catch:{ all -> 0x0078 }
        L_0x00b9:
            r7.d = r8     // Catch:{ all -> 0x0078 }
        L_0x00bb:
            monitor-exit(r0)
        ...
        L_0x00bd:
            ...
            throw r7
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.pje.a(int):void");
    }
    ...
    public final void b(Map map) {
        ...
        synchronized (this.e) {
            ...
            for (Map.Entry entry : map.entrySet()) {
                z |= rq9.q(this.e, (String) entry.getKey(), (String) entry.getValue(), 30);
            }
        }
        if (z) {
