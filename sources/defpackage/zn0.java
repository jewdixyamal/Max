...
public final class zn0 extends AsyncTask {
    ...
    public zn0(Context context, Uri uri, Uri uri2, int i, int i2, qqd qqd) {
        this.a = context;
        this.b = uri;
        this.c = uri2;
        this.d = i;
    ...
    public final void b(android.net.Uri r9, android.net.Uri r10) {
        /*
            ...
            a8g r2 = r1.a
            r3 = 0
            l84 r4 = new l84     // Catch:{ all -> 0x0067 }
            r4.<init>()     // Catch:{ all -> 0x0067 }
            java.lang.String r9 = r9.toString()     // Catch:{ all -> 0x0067 }
            r4.S(r9)     // Catch:{ all -> 0x0067 }
            mhc r9 = r4.r()     // Catch:{ all -> 0x0067 }
            b8c r9 = r1.b(r9)     // Catch:{ all -> 0x0067 }
            yic r9 = r9.f()     // Catch:{ all -> 0x0067 }
            i8c r1 = r9.Z
            fu0 r4 = r1.S()     // Catch:{ all -> 0x0064 }
            ...
            java.util.logging.Logger r5 = defpackage.x2a.a     // Catch:{ all -> 0x0062 }
            ux r5 = new ux     // Catch:{ all -> 0x0062 }
            oue r6 = new oue     // Catch:{ all -> 0x0062 }
        ...
        L_0x007d:
            ...
            throw r8
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.zn0.b(android.net.Uri, android.net.Uri):void");
    }
    ...
    public final String c() {
        ...
        if (DocumentsContract.isDocumentUri(context, uri2)) {
            if ("com.android.externalstorage.documents".equals(uri2.getAuthority())) {
                ...
                try {
                    return f8.f(context, ContentUris.withAppendedId(Uri.parse("content://downloads/public_downloads"), Long.valueOf(documentId).longValue()), (String) null, (String[]) null);
                ...
                return f8.f(context, uri, "_id=?", new String[]{split2[1]});
            }
        } else if ("content".equalsIgnoreCase(uri2.getScheme())) {
            return "com.google.android.apps.photos.content".equals(uri2.getAuthority()) ? uri2.getLastPathSegment() : f8.f(context, uri2, (String) null, (String[]) null);
        } else {
    ...
    /* JADX WARNING: type inference failed for: r0v8, types: [v55, java.lang.Object] */
    ...
    public final defpackage.yn0 d() {
        ...
        L_0x0091:
            ...
            goto L_0x00b3
        L_0x00a2:
            qu6 r2 = new qu6     // Catch:{ IOException -> 0x00af }
            r2.<init>(r1)     // Catch:{ IOException -> 0x00af }
            int r2 = r2.a()     // Catch:{ IOException -> 0x00af }
            defpackage.a14.j(r1)     // Catch:{ IOException -> 0x00b0 }
            goto L_0x00b3
        L_0x00af:
            r2 = r8
        L_0x00b0:
