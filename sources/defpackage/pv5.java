...
public final class pv5 extends ViewGroup implements kre {
    ...
    public final void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        ote.E(textView, tu0.G(fk4.d().getDisplayMetrics().density * f), G, 0, 12);
        ote.E(this.o, tu0.G(fk4.d().getDisplayMetrics().density * f), wg0.d((float) 4, fk4.d().getDisplayMetrics().density, textView.getMeasuredHeight(), G), 0, 12);
