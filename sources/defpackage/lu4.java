...
public final class lu4 {
    ...
    public static final lq9 j = new Object();
    public static wjg k;
    public static dkg l;
    ...
    public static int a(Context context, String str) {
        try {
            ...
            if (s36.l(declaredField.get((Object) null), str)) {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r8v0, resolved type: yu0} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r8v1, resolved type: w3} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r2v1, resolved type: int} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r8v4, resolved type: w3} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r8v5, resolved type: w3} */
    /* JADX WARNING: type inference failed for: r7v0, types: [java.lang.Object, njg] */
    /* JADX WARNING: type inference failed for: r2v6 */
    /* JADX WARNING: type inference failed for: r2v7 */
    /* JADX WARNING: Multi-variable type inference failed */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static defpackage.lu4 b(android.content.Context r16, defpackage.mq9 r17, java.lang.String r18) {
        /*
            r0 = r16
            r1 = r18
            ...
            lq9 r8 = j     // Catch:{ all -> 0x0186 }
            r14 = r17
            w3 r8 = r14.k(r0, r1, r8)     // Catch:{ all -> 0x0186 }
        ...
        L_0x0050:
            ...
            lu4 r0 = new lu4     // Catch:{ all -> 0x0186 }
        ...
        L_0x0064:
            ...
            r2 = 0
            java.lang.Class<lu4> r3 = defpackage.lu4.class
            ...
            njg r3 = (defpackage.njg) r3     // Catch:{ RemoteException -> 0x00db, DynamiteModule$LoadingException -> 0x00d8, all -> 0x00d5 }
            ...
            oy9 r5 = new oy9     // Catch:{ RemoteException -> 0x00db, DynamiteModule$LoadingException -> 0x00d8, all -> 0x00d5 }
            r13 = 0
            r5.<init>(r13)     // Catch:{ RemoteException -> 0x00db, DynamiteModule$LoadingException -> 0x00d8, all -> 0x00d5 }
            java.lang.Class<lu4> r5 = defpackage.lu4.class
        ...
        L_0x00a6:
            ...
            oy9 r0 = new oy9     // Catch:{ RemoteException -> 0x00db, DynamiteModule$LoadingException -> 0x00d8, all -> 0x00d5 }
            r0.<init>(r3)     // Catch:{ RemoteException -> 0x00db, DynamiteModule$LoadingException -> 0x00d8, all -> 0x00d5 }
            xr6 r0 = r14.J0(r5, r1, r15, r0)     // Catch:{ RemoteException -> 0x00db, DynamiteModule$LoadingException -> 0x00d8, all -> 0x00d5 }
            goto L_0x00c6
        L_0x00b8:
            oy9 r5 = new oy9     // Catch:{ RemoteException -> 0x00db, DynamiteModule$LoadingException -> 0x00d8, all -> 0x00d5 }
            r5.<init>(r0)     // Catch:{ RemoteException -> 0x00db, DynamiteModule$LoadingException -> 0x00d8, all -> 0x00d5 }
            oy9 r0 = new oy9     // Catch:{ RemoteException -> 0x00db, DynamiteModule$LoadingException -> 0x00d8, all -> 0x00d5 }
            r0.<init>(r3)     // Catch:{ RemoteException -> 0x00db, DynamiteModule$LoadingException -> 0x00d8, all -> 0x00d5 }
            xr6 r0 = r14.I0(r5, r1, r15, r0)     // Catch:{ RemoteException -> 0x00db, DynamiteModule$LoadingException -> 0x00d8, all -> 0x00d5 }
        L_0x00c6:
            java.lang.Object r0 = defpackage.oy9.L0(r0)     // Catch:{ RemoteException -> 0x00db, DynamiteModule$LoadingException -> 0x00d8, all -> 0x00d5 }
            ...
            lu4 r3 = new lu4     // Catch:{ RemoteException -> 0x00db, DynamiteModule$LoadingException -> 0x00d8, all -> 0x00d5 }
        ...
        L_0x00f9:
            ...
            throw r0     // Catch:{ RemoteException -> 0x00db, DynamiteModule$LoadingException -> 0x00d8, all -> 0x00d5 }
        L_0x00fc:
            wjg r3 = f(r16)     // Catch:{ RemoteException -> 0x00db, DynamiteModule$LoadingException -> 0x00d8, all -> 0x00d5 }
            ...
            njg r5 = (defpackage.njg) r5     // Catch:{ RemoteException -> 0x00db, DynamiteModule$LoadingException -> 0x00d8, all -> 0x00d5 }
            if (r5 == 0) goto L_0x012e
            oy9 r12 = new oy9     // Catch:{ RemoteException -> 0x00db, DynamiteModule$LoadingException -> 0x00d8, all -> 0x00d5 }
            ...
            oy9 r5 = new oy9     // Catch:{ RemoteException -> 0x00db, DynamiteModule$LoadingException -> 0x00d8, all -> 0x00d5 }
            r5.<init>(r0)     // Catch:{ RemoteException -> 0x00db, DynamiteModule$LoadingException -> 0x00d8, all -> 0x00d5 }
            xr6 r0 = r3.J0(r12, r1, r15, r5)     // Catch:{ RemoteException -> 0x00db, DynamiteModule$LoadingException -> 0x00d8, all -> 0x00d5 }
            goto L_0x014b
        L_0x012e:
            com.google.android.gms.dynamite.DynamiteModule$LoadingException r0 = new com.google.android.gms.dynamite.DynamiteModule$LoadingException     // Catch:{ RemoteException -> 0x00db, DynamiteModule$LoadingException -> 0x00d8, all -> 0x00d5 }
        ...
        L_0x0136:
            ...
            oy9 r5 = new oy9     // Catch:{ RemoteException -> 0x00db, DynamiteModule$LoadingException -> 0x00d8, all -> 0x00d5 }
            r5.<init>(r0)     // Catch:{ RemoteException -> 0x00db, DynamiteModule$LoadingException -> 0x00d8, all -> 0x00d5 }
            xr6 r0 = r3.K0(r5, r1, r15)     // Catch:{ RemoteException -> 0x00db, DynamiteModule$LoadingException -> 0x00d8, all -> 0x00d5 }
            goto L_0x014b
        L_0x0142:
            oy9 r5 = new oy9     // Catch:{ RemoteException -> 0x00db, DynamiteModule$LoadingException -> 0x00d8, all -> 0x00d5 }
            r5.<init>(r0)     // Catch:{ RemoteException -> 0x00db, DynamiteModule$LoadingException -> 0x00d8, all -> 0x00d5 }
            xr6 r0 = r3.I0(r5, r1, r15)     // Catch:{ RemoteException -> 0x00db, DynamiteModule$LoadingException -> 0x00d8, all -> 0x00d5 }
        L_0x014b:
            java.lang.Object r0 = defpackage.oy9.L0(r0)     // Catch:{ RemoteException -> 0x00db, DynamiteModule$LoadingException -> 0x00d8, all -> 0x00d5 }
    ...
    public static int c(android.content.Context r8, java.lang.String r9, boolean r10, boolean r11) {
        /*
            ...
            yu0 r8 = i     // Catch:{ Exception -> 0x00b6 }
        ...
        L_0x0019:
            ...
            java.lang.Class<lu4> r1 = defpackage.lu4.class
        ...
        L_0x0087:
            ...
            njg r1 = (defpackage.njg) r1     // Catch:{ Exception -> 0x00a4, all -> 0x00a2 }
        ...
        L_0x00f0:
            throw r8
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.lu4.c(android.content.Context, java.lang.String, boolean, boolean):int");
    }

    /* JADX WARNING: type inference failed for: r1v5, types: [cdg] */
    /* JADX WARNING: Multi-variable type inference failed */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static void d(java.lang.ClassLoader r3) {
        ...
        L_0x0016:
            ...
            boolean r2 = r1 instanceof defpackage.dkg     // Catch:{ ClassNotFoundException | IllegalAccessException | InstantiationException | NoSuchMethodException | InvocationTargetException -> 0x0021 }
            if (r2 == 0) goto L_0x0023
            dkg r1 = (defpackage.dkg) r1     // Catch:{ ClassNotFoundException | IllegalAccessException | InstantiationException | NoSuchMethodException | InvocationTargetException -> 0x0021 }
            goto L_0x0029
        L_0x0021:
            r3 = move-exception
            goto L_0x002c
        L_0x0023:
            dkg r1 = new dkg     // Catch:{ ClassNotFoundException | IllegalAccessException | InstantiationException | NoSuchMethodException | InvocationTargetException -> 0x0021 }
            r2 = 1
        ...
        L_0x002c:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.lu4.d(java.lang.ClassLoader):void");
    }
    ...
    public static boolean e(Context context) {
        ...
        if (g == null) {
            ...
            if (fe6.b.b(context, 10000000) == 0 && resolveContentProvider != null && "com.google.android.gms".equals(resolveContentProvider.packageName)) {
                z = true;
            }
            g = Boolean.valueOf(z);
    ...
    /* JADX WARNING: type inference failed for: r2v5, types: [cdg] */
    /* JADX WARNING: Multi-variable type inference failed */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static defpackage.wjg f(android.content.Context r5) {
        /*
            java.lang.Class<lu4> r0 = defpackage.lu4.class
            monitor-enter(r0)
            wjg r1 = k     // Catch:{ all -> 0x0009 }
        ...
        L_0x0027:
            ...
            boolean r3 = r2 instanceof defpackage.wjg     // Catch:{ Exception -> 0x0034 }
            if (r3 == 0) goto L_0x0036
            wjg r2 = (defpackage.wjg) r2     // Catch:{ Exception -> 0x0034 }
            goto L_0x003e
        L_0x0034:
            r5 = move-exception
            goto L_0x0044
        L_0x0036:
            wjg r2 = new wjg     // Catch:{ Exception -> 0x0034 }
        ...
        L_0x0049:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.lu4.f(android.content.Context):wjg");
    }
}
