...
public final class v8c implements ol7 {
    ...
    public final boolean equals(Object obj) {
        ...
        v8c v8c = (v8c) obj;
        return this.a == v8c.a && tpa.f(this.b, v8c.b) && tpa.f(this.c, v8c.c) && tpa.f(this.o, v8c.o) && this.X == v8c.X && this.Y == v8c.Y && this.Z == v8c.Z && this.s0 == v8c.s0;
    }
    ...
    public final int hashCode() {
        ...
        String str = this.c;
        return Boolean.hashCode(this.s0) + ms2.d(ms2.d(ms2.d(rh4.f(this.o, (f + (str == null ? 0 : str.hashCode())) * 31, 31), 31, this.X), 31, this.Y), 31, this.Z);
    }
    ...
    public final Object n(Object obj) {
        ...
        CharSequence charSequence2 = v8c.b;
        ...
        CharSequence charSequence4 = v8c.o;
    ...
    public final String toString() {
        return "RecentContactModel(id=" + this.a + ", name=" + this.b + ", avatar=" + this.c + ", abbreviation=" + this.o + ", isOnline=" + this.X + ", isVerified=" + this.Y + ", isWebapp=" + this.Z + ", isSavedMessages=" + this.s0 + ")";
    }
}
