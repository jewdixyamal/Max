...
public class jcd extends dec {
    ...
    public jcd(View view, FrgBaseSettings frgBaseSettings) {
        ...
        View findViewById2 = view.findViewById(xxb.row_setting__small_separator);
        this.L0 = findViewById2;
        if (findViewById2 != null) {
            findViewById2.setBackgroundColor(R.K);
        }
        this.N0 = frgBaseSettings;
        if (frgBaseSettings != null) {
            view.setOnClickListener(new elb(4, (Object) this));
        }
    }

    public void A(gcd gcd, boolean z) {
        this.M0 = gcd;
        gcd.getClass();
        View view = this.a;
        ...
        if (textView != null) {
            ...
            sme sme = this.O0;
            if (i == 3) {
                textView.setTextColor(sme.k);
            } else {
                textView.setTextColor(sme.F);
            }
            this.M0.getClass();
