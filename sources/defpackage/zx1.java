...
public final /* synthetic */ class zx1 implements Runnable {
    ...
    public /* synthetic */ zx1(ay1 ay1, Context context, Executor executor, int i, lq1 lq1, long j) {
        this.b = ay1;
        this.Y = context;
        this.c = executor;
        this.X = i;
    ...
    public final void run() {
        ...
        L_0x0007:
            ...
            r2 = r1
            r5 = r10
            r2.<init>((defpackage.ay1) r3, (android.content.Context) r4, (java.util.concurrent.Executor) r5, (int) r6, (defpackage.lq1) r7, (long) r8)
            r10.execute(r1)
            return
        L_0x0023:
            ay1 r12 = r0.b
            ...
            java.lang.String r0 = defpackage.c37.F(r0)
            android.os.Trace.beginSection(r0)
            android.content.Context r1 = defpackage.lz7.n(r1)
            r9 = 0
            by1 r0 = r12.c     // Catch:{ InitializationException | CameraValidator$CameraIdListIncorrectException | RuntimeException -> 0x00ff }
            av1 r0 = r0.b()     // Catch:{ InitializationException | CameraValidator$CameraIdListIncorrectException | RuntimeException -> 0x00ff }
            ...
            w90 r7 = new w90     // Catch:{ InitializationException | CameraValidator$CameraIdListIncorrectException | RuntimeException -> 0x00ff }
            r7.<init>(r0, r5)     // Catch:{ InitializationException | CameraValidator$CameraIdListIncorrectException | RuntimeException -> 0x00ff }
            by1 r0 = r12.c     // Catch:{ InitializationException | CameraValidator$CameraIdListIncorrectException | RuntimeException -> 0x00ff }
            px1 r0 = r0.a()     // Catch:{ InitializationException | CameraValidator$CameraIdListIncorrectException | RuntimeException -> 0x00ff }
            by1 r5 = r12.c     // Catch:{ InitializationException | CameraValidator$CameraIdListIncorrectException | RuntimeException -> 0x00ff }
            long r16 = r5.c()     // Catch:{ InitializationException | CameraValidator$CameraIdListIncorrectException | RuntimeException -> 0x00ff }
            yg2 r10 = new yg2     // Catch:{ InitializationException | CameraValidator$CameraIdListIncorrectException | RuntimeException -> 0x00ff }
            r5 = r10
            r6 = r1
            r8 = r0
            r11 = r10
            ...
            by1 r5 = r12.c     // Catch:{ InitializationException | CameraValidator$CameraIdListIncorrectException | RuntimeException -> 0x00a8 }
            bv1 r5 = r5.d()     // Catch:{ InitializationException | CameraValidator$CameraIdListIncorrectException | RuntimeException -> 0x00a8 }
            if (r5 == 0) goto L_0x00f1
            yg2 r5 = r12.f     // Catch:{ InitializationException | CameraValidator$CameraIdListIncorrectException | RuntimeException -> 0x00a8 }
            ...
            dx1 r6 = (defpackage.dx1) r6     // Catch:{ InitializationException | CameraValidator$CameraIdListIncorrectException | RuntimeException -> 0x00a8 }
            ...
            y7g r5 = defpackage.bv1.a(r1, r6, r7)     // Catch:{ InitializationException | CameraValidator$CameraIdListIncorrectException | RuntimeException -> 0x00a8 }
            r12.g = r5     // Catch:{ InitializationException | CameraValidator$CameraIdListIncorrectException | RuntimeException -> 0x00a8 }
            by1 r5 = r12.c     // Catch:{ InitializationException | CameraValidator$CameraIdListIncorrectException | RuntimeException -> 0x00a8 }
            av1 r5 = r5.j()     // Catch:{ InitializationException | CameraValidator$CameraIdListIncorrectException | RuntimeException -> 0x00a8 }
            if (r5 == 0) goto L_0x00e3
            ev1 r5 = new ev1     // Catch:{ InitializationException | CameraValidator$CameraIdListIncorrectException | RuntimeException -> 0x00a8 }
            ...
            boolean r5 = r13 instanceof defpackage.rw1     // Catch:{ InitializationException | CameraValidator$CameraIdListIncorrectException | RuntimeException -> 0x00a8 }
            if (r5 == 0) goto L_0x00ab
            r5 = r13
            rw1 r5 = (defpackage.rw1) r5     // Catch:{ InitializationException | CameraValidator$CameraIdListIncorrectException | RuntimeException -> 0x00a8 }
            yg2 r6 = r12.f     // Catch:{ InitializationException | CameraValidator$CameraIdListIncorrectException | RuntimeException -> 0x00a8 }
        ...
        L_0x00a8:
            ...
            goto L_0x0110
        L_0x00ab:
            va8 r5 = r12.a     // Catch:{ InitializationException | CameraValidator$CameraIdListIncorrectException | RuntimeException -> 0x00a8 }
            yg2 r6 = r12.f     // Catch:{ InitializationException | CameraValidator$CameraIdListIncorrectException | RuntimeException -> 0x00a8 }
            r5.z(r6)     // Catch:{ InitializationException | CameraValidator$CameraIdListIncorrectException | RuntimeException -> 0x00a8 }
            va8 r5 = r12.a     // Catch:{ InitializationException | CameraValidator$CameraIdListIncorrectException | RuntimeException -> 0x00a8 }
            defpackage.yx1.a(r1, r5, r0)     // Catch:{ InitializationException | CameraValidator$CameraIdListIncorrectException | RuntimeException -> 0x00a8 }
            r0 = 1
            if (r2 <= r0) goto L_0x00cb
            boolean r0 = defpackage.hye.a()     // Catch:{ InitializationException | CameraValidator$CameraIdListIncorrectException | RuntimeException -> 0x00a8 }
            if (r0 == 0) goto L_0x00cb
            java.lang.String r0 = "CX:CameraProvider-RetryStatus"
            java.lang.String r0 = defpackage.c37.F(r0)     // Catch:{ InitializationException | CameraValidator$CameraIdListIncorrectException | RuntimeException -> 0x00a8 }
            r5 = -1
        ...
        L_0x0102:
            ...
            throw r0     // Catch:{ InitializationException | CameraValidator$CameraIdListIncorrectException | RuntimeException -> 0x00db }
        L_0x0110:
            mx1 r5 = new mx1     // Catch:{ all -> 0x00a5 }
            r5.<init>(r14, r0)     // Catch:{ all -> 0x00a5 }
            akc r7 = r12.i     // Catch:{ all -> 0x00a5 }
            zjc r7 = r7.b(r5)     // Catch:{ all -> 0x00a5 }
            boolean r8 = defpackage.hye.a()     // Catch:{ all -> 0x00a5 }
            if (r8 == 0) goto L_0x012d
            int r5 = r5.a     // Catch:{ all -> 0x00a5 }
            java.lang.String r8 = "CX:CameraProvider-RetryStatus"
            java.lang.String r8 = defpackage.c37.F(r8)     // Catch:{ all -> 0x00a5 }
        ...
        L_0x012d:
            ...
            zx1 r4 = new zx1     // Catch:{ all -> 0x00a5 }
            r11 = r4
            r16 = r2
            r17 = r1
            r18 = r3
            r11.<init>((defpackage.ay1) r12, (java.util.concurrent.Executor) r13, (long) r14, (int) r16, (android.content.Context) r17, (defpackage.lq1) r18)     // Catch:{ all -> 0x00a5 }
        ...
        L_0x01a3:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.zx1.run():void");
    }

    public /* synthetic */ zx1(ay1 ay1, Executor executor, long j, int i, Context context, lq1 lq1) {
        this.b = ay1;
        this.c = executor;
        this.o = j;
        this.X = i;
