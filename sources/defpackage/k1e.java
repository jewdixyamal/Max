    ...
    public final Object b(v4 v4Var) {
        switch (this.b) {
            ...
            case Protos.Attaches.Attach.LOCATION /*14*/:
                khe d = v4Var.d(ad.class);
                khe d2 = v4Var.d(o45.class);
                khe d3 = v4Var.d(gh3.class);
                khe d4 = v4Var.d(ri4.class);
                return new w0f(d, d3, d4, d2, v4Var.d(zi5.class), v4Var.d(af8.class), new khe(new qt2(1, d4)));
            ...
            case 16:
                khe d5 = v4Var.d(ct0.class);
                return new x0f(v4Var, (kke) v4Var.c(kke.class), new khe(new fyc(v4Var, 14)), v4Var.d(u2a.class), d5, (w0f) v4Var.c(w0f.class));
            ...
            case 25:
                khe d6 = v4Var.d(vt7.class);
                v4Var.d(y7d.class);
                return new xie(v4Var.d(u8e.class), v4Var.d(q33.class), v4Var.d(x6a.class), (p67) v4Var.c(p67.class), v4Var.d(SystemServicesManager$PushTokenGeneratedListener.class), v4Var.d(ty3.class), (ox3) v4Var.c(ox3.class), d6, v4Var.d(qe5.class));
            case 26:
                Context context = (Context) v4Var.c(Context.class);
                p9g p9g = new p9g(context, 0);
                return new acf(((Boolean) ccf.a.getValue()).booleanValue(), p9g, (NotificationManager) context.getSystemService("notification"));
            case 27:
