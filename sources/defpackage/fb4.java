...
public final class fb4 implements co7 {
    ...
    public fb4(hb4 hb4, Uri uri) {
        this.v0 = hb4;
        this.a = uri;
        this.c = ((p24) ((gaa) hb4.s0).a).a();
    }

    public static boolean a(fb4 fb4, long j) {
        fb4.s0 = SystemClock.elapsedRealtime() + j;
        hb4 hb4 = fb4.v0;
        if (!fb4.a.equals(hb4.X)) {
            return false;
        }
        ...
        for (int i = 0; i < size; i++) {
            fb4 fb42 = (fb4) hb4.b.get(((vm6) list.get(i)).a);
            fb42.getClass();
            if (elapsedRealtime > fb42.s0) {
                Uri uri = fb42.a;
                hb4.X = uri;
                fb42.c(hb4.c(uri));
                return false;
    ...
    public final void b(Uri uri) {
        hb4 hb4 = this.v0;
        aqa aqa = new aqa(this.c, uri, 4, ((dn6) hb4.t0).E((xm6) hb4.y0, this.o));
        int i = aqa.c;
        ((gk8) hb4.v0).k(new xn7(aqa.a, aqa.b, this.b.w(aqa, this, ((buc) hb4.u0).v(i))), i, -1, (oy5) null, 0, (Object) null, -9223372036854775807L, -9223372036854775807L);
    }
        ...
        if (!this.t0) {
            ...
            if (!jo7.o() && !jo7.n()) {
                ...
                if (elapsedRealtime < j) {
                    this.t0 = true;
                    this.v0.o.postDelayed(new wt1(this, 21, uri), j - elapsedRealtime);
                    return;
                }
                b(uri);
            }
    ...
    public final void d(defpackage.pm6 r65) {
        ...
        L_0x0255:
            ...
            java.lang.Object r2 = defpackage.mqd.m(r2)
    ...
    public final void o(fo7 fo7, long j, long j2, boolean z) {
        ...
        hb4 hb4 = this.v0;
        ((buc) hb4.u0).getClass();
        ((gk8) hb4.v0).d(xn7, 4, -1, (oy5) null, 0, (Object) null, -9223372036854775807L, -9223372036854775807L);
    }
    ...
    public final void y(fo7 fo7, long j, long j2) {
        ...
        if (zm6 instanceof pm6) {
            d((pm6) zm6);
            ((gk8) this.v0.v0).f(xn7, 4, -1, (oy5) null, 0, (Object) null, -9223372036854775807L, -9223372036854775807L);
        } else {
            ParserException b2 = ParserException.b((Exception) null, "Loaded playlist has unexpected type.");
            this.u0 = b2;
            ((gk8) this.v0.v0).i(xn7, 4, b2, true);
        }
    ...
    public final b11 z(fo7 fo7, long j, long j2, IOException iOException, int i) {
        ...
        xn7 xn7 = r3;
        Uri uri2 = uri;
        xn7 xn72 = new xn7(j3, aqa.b, uri, t1e.o, j, j2, t1e.b);
        ...
        if (z || z2) {
            ...
            if (z2 || i3 == 400 || i3 == 503) {
                ...
                c(uri3);
                int i4 = maf.a;
                ((gk8) hb4.v0).i(xn73, i2, iOException2, true);
                return b11;
            }
        }
        ...
        boolean z3 = false;
        while (it.hasNext()) {
            z3 |= !((fn6) it.next()).e(uri3, wn7, false);
        }
        buc buc = (buc) hb4.u0;
        if (z3) {
            buc.getClass();
        ...
        boolean z4 = !b11.a();
        ((gk8) hb4.v0).i(xn7, i2, iOException2, z4);
        if (z4) {
            buc.getClass();
        }
        return b11;
