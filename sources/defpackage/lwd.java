...
public final class lwd {
    ...
    /* JADX WARNING: type inference failed for: r0v5, types: [bu4, java.lang.Object] */
    public lwd() {
    ...
    public final bu4 c(double d2, double d3, long j2) {
        double d4;
        double d5;
        if (!this.c) {
        ...
        bu4 bu4 = this.j;
        bu4.a = (float) (d4 + this.i);
        bu4.b = (float) d5;
        return bu4;
    }

    /* JADX WARNING: type inference failed for: r0v4, types: [bu4, java.lang.Object] */
    public lwd(float f2) {
        this.a = Math.sqrt(1500.0d);
        this.b = 0.5d;
        this.c = false;
