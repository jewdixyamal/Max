...
public final class gcd implements Serializable {
    ...
    public static gcd a(int i, String str, String str2) {
        return new gcd(i, str, str2, (String) null, (Boolean) null, 0);
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (!(obj instanceof gcd) || this.a != (gcd = (gcd) obj).a || this.Y != gcd.Y || this.Z != gcd.Z || Float.compare(1.0f, 1.0f) != 0) {
            return false;
        }
        CharSequence charSequence = gcd.b;
