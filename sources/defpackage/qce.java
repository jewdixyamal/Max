...
public final class qce extends h04 implements View.OnClickListener {
    ...
    public qce(Context context, o0d o0d, SearchableInfo searchableInfo, WeakHashMap weakHashMap) {
        int suggestionRowLayout = o0d.getSuggestionRowLayout();
        this.b = true;
        this.c = null;
        this.a = false;
        this.o = -1;
        this.X = new f04((h04) this);
        ...
        this.z0 = o0d.getSuggestionCommitIconResId();
        this.x0 = context;
        this.y0 = weakHashMap;
    }
    ...
    public final void a(android.view.View r22, android.database.Cursor r23) {
        ...
        L_0x0062:
            ...
            android.content.res.ColorStateList r14 = r1.B0
            r16 = 0
            r19 = 0
            r17 = 0
            r18 = 0
    ...
    public final View d(ViewGroup viewGroup) {
        View inflate = this.u0.inflate(this.s0, viewGroup, false);
        inflate.setTag(new nce(inflate));
        ((ImageView) inflate.findViewById(mvb.edit_query)).setImageResource(this.z0);
        return inflate;
    }
    ...
    public final android.graphics.drawable.Drawable f(java.lang.String r9) {
        /*
            r8 = this;
            java.util.WeakHashMap r0 = r8.y0
            android.content.Context r1 = r8.x0
        ...
        L_0x0043:
            ...
            return r5
        L_0x0046:
            android.graphics.drawable.Drawable r4 = defpackage.kt3.b(r1, r4)     // Catch:{ NumberFormatException -> 0x0055, NotFoundException -> 0x0054 }
        ...
        L_0x00d4:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.qce.f(java.lang.String):android.graphics.drawable.Drawable");
    }
    ...
    public final Cursor g(SearchableInfo searchableInfo, String str) {
        ...
        return this.x0.getContentResolver().query(fragment.build(), (String[]) null, suggestSelection, strArr2, (String) null);
    }
    ...
    public final View getDropDownView(int i, View view, ViewGroup viewGroup) {
        try {
            ...
            View inflate = this.u0.inflate(this.t0, viewGroup, false);
            if (inflate != null) {
                ((nce) inflate.getTag()).a.setText(e.toString());
            }
            return inflate;
        }
    }
    ...
    public final View getView(int i, View view, ViewGroup viewGroup) {
        try {
            ...
            View d = d(viewGroup);
            ((nce) d.getTag()).a.setText(e.toString());
            return d;
        }
    }
