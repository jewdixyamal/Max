...
public abstract class q45 {
    public static final p45 a = new Throwable("No further exceptions");
    ...
    public static Throwable d(AtomicReference atomicReference) {
        ...
        p45 p45 = a;
        return th != p45 ? (Throwable) atomicReference.getAndSet(p45) : th;
    }

    public static String e(long j, TimeUnit timeUnit) {
        StringBuilder k = au1.k(j, "The source did not signal an event for ", " ");
