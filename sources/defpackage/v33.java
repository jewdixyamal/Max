...
public final class v33 extends ju0 {
    public ClipPathElement L(XmlResourceParser xmlResourceParser) {
        int a = ju0.a(this, xmlResourceParser, "name");
        String str = null;
        String attributeValue = ju0.c(this, a) ? xmlResourceParser.getAttributeValue(a) : null;
        int a2 = ju0.a(this, xmlResourceParser, "pathData");
        if (ju0.c(this, a2)) {
    ...
    public GroupElement M(XmlResourceParser xmlResourceParser) {
        int a = ju0.a(this, xmlResourceParser, "name");
        String attributeValue = ju0.c(this, a) ? xmlResourceParser.getAttributeValue(a) : null;
        int a2 = ju0.a(this, xmlResourceParser, "pivotX");
        float floatValue = (ju0.c(this, a2) ? Float.valueOf(Float.parseFloat(xmlResourceParser.getAttributeValue(a2))) : Float.valueOf(0.0f)).floatValue();
        int a3 = ju0.a(this, xmlResourceParser, "pivotY");
        float floatValue2 = (ju0.c(this, a3) ? Float.valueOf(Float.parseFloat(xmlResourceParser.getAttributeValue(a3))) : Float.valueOf(0.0f)).floatValue();
        int a4 = ju0.a(this, xmlResourceParser, "rotation");
        float floatValue3 = (ju0.c(this, a4) ? Float.valueOf(Float.parseFloat(xmlResourceParser.getAttributeValue(a4))) : Float.valueOf(0.0f)).floatValue();
        int a5 = ju0.a(this, xmlResourceParser, "scaleX");
        float floatValue4 = (ju0.c(this, a5) ? Float.valueOf(Float.parseFloat(xmlResourceParser.getAttributeValue(a5))) : Float.valueOf(1.0f)).floatValue();
        int a6 = ju0.a(this, xmlResourceParser, "scaleY");
        float floatValue5 = (ju0.c(this, a6) ? Float.valueOf(Float.parseFloat(xmlResourceParser.getAttributeValue(a6))) : Float.valueOf(1.0f)).floatValue();
        int a7 = ju0.a(this, xmlResourceParser, "translateX");
        float floatValue6 = (ju0.c(this, a7) ? Float.valueOf(Float.parseFloat(xmlResourceParser.getAttributeValue(a7))) : Float.valueOf(0.0f)).floatValue();
        int a8 = ju0.a(this, xmlResourceParser, "translateY");
        return new GroupElement(attributeValue, floatValue, floatValue2, floatValue3, floatValue4, floatValue5, floatValue6, (ju0.c(this, a8) ? Float.valueOf(Float.parseFloat(xmlResourceParser.getAttributeValue(a8))) : Float.valueOf(0.0f)).floatValue(), (GroupElement) null, (ElementHolder) null, 768, (z84) null);
    }
    ...
    public one.me.sdk.richvector.internal.element.PathElement N(android.content.res.XmlResourceParser r21) {
        /*
            ...
            int r2 = defpackage.ju0.a(r0, r1, r2)
            boolean r3 = defpackage.ju0.c(r0, r2)
            r4 = 0
        ...
        L_0x0037:
            ...
            int r8 = defpackage.ju0.a(r0, r1, r8)
            boolean r9 = defpackage.ju0.c(r0, r8)
            r10 = 0
            if (r9 == 0) goto L_0x005e
            java.lang.String r8 = r1.getAttributeValue(r8)
            int r8 = defpackage.s36.x(r8)
        ...
        L_0x0062:
            int r8 = r8.intValue()
            nra r9 = defpackage.nra.o
            java.lang.Object r11 = r9.b
            java.lang.String r11 = (java.lang.String) r11
            int r11 = defpackage.ju0.a(r0, r1, r11)
            boolean r12 = defpackage.ju0.c(r0, r11)
        ...
        L_0x00d9:
            ...
            int r3 = defpackage.ju0.a(r0, r1, r3)
            boolean r7 = defpackage.ju0.c(r0, r3)
            if (r7 == 0) goto L_0x00fc
            java.lang.String r3 = r1.getAttributeValue(r3)
            int r3 = defpackage.s36.x(r3)
        ...
        L_0x0100:
            int r12 = r3.intValue()
            ora r3 = defpackage.ora.o
            java.lang.Object r7 = r3.b
            java.lang.String r7 = (java.lang.String) r7
            int r7 = defpackage.ju0.a(r0, r1, r7)
            boolean r10 = defpackage.ju0.c(r0, r7)
            if (r10 == 0) goto L_0x012d
            java.lang.String r3 = r1.getAttributeValue(r7)
            boolean r7 = defpackage.tpa.f(r3, r13)
            if (r7 == 0) goto L_0x0121
            android.graphics.Paint$Cap r3 = android.graphics.Paint.Cap.ROUND
            goto L_0x012f
        L_0x0121:
            boolean r3 = defpackage.tpa.f(r3, r14)
        ...
        L_0x012f:
            ...
            pra r7 = defpackage.pra.o
            java.lang.Object r10 = r7.b
            java.lang.String r10 = (java.lang.String) r10
            int r10 = defpackage.ju0.a(r0, r1, r10)
            boolean r15 = defpackage.ju0.c(r0, r10)
            if (r15 == 0) goto L_0x015a
            java.lang.String r7 = r1.getAttributeValue(r10)
            boolean r10 = defpackage.tpa.f(r7, r13)
            if (r10 == 0) goto L_0x014e
            android.graphics.Paint$Join r7 = android.graphics.Paint.Join.ROUND
            goto L_0x015c
        L_0x014e:
            boolean r7 = defpackage.tpa.f(r7, r14)
        ...
        L_0x01c1:
            ...
            int r5 = defpackage.ju0.a(r0, r1, r5)
            boolean r7 = defpackage.ju0.c(r0, r5)
        ...
        L_0x01e2:
            ...
            int r5 = defpackage.ju0.a(r0, r1, r5)
            boolean r0 = defpackage.ju0.c(r0, r5)
    ...
    public Shape O(XmlResourceParser xmlResourceParser) {
        Float f;
        Float f2;
        int a = ju0.a(this, xmlResourceParser, "viewportWidth");
        float floatValue = (ju0.c(this, a) ? Float.valueOf(Float.parseFloat(xmlResourceParser.getAttributeValue(a))) : Float.valueOf(0.0f)).floatValue();
        int a2 = ju0.a(this, xmlResourceParser, "viewportHeight");
        float floatValue2 = (ju0.c(this, a2) ? Float.valueOf(Float.parseFloat(xmlResourceParser.getAttributeValue(a2))) : Float.valueOf(0.0f)).floatValue();
        int a3 = ju0.a(this, xmlResourceParser, "alpha");
        int min = Math.min(255, (int) (((float) 255) * (ju0.c(this, a3) ? Float.valueOf(Float.parseFloat(xmlResourceParser.getAttributeValue(a3))) : Float.valueOf(1.0f)).floatValue()));
        int a4 = ju0.a(this, xmlResourceParser, "name");
        String attributeValue = ju0.c(this, a4) ? xmlResourceParser.getAttributeValue(a4) : null;
        int a5 = ju0.a(this, xmlResourceParser, "width");
        int i = 3;
        if (ju0.c(this, a5)) {
        ...
        int a6 = ju0.a(this, xmlResourceParser, "height");
        if (ju0.c(this, a6)) {
        ...
        return new Shape(attributeValue, floatValue, floatValue2, min, floatValue3, f2.floatValue(), (ElementHolder) null, 64, (z84) null);
    }
}
