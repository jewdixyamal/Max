...
public final class er0 {
            ...
            default:
                ...
                if (weakReference2 != null && weakReference2.get() != null) {
                    ...
                    if (!this.c) {
                        ...
                        ((View) sideSheetBehavior.p.get()).postOnAnimation((u3c) this.d);
                        this.c = true;
                        return;
                    }
                    return;
    ...
    public void c(va8 va8, int i, int i2) {
        int i3;
    ...
    public void e(va8 va8, int i, int i2) {
        if (!((n77) g()).hasNext()) {
            c(va8, i, i2);
            return;
        }
        hd6 hd6 = (hd6) ((n77) g()).next();
        if (hd6.c != i || hd6.d != i2) {
            d();
            c(va8, i, i2);
        }
    ...
    public hd6 h() {
        ...
        if (!arrayDeque.isEmpty()) {
            hd6 hd6 = (hd6) arrayDeque.remove();
            ((ArrayDeque) this.e).add(hd6);
            return hd6;
        }
