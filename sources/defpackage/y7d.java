...
public interface y7d {
    public static final xs a = new xs((Collection) Arrays.asList(new String[]{"error.comment.chat.access", "error.comment.invalid", "error.message.invalid", "error.message.chat.access", "error.message.like.unknown.like", "error.message.like.unknown.reaction"}));
