...
public abstract class sh7 extends ViewGroup {
    ...
    public sh7(Context context, AttributeSet attributeSet, int i) {
        ...
        k8g x = k8g.x(context, attributeSet, p3c.LinearLayoutCompat, i, 0);
        ...
        setDividerDrawable(x.n(p3c.LinearLayoutCompat_divider));
    ...
    public void drawDividersHorizontal(Canvas canvas) {
        ...
        for (int i3 = 0; i3 < virtualChildCount; i3++) {
            ...
            if (!(virtualChildAt == null || virtualChildAt.getVisibility() == 8 || !hasDividerBeforeChildAt(i3))) {
                rh7 rh7 = (rh7) virtualChildAt.getLayoutParams();
                drawVerticalDivider(canvas, z ? virtualChildAt.getRight() + rh7.rightMargin : (virtualChildAt.getLeft() - rh7.leftMargin) - this.mDividerWidth);
            }
        }
        if (hasDividerBeforeChildAt(virtualChildCount)) {
            View virtualChildAt2 = getVirtualChildAt(virtualChildCount - 1);
            if (virtualChildAt2 != null) {
                rh7 rh72 = (rh7) virtualChildAt2.getLayoutParams();
                if (z) {
                    left = virtualChildAt2.getLeft() - rh72.leftMargin;
                    i2 = this.mDividerWidth;
                } else {
                    i = virtualChildAt2.getRight() + rh72.rightMargin;
    ...
    public void drawDividersVertical(Canvas canvas) {
        ...
        for (int i = 0; i < virtualChildCount; i++) {
            ...
            if (!(virtualChildAt == null || virtualChildAt.getVisibility() == 8 || !hasDividerBeforeChildAt(i))) {
                drawHorizontalDivider(canvas, (virtualChildAt.getTop() - ((rh7) virtualChildAt.getLayoutParams()).topMargin) - this.mDividerHeight);
            }
        }
        if (hasDividerBeforeChildAt(virtualChildCount)) {
            View virtualChildAt2 = getVirtualChildAt(virtualChildCount - 1);
            drawHorizontalDivider(canvas, virtualChildAt2 == null ? (getHeight() - getPaddingBottom()) - this.mDividerHeight : virtualChildAt2.getBottom() + ((rh7) virtualChildAt2.getLayoutParams()).bottomMargin);
        }
    }
    ...
    public int getBaseline() {
        ...
        if (childCount > i2) {
            ...
            if (baseline != -1) {
                ...
                return i3 + ((rh7) childAt.getLayoutParams()).topMargin + baseline;
    ...
    /* JADX WARNING: type inference failed for: r2v3, types: [rh7, android.widget.LinearLayout$LayoutParams] */
    /* JADX WARNING: type inference failed for: r2v4, types: [rh7, android.widget.LinearLayout$LayoutParams] */
    ...
    /* JADX WARNING: type inference failed for: r0v3, types: [rh7, android.widget.LinearLayout$LayoutParams] */
    /* JADX WARNING: type inference failed for: r0v4, types: [rh7, android.widget.LinearLayout$LayoutParams] */
    /* JADX WARNING: type inference failed for: r0v5, types: [rh7, android.widget.LinearLayout$LayoutParams] */
    public rh7 generateLayoutParams(ViewGroup.LayoutParams layoutParams) {
        if (layoutParams instanceof rh7) {
            return new LinearLayout.LayoutParams((rh7) layoutParams);
        }
