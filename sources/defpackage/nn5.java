...
public final class nn5 extends uj6 {
    ...
    public final int T(hj3 hj3, int i) {
        if (hj3 == null) {
            return 0;
        }
        int[] iArr = hj3.p0;
        if (iArr[1] == 3) {
            ...
            if (i2 == 2) {
                int i3 = (int) (hj3.z * ((float) i));
                if (i3 != hj3.k()) {
                    hj3.g = true;
                    W(iArr[0], hj3.q(), 1, i3, hj3);
                }
                return i3;
            } else if (i2 == 1) {
                return hj3.k();
                ...
                if (i2 == 3) {
                    return (int) ((((float) hj3.q()) * hj3.W) + 0.5f);
                }
            }
        }
        return hj3.k();
    ...
    public final int U(hj3 hj3, int i) {
        if (hj3 == null) {
            return 0;
        }
        int[] iArr = hj3.p0;
        if (iArr[0] == 3) {
            ...
            if (i2 == 2) {
                int i3 = (int) (hj3.w * ((float) i));
                if (i3 != hj3.q()) {
                    hj3.g = true;
                    W(1, i3, iArr[1], hj3.k(), hj3);
                }
                return i3;
            } else if (i2 == 1) {
                return hj3.q();
                ...
                if (i2 == 3) {
                    return (int) ((((float) hj3.k()) * hj3.W) + 0.5f);
                }
            }
        }
        return hj3.q();
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r10v2, resolved type: ln5} */
    ...
    public final void V(int r40, int r41, int r42, int r43) {
        ...
        L_0x0026:
            ...
            goto L_0x0075
        L_0x0031:
            boolean r4 = r3 instanceof defpackage.fh6
        ...
        L_0x02a1:
            ...
            ln5 r15 = (defpackage.ln5) r15
            if (r36 != 0) goto L_0x02ff
            int r5 = r0 + -1
            if (r7 >= r5) goto L_0x02c0
            int r5 = r7 + 1
            java.lang.Object r5 = r14.get(r5)
            ln5 r5 = (defpackage.ln5) r5
            hj3 r5 = r5.b
            oi3 r5 = r5.J
            r12 = r5
            r38 = r14
    ...
    public final void W(int i, int i2, int i3, int i4, hj3 hj3) {
        dob dob;
        hj3 hj32;
        while (true) {
            dob = this.C0;
            if (dob != null || (hj32 = this.T) == null) {
                xk0 xk0 = this.B0;
                xk0.b = i;
                xk0.d = i3;
                xk0.e = i2;
    ...
    public final void b(zh7 zh7, boolean z) {
        ...
        super.b(zh7, z);
        hj3 hj32 = this.T;
        boolean z2 = hj32 != null && ((ij3) hj32).v0;
        int i2 = this.T0;
        ...
        if (i2 != 0) {
            if (i2 == 1) {
                ...
                while (i8 < i6) {
                    ...
                    hj3 hj34 = this.Y0[i];
                    if (!(hj34 == null || hj34.g0 == 8)) {
                        oi3 oi3 = hj34.I;
                        if (i8 == 0) {
                            hj34.f(oi3, this.I, this.w0);
                            hj34.i0 = this.D0;
                            hj34.d0 = f;
                        }
                        if (i8 == i6 - 1) {
                            hj34.f(hj34.K, this.K, this.x0);
                        }
                        if (i8 > 0 && hj33 != null) {
                            int i9 = this.P0;
                            oi3 oi32 = hj33.K;
                ...
                for (int i10 = 0; i10 < i7; i10++) {
                    hj3 hj35 = this.X0[i10];
                    if (!(hj35 == null || hj35.g0 == 8)) {
                        oi3 oi33 = hj35.J;
                        if (i10 == 0) {
                            hj35.f(oi33, this.J, this.s0);
                            hj35.j0 = this.E0;
                            hj35.e0 = this.K0;
                        }
                        if (i10 == i7 - 1) {
                            hj35.f(hj35.L, this.L, this.t0);
                        }
                        if (i10 > 0 && hj33 != null) {
                            int i11 = this.Q0;
                            oi3 oi34 = hj33.L;
                            hj35.f(oi33, oi34, i11);
                            hj33.f(oi34, oi33, 0);
                        }
                        hj33 = hj35;
                    }
                ...
                for (int i12 = 0; i12 < i6; i12++) {
                    for (int i13 = 0; i13 < i7; i13++) {
                        ...
                        hj3[] hj3Arr = this.a1;
                        if (!(i14 >= hj3Arr.length || (hj3 = hj3Arr[i14]) == null || hj3.g0 == 8)) {
                            hj3 hj36 = this.Y0[i12];
                            hj3 hj37 = this.X0[i13];
                            if (hj3 != hj36) {
                                hj3.f(hj3.I, hj36.I, 0);
                                hj3.f(hj3.K, hj36.K, 0);
                            }
                            if (hj3 != hj37) {
                                hj3.f(hj3.J, hj37.J, 0);
                                hj3.f(hj3.L, hj37.L, 0);
                            }
                        }
                    }
                }
