...
public class qpd {
    ...
    public final int c(int i, Object obj) {
        ...
        int l = j47.l(i2, i, this.a);
        if (l < 0 || tpa.f(obj, this.b[l << 1])) {
            return l;
        }
        int i3 = l + 1;
        ...
        try {
            if (obj instanceof qpd) {
                ...
                for (int i2 = 0; i2 < i; i2++) {
                    Object f = f(i2);
                    Object i3 = i(i2);
                    Object obj2 = qpd.get(f);
                    if (i3 == null) {
                        if (obj2 != null || !qpd.containsKey(f)) {
                            return false;
                        }
    ...
    public final Object g(int i) {
        ...
        if (i2 <= 1) {
            ...
            if (iArr.length <= 8 || i2 >= iArr.length / 3) {
                if (i < i4) {
                    int i6 = i + 1;
                    ys.V(i, i6, i2, iArr, iArr);
                    Object[] objArr2 = this.b;
                    ys.W(i3, i6 << 1, i2 << 1, objArr2, objArr2);
                }
