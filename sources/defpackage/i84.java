...
public final class i84 implements hg0, z0f {
    ...
    public i84(Context context, HashMap hashMap, int i2, she she, boolean z) {
        this.a = cx6.b(hashMap);
        this.e = new btd(i2, 1);
        this.c = she;
        this.d = z;
        if (context != null) {
            ho9 h2 = ho9.h(context);
            int i3 = h2.i();
            this.m = i3;
            this.k = b(i3);
            g84 g84 = new g84(this);
            CopyOnWriteArrayList copyOnWriteArrayList = (CopyOnWriteArrayList) h2.c;
            ...
            copyOnWriteArrayList.add(new WeakReference(g84));
            ((Handler) h2.b).post(new do9(h2, 1, g84));
            return;
        }
        this.m = 0;
        this.k = b(0);
    ...
    public final long b(int r1) {
        ...
        L_0x0023:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.i84.b(int):long");
    }
    ...
    public final void c(int i2, long j2, long j3) {
        if (i2 != 0 || j2 != 0 || j3 != this.l) {
            ...
            while (it.hasNext()) {
                fg0 fg0 = (fg0) it.next();
                if (!fg0.c) {
                    fg0.a.post(new t60(i2, 3, j2, j3, fg0));
                }
            }
        }
    }
