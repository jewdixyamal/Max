...
public final class o3f extends fqd {
    ...
    public static u3f g(u3f u3f) {
        return u3f == null ? new u3f() : u3f;
    }
    ...
    public static fm5 i(XmlPullParser xmlPullParser, fm5 fm5) {
    ...
    public static void j(String str, u3f u3f) {
        Matcher matcher;
        char c = 65535;
        int i = maf.a;
    ...
    public static uwc k(XmlPullParser xmlPullParser) {
        float f;
    ...
    public static void m(org.xmlpull.v1.XmlPullParser r20, java.util.HashMap r21, defpackage.fm5 r22, defpackage.jt r23, java.util.HashMap r24, java.util.HashMap r25) {
        /*
            r0 = r20
            r1 = r21
            r2 = r23
        ...
        L_0x000a:
            ...
            boolean r8 = defpackage.z04.P(r0, r7)
            if (r8 == 0) goto L_0x0057
            java.lang.String r7 = defpackage.z04.x(r0, r7)
            u3f r8 = new u3f
            r8.<init>()
            u3f r8 = o(r0, r8)
        ...
        L_0x0057:
            ...
            java.lang.String r10 = defpackage.z04.x(r0, r8)
            r7 = 0
            if (r10 != 0) goto L_0x006a
            goto L_0x0219
        L_0x006a:
            java.lang.String r8 = "origin"
            java.lang.String r8 = defpackage.z04.x(r0, r8)
            if (r8 == 0) goto L_0x0219
            java.util.regex.Pattern r9 = C0
            java.util.regex.Matcher r11 = r9.matcher(r8)
            java.util.regex.Pattern r12 = D0
        ...
        L_0x00e5:
            ...
            java.lang.String r13 = defpackage.z04.x(r0, r13)
        ...
        L_0x0224:
            ...
            boolean r7 = defpackage.z04.P(r0, r4)
        ...
        L_0x022e:
            ...
            java.lang.String r7 = defpackage.z04.x(r0, r8)
            if (r7 == 0) goto L_0x0249
        ...
        L_0x0249:
            r11 = r25
        L_0x024b:
            boolean r7 = defpackage.z04.L(r0, r4)
            if (r7 == 0) goto L_0x022e
        L_0x0251:
            java.lang.String r4 = "head"
            boolean r4 = defpackage.z04.L(r0, r4)
    ...
    /* JADX WARNING: Can't fix incorrect switch cases order */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static defpackage.p3f n(org.xmlpull.v1.XmlPullParser r21, defpackage.p3f r22, java.util.HashMap r23, defpackage.uwc r24) {
        /*
            r0 = r21
            r11 = r22
            r1 = r24
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r1v54, resolved type: epe} */
    ...
    /* JADX WARNING: type inference failed for: r12v15, types: [epe] */
    /* JADX WARNING: type inference failed for: r11v69, types: [epe] */
    /* JADX WARNING: type inference failed for: r12v20, types: [epe] */
    /* JADX WARNING: Can't fix incorrect switch cases order */
    ...
    public static defpackage.u3f o(org.xmlpull.v1.XmlPullParser r19, defpackage.u3f r20) {
        ...
        L_0x014b:
            u3f r0 = g(r0)
            int r13 = defpackage.j63.a(r12, r11)     // Catch:{ IllegalArgumentException -> 0x0159 }
        ...
        L_0x018d:
            u3f r0 = g(r0)
            java.util.regex.Pattern r13 = defpackage.epe.d
        ...
        L_0x0253:
            r13 = 0
            jx6 r11 = defpackage.epe.g
            xbd r11 = defpackage.ngg.y(r11, r12)
            jx6 r15 = defpackage.epe.f
        ...
        L_0x02f4:
            r18 = r3
            u3f r0 = g(r0)     // Catch:{ SubtitleDecoderException -> 0x02fe }
        ...
        L_0x0393:
            ...
            u3f r0 = g(r0)
            r1 = 0
            int r3 = defpackage.j63.a(r12, r1)     // Catch:{ IllegalArgumentException -> 0x03a5 }
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static long p(java.lang.String r13, defpackage.uwc r14) {
        /*
            r0 = 4
            r1 = 3
            java.util.regex.Pattern r2 = y0
    ...
    public static jt q(XmlPullParser xmlPullParser) {
        String x = z04.x(xmlPullParser, "extent");
        if (x == null) {
            return null;
        }
        Matcher matcher = D0.matcher(x);
        if (!matcher.matches()) {
            if (x.length() != 0) {
                "Ignoring non-pixel tts extent: ".concat(x);
            }
            return null;
        }
        try {
            ...
            String group2 = matcher.group(2);
            group2.getClass();
            return new jt(parseInt, Integer.parseInt(group2), 10);
        } catch (NumberFormatException unused) {
            if (x.length() != 0) {
                "Ignoring malformed tts extent: ".concat(x);
            }
            return null;
        }
    }
    ...
    public final abe a(int i, byte[] bArr, boolean z) {
        uwc uwc;
        try {
            XmlPullParser newPullParser = this.x0.newPullParser();
            HashMap hashMap = new HashMap();
            HashMap hashMap2 = new HashMap();
            HashMap hashMap3 = new HashMap();
            hashMap2.put("", new s3f("", -3.4028235E38f, -3.4028235E38f, Integer.MIN_VALUE, Integer.MIN_VALUE, -3.4028235E38f, -3.4028235E38f, Integer.MIN_VALUE, -3.4028235E38f, Integer.MIN_VALUE));
            jt jtVar = null;
            ...
            for (int eventType = newPullParser.getEventType(); eventType != 1; eventType = newPullParser.getEventType()) {
                p3f p3f = (p3f) arrayDeque.peek();
                if (i2 == 0) {
                    String name = newPullParser.getName();
                    if (eventType == 2) {
                        if ("tt".equals(name)) {
                            uwc2 = k(newPullParser);
                            fm52 = i(newPullParser, fm5);
                            jtVar = q(newPullParser);
                        }
                        fm5 fm53 = fm52;
                        jt jtVar2 = jtVar;
                        uwc uwc3 = uwc2;
                        if (!h(name)) {
                            ...
                            if ("head".equals(name)) {
                                uwc = uwc3;
                                m(newPullParser, hashMap, fm53, jtVar2, hashMap2, hashMap3);
                            } else {
                                uwc = uwc3;
                                try {
                                    p3f n = n(newPullParser, p3f, hashMap2, uwc);
                                    arrayDeque.push(n);
                                    if (p3f != null) {
                                        if (p3f.m == null) {
                                            p3f.m = new ArrayList();
                        ...
                        p3f.getClass();
                        p3f a = p3f.a(newPullParser.getText());
                        if (p3f.m == null) {
                            p3f.m = new ArrayList();
                        }
                        p3f.m.add(a);
                        ...
                        if (newPullParser.getName().equals("tt")) {
                            p3f p3f2 = (p3f) arrayDeque.peek();
                            p3f2.getClass();
                            jc6 = new jc6(p3f2, hashMap, hashMap2, hashMap3);
                        }
                        arrayDeque.pop();
                    }
                } else if (eventType == 2) {
