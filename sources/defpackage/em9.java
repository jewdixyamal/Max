...
public enum em9 {
    ...
    public static void a() {
        File[] listFiles = new File(new File(System.getProperty("java.io.tmpdir")).getAbsolutePath()).listFiles(new dm9(0));
        if (listFiles != null) {
    ...
    public static String c() {
        String str;
        int b2 = b();
        StringBuilder m = au1.m("/", em9.class.getPackage().getName().replace('.', '/'), "/");
        if (b2 == 1) {
            str = "win32";
        } else if (b2 == 2) {
            str = "linux";
