...
public final class rd9 implements ka5 {
    ...
    public static long b(e99 e99) {
        if (e99 == null) {
            return -9223372036854775807L;
        }
        for (c99 c99 : e99.a) {
            if (c99 instanceof ipe) {
                ipe ipe = (ipe) c99;
                if (ipe.a.equals("TLEN")) {
                    return maf.D(Long.parseLong(ipe.c));
                }
            }
        }
        return -9223372036854775807L;
    ...
    public final ii3 a(ra4 ra4, boolean z) {
        yaf yaf = this.c;
        ...
        ie9 ie9 = this.d;
        ie9.a(h2);
        return new gi3(ra4.c, ra4.o, ie9.g, ie9.d, z);
    }

    public final boolean c(ra4 ra4) {
        c2d c2d = this.q;
        if (c2d != null) {
            long a2 = c2d.a();
            if (a2 != -1 && ra4.r() > a2 - 4) {
        ...
        try {
            return !ra4.q(this.c.a, 0, 4, true);
    ...
    public final void d(long j2, long j3) {
        ...
        this.t = j3;
        c2d c2d = this.q;
        if ((c2d instanceof wz6) && !((wz6) c2d).d(j3)) {
            this.s = true;
            this.j = this.g;
        }
    }

    public final boolean e(ra4 ra4, boolean z) {
        int i2;
        int i3;
        int p2;
        ra4 ra42 = ra4;
        ...
        ra42.Y = 0;
        if (ra42.o == 0) {
            e99 K = this.f.K(ra42, (this.a & 8) == 0 ? null : u);
            this.l = K;
            if (K != null) {
                this.e.b(K);
            }
        ...
        while (true) {
            if (!c(ra4)) {
                ...
                yaf.H(0);
                int h2 = yaf.h();
                if ((i3 == 0 || ((long) (-128000 & h2)) == (((long) i3) & -128000)) && (p2 = ay7.p(h2)) != -1) {
                    i5++;
                    if (i5 != 1) {
                        if (i5 == 4) {
                            break;
    ...
    public final boolean h(ma5 ma5) {
        return e((ra4) ma5, true);
    }

    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r1v27, resolved type: c2d} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r2v19, resolved type: bc9} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r1v28, resolved type: wz6} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r1v31, resolved type: wz6} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r1v38, resolved type: wz6} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r1v39, resolved type: wz6} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r2v27, resolved type: bc9} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r2v31, resolved type: bc9} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r1v46, resolved type: q9g} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r0v28, resolved type: zaf} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r1v64, resolved type: wz6} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r1v65, resolved type: wz6} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r1v66, resolved type: wz6} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r1v67, resolved type: ii3} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r28v4, resolved type: wz6} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r1v68, resolved type: ii3} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r1v69, resolved type: ii3} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r28v5, resolved type: zaf} */
    /* JADX WARNING: type inference failed for: r1v45, types: [pm5] */
    ...
    public final int i(defpackage.ma5 r37, defpackage.lh4 r38) {
        /*
            r36 = this;
            r0 = r36
            r1 = r37
            ...
            r5 = r1
            ra4 r5 = (defpackage.ra4) r5     // Catch:{ EOFException -> 0x001e }
        ...
        L_0x00b7:
            ...
            r19 = r2
            r23 = r4
            long r31 = defpackage.maf.J(r19, r21, r23)
            int r2 = r27.A()
            int r3 = r27.A()
            int r4 = r27.A()
            r5 = r27
        ...
        L_0x016e:
            ...
            r27 = r13
            r31 = r2
            long r31 = defpackage.maf.J(r27, r29, r31)
            r2 = 6
            r3 = r8 & 6
        ...
        L_0x021c:
            ...
            r13 = r10[r12]
            boolean r14 = r13 instanceof defpackage.zb9
            if (r14 == 0) goto L_0x0278
            zb9 r13 = (defpackage.zb9) r13
            long r10 = b(r2)
            int[] r2 = r13.X
            int r2 = r2.length
            r26 = 1
        ...
        L_0x03a8:
            ...
            r4.p = r2
            c2d r3 = r4.q
            boolean r5 = r3 instanceof defpackage.wz6
            if (r5 == 0) goto L_0x03ed
            wz6 r3 = (defpackage.wz6) r3
            long r5 = r4.n
            int r7 = r9.h
            long r7 = (long) r7
            long r5 = r5 + r7
        ...
        L_0x0432:
            ...
            c2d r0 = r4.q
            boolean r1 = r0 instanceof defpackage.wz6
