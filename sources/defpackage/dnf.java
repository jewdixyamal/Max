...
public final class dnf {
    ...
    public final gwe u = new gwe(4, (Object) this);

    public dnf(Context context, ViewGroup viewGroup, nd7 nd7) {
        if (viewGroup == null) {
    ...
    public final boolean c(View view, float f2, float f3) {
        ...
        nd7 nd7 = this.q;
        boolean z = nd7.x(view) > 0;
        boolean z2 = nd7.y(view) > 0;
        if (!z || !z2) {
    ...
    public final boolean h(int r11, int r12, int r13, int r14) {
        ...
        L_0x006b:
            ...
            return r10
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.dnf.h(int, int, int, int):boolean");
    }
