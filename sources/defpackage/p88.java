...
public abstract class p88 {
    ...
    public static void a(String str, ArrayList arrayList) {
        if ("audio/raw".equals(str)) {
            if (oaf.a < 26 && oaf.b.equals("R9") && arrayList.size() == 1 && ((y78) arrayList.get(0)).a.equals("OMX.MTK.AUDIO.DECODER.RAW")) {
                arrayList.add(y78.h("OMX.google.raw.decoder", "audio/raw", "audio/raw", (MediaCodecInfo.CodecCapabilities) null, false, true, false, false));
            }
    ...
    public static String b(qy5 qy5) {
        Pair d;
        if ("audio/eac3-joc".equals(qy5.n)) {
            return "audio/eac3";
        }
        if (!"video/dolby-vision".equals(qy5.n) || (d = d(qy5)) == null) {
            return null;
        }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:343:0x0557, code lost:
        switch(r17) {
            ...
            case ru.ok.tamtam.nano.Protos.Attaches.Attach.PRESENT :int: goto L_0x05ab;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:351:0x0588, code lost:
        r2 = java.lang.Integer.valueOf(kotlinx.coroutines.internal.LockFreeTaskQueueCore.MIN_ADD_SPIN_CAPACITY);
     */
    ...
    public static android.util.Pair d(defpackage.qy5 r32) {
        ...
        L_0x0351:
            ...
            java.lang.String r0 = defpackage.ia9.d(r0)     // Catch:{ NumberFormatException -> 0x03ac }
        ...
        L_0x06d5:
            ...
            defpackage.z04.c0(r0)     // Catch:{ NumberFormatException -> 0x06e5 }
            goto L_0x06e8
        L_0x06e5:
            defpackage.k7d.o(r1, r14)
        L_0x06e8:
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r6v0, resolved type: l88} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r6v1, resolved type: java.lang.Object} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r6v3, resolved type: l88} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r6v4, resolved type: l88} */
    /* JADX WARNING: type inference failed for: r9v3, types: [java.lang.Object, k88] */
    /* JADX WARNING: Multi-variable type inference failed */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static synchronized java.util.List e(java.lang.String r8, boolean r9, boolean r10) {
        /*
            java.lang.String r0 = "MediaCodecList API didn't list secure decoder for: "
            java.lang.Class<p88> r1 = defpackage.p88.class
            monitor-enter(r1)
            i88 r2 = new i88     // Catch:{ all -> 0x0023 }
            ...
            return r4
        L_0x0016:
            int r4 = defpackage.oaf.a     // Catch:{ all -> 0x0023 }
            r5 = 21
            if (r4 < r5) goto L_0x0025
            l88 r6 = new l88     // Catch:{ all -> 0x0023 }
            r7 = 1
            r6.<init>(r7, r9, r10)     // Catch:{ all -> 0x0023 }
            goto L_0x002a
        L_0x0023:
            r8 = move-exception
            goto L_0x0077
        L_0x0025:
            ob6 r6 = new ob6     // Catch:{ all -> 0x0023 }
            r6.<init>()     // Catch:{ all -> 0x0023 }
        L_0x002a:
            java.util.ArrayList r10 = f(r2, r6)     // Catch:{ all -> 0x0023 }
            if (r9 == 0) goto L_0x006b
            boolean r9 = r10.isEmpty()     // Catch:{ all -> 0x0023 }
            if (r9 == 0) goto L_0x006b
            if (r5 > r4) goto L_0x006b
            r9 = 23
            if (r4 > r9) goto L_0x006b
            ob6 r9 = new ob6     // Catch:{ all -> 0x0023 }
            r9.<init>()     // Catch:{ all -> 0x0023 }
            java.util.ArrayList r10 = f(r2, r9)     // Catch:{ all -> 0x0023 }
            boolean r9 = r10.isEmpty()     // Catch:{ all -> 0x0023 }
            if (r9 != 0) goto L_0x006b
            java.lang.StringBuilder r9 = new java.lang.StringBuilder     // Catch:{ all -> 0x0023 }
            r9.<init>(r0)     // Catch:{ all -> 0x0023 }
            r9.append(r8)     // Catch:{ all -> 0x0023 }
            java.lang.String r0 = ". Assuming: "
            r9.append(r0)     // Catch:{ all -> 0x0023 }
            r0 = 0
            java.lang.Object r0 = r10.get(r0)     // Catch:{ all -> 0x0023 }
            y78 r0 = (defpackage.y78) r0     // Catch:{ all -> 0x0023 }
            java.lang.String r0 = r0.a     // Catch:{ all -> 0x0023 }
            r9.append(r0)     // Catch:{ all -> 0x0023 }
            java.lang.String r9 = r9.toString()     // Catch:{ all -> 0x0023 }
            defpackage.z04.c0(r9)     // Catch:{ all -> 0x0023 }
        L_0x006b:
            a(r8, r10)     // Catch:{ all -> 0x0023 }
            zw6 r8 = defpackage.zw6.j(r10)     // Catch:{ all -> 0x0023 }
        ...
        L_0x0077:
            ...
            throw r8
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.p88.e(java.lang.String, boolean, boolean):java.util.List");
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static java.util.ArrayList f(defpackage.i88 r23, defpackage.k88 r24) {
        /*
            r1 = r23
            r2 = r24
            ...
            int r15 = r24.g()     // Catch:{ Exception -> 0x014e }
            boolean r13 = r24.h()     // Catch:{ Exception -> 0x014e }
            r16 = 0
            r12 = r16
        L_0x001b:
            if (r12 >= r15) goto L_0x0174
            android.media.MediaCodecInfo r0 = r2.a(r12)     // Catch:{ Exception -> 0x014e }
            int r6 = defpackage.oaf.a     // Catch:{ Exception -> 0x014e }
            r7 = 29
        ...
        L_0x0045:
            ...
            boolean r8 = r2.d(r4, r10, r9)     // Catch:{ Exception -> 0x0117 }
        ...
        L_0x0057:
            ...
            goto L_0x002d
        L_0x005c:
            boolean r7 = r2.d(r3, r10, r9)     // Catch:{ Exception -> 0x0117 }
        ...
        L_0x0093:
            ...
            java.lang.String r0 = defpackage.lz7.T(r0)     // Catch:{ Exception -> 0x0117 }
        ...
        L_0x00c1:
            ...
            r22 = r13
            r13 = r2
            y78 r0 = defpackage.y78.h(r6, r7, r8, r9, r10, r11, r12, r13)     // Catch:{ Exception -> 0x00dc }
        ...
        L_0x00e0:
            ...
            r1 = r13
            r13 = r2
            y78 r0 = defpackage.y78.h(r6, r7, r8, r9, r10, r11, r12, r13)     // Catch:{ Exception -> 0x0112 }
        ...
        L_0x0117:
            ...
            r22 = r13
        L_0x011f:
            int r2 = defpackage.oaf.a     // Catch:{ Exception -> 0x014e }
            r6 = 23
            ...
            defpackage.z04.u(r0)     // Catch:{ Exception -> 0x014e }
        L_0x0144:
            int r12 = r18 + 1
            r1 = r23
            r2 = r24
        ...
        L_0x0150:
            ...
            defpackage.z04.u(r1)     // Catch:{ Exception -> 0x014e }
    ...
    public static ffc g(xw0 xw0, qy5 qy5, boolean z, boolean z2) {
        Iterable iterable;
        String str = qy5.n;
        xw0.getClass();
        List e = e(str, z, z2);
    ...
    public static ArrayList h(qy5 qy5, List list) {
        ArrayList arrayList = new ArrayList(list);
        Collections.sort(arrayList, new ca3(5, new z16(20, qy5)));
        return arrayList;
    }
    ...
    public static boolean j(MediaCodecInfo mediaCodecInfo, String str) {
        ...
        String T = lz7.T(mediaCodecInfo.getName());
        if (T.startsWith("arc.")) {
            return false;
        }
        if (T.startsWith("omx.google.") || T.startsWith("omx.ffmpeg.")) {
            return true;
        }
        if ((!T.startsWith("omx.sec.") || !T.contains(".sw.")) && !T.equals("omx.qcom.video.decoder.hevcswvdec") && !T.startsWith("c2.android.") && !T.startsWith("c2.google.")) {
            return !T.startsWith("omx.") && !T.startsWith("c2.");
        }
        return true;
    }
    ...
    public static int k() {
        ...
        if (c == -1) {
            ...
            if (y78 != null) {
                    ...
                    if (i4 != 1 && i4 != 2) {
                        switch (i4) {
                            ...
                            case 512:
                                i = 921600;
                                break;
                            case LockFreeTaskQueueCore.MIN_ADD_SPIN_CAPACITY:
                                i = 1310720;
                                break;
                            case 2048:
                            case 4096:
                ...
                i2 = Math.max(i3, oaf.a >= 21 ? 345600 : 172800);
            }
            c = i2;
        }
        return c;
