...
public abstract class p4g {
    ...
    public static ArrayList b(List list, String str, k4g k4g) {
        int i;
        ArrayList arrayList = new ArrayList();
        for (int i2 = 0; i2 < list.size(); i2++) {
            e4g e4g = (e4g) list.get(i2);
            String str2 = k4g.a;
            if (!e4g.a.isEmpty() || !e4g.b.isEmpty() || !e4g.c.isEmpty() || !e4g.d.isEmpty()) {
                int a2 = e4g.a(e4g.d, e4g.a(e4g.b, e4g.a(e4g.a, 0, 1073741824, str), 2, str2), 4, k4g.c);
                if (a2 != -1) {
                    if (k4g.d.containsAll(e4g.c)) {
                        i = a2 + (e4g.c.size() * 4);
                    }
                }
                i = 0;
    ...
    public static int c(List list, String str, k4g k4g) {
        ArrayList b2 = b(list, str, k4g);
        for (int i = 0; i < b2.size(); i++) {
            int i2 = ((m4g) b2.get(i)).b.p;
            if (i2 != -1) {
                return i2;
            }
        }
    ...
    public static g4g d(String str, Matcher matcher, yaf yaf, ArrayList arrayList) {
        o4g o4g = new o4g();
        try {
            ...
            return new g4g(o4g.a().a(), o4g.a, o4g.b);
    ...
    public static void e(java.lang.String r18, defpackage.o4g r19) {
        ...
        L_0x0116:
            float r5 = defpackage.u4g.b(r14)     // Catch:{ NumberFormatException -> 0x016d }
