...
public abstract class o88 {
    ...
    public static void a(String str, ArrayList arrayList) {
        if ("audio/raw".equals(str)) {
            if (maf.a < 26 && maf.b.equals("R9") && arrayList.size() == 1 && ((x78) arrayList.get(0)).a.equals("OMX.MTK.AUDIO.DECODER.RAW")) {
                arrayList.add(x78.g("OMX.google.raw.decoder", "audio/raw", "audio/raw", (MediaCodecInfo.CodecCapabilities) null, false, true, false, false));
            }
    ...
    public static String b(oy5 oy5) {
        Pair d;
        if ("audio/eac3-joc".equals(oy5.w0)) {
            return "audio/eac3";
        }
        if (!"video/dolby-vision".equals(oy5.w0) || (d = d(oy5)) == null) {
            return null;
        }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:352:0x0578, code lost:
        switch(r18) {
            ...
            case ru.ok.tamtam.nano.Protos.Attaches.Attach.PRESENT :int: goto L_0x05db;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:360:0x05af, code lost:
        r1 = java.lang.Integer.valueOf(kotlinx.coroutines.internal.LockFreeTaskQueueCore.MIN_ADD_SPIN_CAPACITY);
     */
    ...
    public static android.util.Pair d(defpackage.oy5 r26) {
        ...
        L_0x0360:
            ...
            java.lang.String r0 = defpackage.ha9.d(r0)     // Catch:{ NumberFormatException -> 0x03ba }
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r5v0, resolved type: l88} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r5v1, resolved type: java.lang.Object} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r5v3, resolved type: l88} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r5v4, resolved type: l88} */
    /* JADX WARNING: type inference failed for: r8v3, types: [java.lang.Object, j88] */
    /* JADX WARNING: Multi-variable type inference failed */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static synchronized java.util.List e(java.lang.String r7, boolean r8, boolean r9) {
        /*
            java.lang.Class<o88> r0 = defpackage.o88.class
            monitor-enter(r0)
            h88 r1 = new h88     // Catch:{ all -> 0x0021 }
            r1.<init>(r7, r8, r9)     // Catch:{ all -> 0x0021 }
            java.util.HashMap r2 = b     // Catch:{ all -> 0x0021 }
            java.lang.Object r3 = r2.get(r1)     // Catch:{ all -> 0x0021 }
            java.util.List r3 = (java.util.List) r3     // Catch:{ all -> 0x0021 }
            if (r3 == 0) goto L_0x0014
            monitor-exit(r0)
            return r3
        L_0x0014:
            int r3 = defpackage.maf.a     // Catch:{ all -> 0x0021 }
            r4 = 21
            if (r3 < r4) goto L_0x0023
            l88 r5 = new l88     // Catch:{ all -> 0x0021 }
            r6 = 0
            r5.<init>(r6, r8, r9)     // Catch:{ all -> 0x0021 }
            goto L_0x0028
        L_0x0021:
            r7 = move-exception
            goto L_0x0076
        L_0x0023:
            vu4 r5 = new vu4     // Catch:{ all -> 0x0021 }
            r5.<init>()     // Catch:{ all -> 0x0021 }
        L_0x0028:
            java.util.ArrayList r9 = f(r1, r5)     // Catch:{ all -> 0x0021 }
            if (r8 == 0) goto L_0x006a
            boolean r8 = r9.isEmpty()     // Catch:{ all -> 0x0021 }
            if (r8 == 0) goto L_0x006a
            if (r4 > r3) goto L_0x006a
            r8 = 23
            if (r3 > r8) goto L_0x006a
            vu4 r8 = new vu4     // Catch:{ all -> 0x0021 }
            r8.<init>()     // Catch:{ all -> 0x0021 }
            java.util.ArrayList r9 = f(r1, r8)     // Catch:{ all -> 0x0021 }
            boolean r8 = r9.isEmpty()     // Catch:{ all -> 0x0021 }
            if (r8 != 0) goto L_0x006a
            r8 = 0
            java.lang.Object r8 = r9.get(r8)     // Catch:{ all -> 0x0021 }
            x78 r8 = (defpackage.x78) r8     // Catch:{ all -> 0x0021 }
            java.lang.String r8 = r8.a     // Catch:{ all -> 0x0021 }
            java.lang.String r3 = java.lang.String.valueOf(r7)     // Catch:{ all -> 0x0021 }
            int r3 = r3.length()     // Catch:{ all -> 0x0021 }
            int r3 = r3 + 63
            java.lang.String r8 = java.lang.String.valueOf(r8)     // Catch:{ all -> 0x0021 }
            int r8 = r8.length()     // Catch:{ all -> 0x0021 }
            int r3 = r3 + r8
            java.lang.StringBuilder r8 = new java.lang.StringBuilder     // Catch:{ all -> 0x0021 }
            r8.<init>(r3)     // Catch:{ all -> 0x0021 }
        L_0x006a:
            a(r7, r9)     // Catch:{ all -> 0x0021 }
            zw6 r7 = defpackage.zw6.j(r9)     // Catch:{ all -> 0x0021 }
            r2.put(r1, r7)     // Catch:{ all -> 0x0021 }
            monitor-exit(r0)
            return r7
        L_0x0076:
            ...
            throw r7
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.o88.e(java.lang.String, boolean, boolean):java.util.List");
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static java.util.ArrayList f(defpackage.h88 r23, defpackage.j88 r24) {
        /*
            r1 = r23
            r2 = r24
            ...
            int r15 = r24.g()     // Catch:{ Exception -> 0x0130 }
            boolean r13 = r24.h()     // Catch:{ Exception -> 0x0130 }
            r16 = 0
            r12 = r16
        L_0x001b:
            if (r12 >= r15) goto L_0x0147
            android.media.MediaCodecInfo r0 = r2.a(r12)     // Catch:{ Exception -> 0x0130 }
            int r6 = defpackage.maf.a     // Catch:{ Exception -> 0x0130 }
            r7 = 29
        ...
        L_0x0045:
            ...
            boolean r8 = r2.d(r4, r10, r9)     // Catch:{ Exception -> 0x0104 }
        ...
        L_0x0057:
            ...
            goto L_0x002d
        L_0x005c:
            boolean r7 = r2.d(r3, r10, r9)     // Catch:{ Exception -> 0x0104 }
        ...
        L_0x0093:
            ...
            java.lang.String r0 = defpackage.lz7.T(r0)     // Catch:{ Exception -> 0x0104 }
        ...
        L_0x00c1:
            ...
            r22 = r13
            r13 = r2
            x78 r0 = defpackage.x78.g(r6, r7, r8, r9, r10, r11, r12, r13)     // Catch:{ Exception -> 0x00db }
        ...
        L_0x0104:
            ...
            r22 = r13
        L_0x010d:
            int r2 = defpackage.maf.a     // Catch:{ Exception -> 0x0130 }
            r6 = 23
    ...
    public static int i() {
        ...
        if (c == -1) {
            ...
            if (x78 != null) {
                ...
                i2 = Math.max(i3, maf.a >= 21 ? 345600 : 172800);
            }
            c = i2;
        }
        return c;
