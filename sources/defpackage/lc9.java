...
public final class lc9 extends BaseAdapter {
    public static final int X = ((jaf.d((Calendar) null).getMaximum(7) + jaf.d((Calendar) null).getMaximum(5)) - 1);
    public static final int o = jaf.d((Calendar) null).getMaximum(4);
    public final kc9 a;
    public ph4 b;
    public final tx0 c;

    public lc9(kc9 kc9, tx0 tx0) {
        this.a = kc9;
        this.c = tx0;
        throw null;
    }
    ...
    public final int a() {
        int i = this.c.X;
        kc9 kc9 = this.a;
        Calendar calendar = kc9.a;
        int i2 = calendar.get(7);
        if (i <= 0) {
            i = calendar.getFirstDayOfWeek();
        }
        int i3 = i2 - i;
        return i3 < 0 ? i3 + kc9.o : i3;
    }
