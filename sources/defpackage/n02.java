...
public final class n02 extends b12 {
    ...
    public final kbe c() {
        ...
        long j3 = this.y;
        if (j3 == -9223372036854775807L || this.e - j3 < j2 || (kbe = (kbe) this.b.pollFirst()) == null) {
            return null;
        }
    ...
    public final ArrayList j() {
        ...
        for (int i3 = 0; i3 < size; i3++) {
            yz3 c = ((l02) arrayList.get(i3)).c(Integer.MIN_VALUE);
            arrayList2.add(c);
            if (c != null) {
                i2 = Math.min(i2, c.i);
            }
        ...
        for (int i4 = 0; i4 < size; i4++) {
            yz3 yz3 = (yz3) arrayList2.get(i4);
            if (yz3 != null) {
                if (yz3.i != i2) {
                    yz3 = ((l02) arrayList.get(i4)).c(i2);
                    yz3.getClass();
                }
                arrayList3.add(yz3);
            }
