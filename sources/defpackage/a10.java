...
public final class a10 extends Drawable {
    public Drawable a;
    public boolean b;
    public int c = tu0.G(((float) 56) * fk4.d().getDisplayMetrics().density);
    ...
    public final void setBounds(Rect rect) {
        ...
        if (!this.b && rect.width() > 0 && rect.width() < tu0.G(((float) 56) * fk4.d().getDisplayMetrics().density)) {
            this.c = rect.width();
        }
    }
    ...
    public final void setBounds(int i2, int i3, int i4, int i5) {
        ...
        if (!this.b && getBounds().width() > 0 && getBounds().width() < tu0.G(((float) 56) * fk4.d().getDisplayMetrics().density)) {
