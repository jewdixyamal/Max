...
public abstract class q4g {
    ...
    static {
        ...
        h4f.p(255, 255, 255, hashMap, "white");
        h4f.p(0, 255, 0, hashMap, "lime");
        h4f.p(0, 255, 255, hashMap, "cyan");
        h4f.p(255, 0, 0, hashMap, "red");
        h4f.p(255, 255, 0, hashMap, "yellow");
        h4f.p(255, 0, 255, hashMap, "magenta");
        h4f.p(0, 0, 255, hashMap, "blue");
        h4f.p(0, 0, 0, hashMap, "black");
        c = Collections.unmodifiableMap(hashMap);
        HashMap hashMap2 = new HashMap();
        h4f.p(255, 255, 255, hashMap2, "bg_white");
        h4f.p(0, 255, 0, hashMap2, "bg_lime");
        h4f.p(0, 255, 255, hashMap2, "bg_cyan");
        h4f.p(255, 0, 0, hashMap2, "bg_red");
        h4f.p(255, 255, 0, hashMap2, "bg_yellow");
        h4f.p(255, 0, 255, hashMap2, "bg_magenta");
        h4f.p(0, 0, 255, hashMap2, "bg_blue");
        h4f.p(0, 0, 0, hashMap2, "bg_black");
    ...
    public static ArrayList b(List list, String str, l4g l4g) {
        int i;
        ArrayList arrayList = new ArrayList();
        for (int i2 = 0; i2 < list.size(); i2++) {
            f4g f4g = (f4g) list.get(i2);
            String str2 = l4g.a;
            if (!f4g.a.isEmpty() || !f4g.b.isEmpty() || !f4g.c.isEmpty() || !f4g.d.isEmpty()) {
                int a2 = f4g.a(f4g.d, f4g.a(f4g.b, f4g.a(f4g.a, 0, 1073741824, str), 2, str2), 4, l4g.c);
                if (a2 != -1) {
                    if (l4g.d.containsAll(f4g.c)) {
                        i = a2 + (f4g.c.size() * 4);
                    }
                }
                i = 0;
    ...
    public static int c(List list, String str, l4g l4g) {
        ArrayList b2 = b(list, str, l4g);
        for (int i = 0; i < b2.size(); i++) {
            int i2 = ((n4g) b2.get(i)).b.p;
            if (i2 != -1) {
                return i2;
            }
        }
    ...
    public static h4g d(String str, Matcher matcher, wpa wpa, ArrayList arrayList) {
        o4g o4g = new o4g();
        try {
            ...
            o4g.c = f(str, sb.toString(), arrayList);
            return new h4g(o4g.b().a(), o4g.a, o4g.b);
    ...
    public static void e(java.lang.String r18, defpackage.o4g r19) {
        ...
        L_0x0085:
            ...
            defpackage.z04.c0(r13)     // Catch:{ NumberFormatException -> 0x0173 }
        L_0x008e:
            r13 = r10
            goto L_0x0097
        L_0x0090:
        ...
        L_0x00fb:
            ...
            defpackage.z04.c0(r5)     // Catch:{ NumberFormatException -> 0x0173 }
            r5 = r16
            goto L_0x010c
        L_0x0107:
            r5 = r10
        ...
        L_0x0112:
            float r5 = defpackage.v4g.b(r14)     // Catch:{ NumberFormatException -> 0x0173 }
    ...
    public static void g(String str, o4g o4g) {
        int i = 2;
        ...
        if (indexOf != -1) {
            ...
            switch (c2) {
                ...
                case 3:
                    ...
                    break;
                default:
                    z04.c0("Invalid anchor value: ".concat(substring));
                    i = Integer.MIN_VALUE;
                    break;
            }
            o4g.g = i;
        ...
        o4g.e = (float) Integer.parseInt(str);
        o4g.f = 1;
    }
}
