...
public final class u74 {
    ...
    public u74(qy5 qy5, int i2, int i3, int i4, int i5, int i6, int i7, int i8, h60 h60, boolean z, boolean z2, boolean z3) {
        this.a = qy5;
        this.b = i2;
        this.c = i3;
        this.d = i4;
    ...
    public static AudioAttributes c(h30 h30, boolean z) {
        return z ? new AudioAttributes.Builder().setContentType(3).setFlags(16).setUsage(1).build() : (AudioAttributes) h30.b().a;
    }

    public final AudioTrack a(h30 h30, int i2) {
        int i3 = this.c;
        try {
            AudioTrack b2 = b(h30, i2);
    ...
    public final android.media.AudioTrack b(defpackage.h30 r13, int r14) {
        /*
            r12 = this;
            ...
            android.media.AudioFormat r2 = defpackage.oaf.s(r8, r10, r9)
        ...
        L_0x0094:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.u74.b(h30, int):android.media.AudioTrack");
    }
}
