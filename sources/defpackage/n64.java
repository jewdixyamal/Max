...
public final class n64 {
    ...
    public synchronized void c(int r2) {
        ...
        L_0x002e:
            ...
            throw r2
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.n64.c(int):void");
    }
    ...
    public synchronized void d() {
        ...
        synchronized (this) {
            switch (i) {
                case 0:
                    int max = Math.max(0, maf.g(this.d, this.c) - this.e);
                    int i2 = this.f;
                    if (max < i2) {
                        Arrays.fill((vc[]) this.g, max, i2, (Object) null);
                        this.f = max;
                        return;
                    }
                    return;
                default:
                    int max2 = Math.max(0, oaf.g(this.d, this.c) - this.e);
                    int i3 = this.f;
                    if (max2 < i3) {
                        Arrays.fill((wc[]) this.g, max2, i3, (Object) null);
                        this.f = max2;
                        return;
                    }
                    return;
