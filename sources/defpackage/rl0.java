...
public final class rl0 {
    ...
    public static final rl0 f = new rl0(false);
    public static final rl0 g = new rl0(true);
    ...
    public final SpannableStringBuilder d(CharSequence charSequence, u2 u2Var) {
        ...
        boolean T1 = u2Var.T1(charSequence.length(), charSequence);
        ...
        boolean z = this.a;
        if (i != 0) {
            boolean T12 = (T1 ? bpe.b : bpe.a).T1(charSequence.length(), charSequence);
            spannableStringBuilder.append((z || (!T12 && a(charSequence) != 1)) ? (!z || (T12 && a(charSequence) != -1)) ? str : str2 : str3);
        }
        if (T1 != z) {
            spannableStringBuilder.append(T1 ? (char) 8235 : 8234);
            spannableStringBuilder.append(charSequence);
            spannableStringBuilder.append(8236);
        } else {
            spannableStringBuilder.append(charSequence);
        }
        boolean T13 = (T1 ? bpe.b : bpe.a).T1(charSequence.length(), charSequence);
        if (!z && (T13 || b(charSequence) == 1)) {
            str = str3;
        } else if (z && (!T13 || b(charSequence) == -1)) {
            str = str2;
        }
