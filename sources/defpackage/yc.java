...
public final class yc implements ka5 {
    ...
    public final boolean b(ra4 ra4) {
        ra4.Y = 0;
        byte[] bArr = r;
        byte[] bArr2 = new byte[bArr.length];
        ra4.q(bArr2, 0, bArr.length, false);
        ...
        ra4.q(bArr4, 0, bArr3.length, false);
    ...
    public final void d(long j2, long j3) {
        ...
        if (j2 != 0) {
            u1d u1d = this.n;
            if (u1d instanceof gi3) {
                gi3 gi3 = (gi3) u1d;
                this.k = (Math.max(0, j2 - gi3.b) * 8000000) / ((long) gi3.e);
                return;
            }
        }
        this.k = 0;
    ...
    public final int i(defpackage.ma5 r20, defpackage.lh4 r21) {
        /*
            r19 = this;
            r0 = r19
            r1 = r20
        ...
        L_0x0058:
            ...
            r3 = r1
            ra4 r3 = (defpackage.ra4) r3     // Catch:{ EOFException -> 0x0082 }
