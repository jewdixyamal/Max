...
public abstract class asb implements l66 {
    public static wrb a(Context context, Bundle bundle) {
        ...
        Arrays.toString(b);
        Arrays.toString(b2);
        return new wrb(z, new HashSet(c(b)), new HashSet(c(b2)));
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:5:0x0015, code lost:
        if (defpackage.vrb.class.isAssignableFrom(r3) != false) goto L_0x0019;
     */
    ...
    public static java.util.HashSet c(java.lang.String[] r5) {
        ...
        L_0x0007:
            ...
            java.lang.Class<vrb> r4 = defpackage.vrb.class
        ...
        L_0x0021:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.asb.c(java.lang.String[]):java.util.HashSet");
    }
}
