...
public final class xv1 {
    ...
    public xv1(CameraCharacteristics cameraCharacteristics, String str) {
        this.b = new gaa((Object) cameraCharacteristics);
        this.c = str;
    }
    ...
    public final java.lang.Object a(android.hardware.camera2.CameraCharacteristics.Key r3) {
        ...
        L_0x0033:
            ...
            throw r3
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.xv1.a(android.hardware.camera2.CameraCharacteristics$Key):java.lang.Object");
    }

    /* JADX WARNING: type inference failed for: r2v1, types: [java.lang.Object, c8d] */
    public final c8d b() {
        if (this.d == null) {
            try {
                StreamConfigurationMap streamConfigurationMap = (StreamConfigurationMap) a(CameraCharacteristics.SCALER_STREAM_CONFIGURATION_MAP);
                if (streamConfigurationMap != null) {
                    y7g y7g = new y7g(this.c);
                    ? obj = new Object();
                    obj.c = new HashMap();
                    obj.o = new HashMap();
                    new HashMap();
                    obj.a = new fd7(streamConfigurationMap);
                    obj.b = y7g;
                    this.d = obj;
                } else {
