...
public final class ln5 {
    ...
    public ln5(nn5 nn5, int i2, oi3 oi3, oi3 oi32, oi3 oi33, oi3 oi34, int i3) {
        this.r = nn5;
        this.a = i2;
        this.d = oi3;
        this.e = oi32;
    ...
    public final void a(hj3 hj3) {
        ...
        if (i2 == 0) {
            ...
            int U2 = nn5.U(hj3, this.q);
            int T2 = nn5.T(hj3, this.q);
            if (hj3.p0[1] == 3) {
                this.p++;
                T2 = 0;
            }
    ...
    public final void b(int r21, boolean r22, boolean r23) {
        ...
        L_0x02d0:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.ln5.b(int, boolean, boolean):void");
    }
                ...
                if (i7 >= i5 || (i3 = this.n + i7) >= nn5.b1) {
                    ...
                    if (this.a == 0) {
                        if (hj3 != null) {
                            int[] iArr = hj3.p0;
                            if (iArr[0] == 3 && hj3.r == 0) {
                                nn5.W(1, i6, iArr[1], hj3.k(), hj3);
                            }
                        }
                    } else if (hj3 != null) {
                        int[] iArr2 = hj3.p0;
                        if (iArr2[1] == 3 && hj3.s == 0) {
                            nn5.W(iArr2[0], hj3.q(), 1, i6, hj3);
                        }
                    }
                    i7++;
                }
            ...
            while (i92 < i82) {
                ...
                if (i10 < nn5.b1) {
                    ...
                    if (this.a == 0) {
                        ...
                        int U = nn5.U(hj32, this.q);
                        int T2 = nn5.T(hj32, this.q);
                        int i12 = nn5.Q0;
                        if (hj32.g0 == 8) {
                            i12 = 0;
                        }
    ...
    public final void f(int i2, oi3 oi3, oi3 oi32, oi3 oi33, oi3 oi34, int i3, int i4, int i5, int i6, int i7) {
        this.a = i2;
        this.d = oi3;
        this.e = oi32;
        this.f = oi33;
