...
public final class xs5 {
    ...
    public xs5(st1 st1, zh6 zh6, q6d q6d, bj6 bj6) {
    ...
    public final void a(boolean z, boolean z2) {
        if (this.d) {
            ...
            mi9 b2 = mi9.b();
            if (z) {
                b2.j(cv1.v0(CaptureRequest.CONTROL_AF_TRIGGER), 2);
            }
            if (z2) {
                b2.j(cv1.v0(CaptureRequest.CONTROL_AE_PRECAPTURE_TRIGGER), 2);
            }
    ...
    public final void b() {
        ts5 ts5 = this.p;
        st1 st1 = this.a;
        ((HashSet) st1.b.b).remove(ts5);
        lq1 lq1 = this.u;
        if (lq1 != null) {
            lq1.d(new Exception("Cancelled by another cancelFocusAndMetering()"));
            this.u = null;
        }
        ((HashSet) st1.b.b).remove(this.o);
        lq1 lq12 = this.t;
        if (lq12 != null) {
            lq12.d(new Exception("Cancelled by cancelFocusAndMetering()"));
            this.t = null;
        }
        this.u = null;
        ...
        if (this.u != null) {
            ...
            ts5 ts52 = new ts5(st1.u(i2), A, this);
            this.p = ts52;
            st1.p(ts52);
        }
    }
    ...
    public final void d(lq1 lq1) {
        ...
        u40.b = true;
        mi9 b2 = mi9.b();
        b2.j(cv1.v0(CaptureRequest.CONTROL_AE_PRECAPTURE_TRIGGER), 1);
        u40.c(new re6(8, (Object) wma.a(b2)));
        u40.b(new ru1(lq1, 2));
        this.a.z(Collections.singletonList(u40.d()));
    }
    ...
    public final void e(boolean z) {
        if (this.d) {
            ...
            u40.b = true;
            mi9 b2 = mi9.b();
            b2.j(cv1.v0(CaptureRequest.CONTROL_AF_TRIGGER), 1);
            if (z) {
                CaptureRequest.Key key = CaptureRequest.CONTROL_AE_MODE;
                Integer valueOf = Integer.valueOf(st1.t(this.a.e, 1));
                b2.d(cv1.v0(key), be3.b, valueOf);
            }
            u40.c(new re6(8, (Object) wma.a(b2)));
            u40.b(new ru1());
            this.a.z(Collections.singletonList(u40.d()));
