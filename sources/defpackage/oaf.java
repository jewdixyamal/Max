...
public abstract class oaf {
    ...
    public static int J(Uri uri, String str) {
        ...
        if (str == null) {
            ...
            if (lastPathSegment != null) {
                ...
                if (lastIndexOf >= 0) {
                    String T = lz7.T(lastPathSegment.substring(lastIndexOf + 1));
                    T.getClass();
                    switch (T.hashCode()) {
                        case 104579:
                            if (T.equals("ism")) {
    ...
    public static boolean O() {
        String T = lz7.T(b);
        return T.contains("emulator") || T.contains("emu64a") || T.contains("emu64x") || T.contains("generic");
    }
    ...
    public static String T(String str) {
        ...
        if (str4 != null) {
            StringBuilder l2 = au1.l(str4);
            l2.append(T.substring(str2.length()));
            T = l2.toString();
            str2 = str4;
        }
        ...
        while (true) {
            ...
            if (T.startsWith(strArr2[i2])) {
                return strArr2[i2 + 1] + T.substring(strArr2[i2].length());
            }
            i2 += 2;
        }
    }
    ...
    public static long V(String str) {
        ...
        throw ParserException.a((RuntimeException) null, "Invalid date/time format: " + str);
    }
    ...
    public static void Z(long[] jArr, long j2) {
        ...
        if (i2 >= 0 && j2 % 1000000 == 0) {
            long m2 = m6d.m(j2, 1000000, RoundingMode.UNNECESSARY);
            while (i3 < jArr.length) {
                jArr[i3] = m6d.m(jArr[i3], m2, roundingMode);
                i3++;
            }
            ...
            for (int i4 = 0; i4 < jArr.length; i4++) {
                ...
                if (j3 != 0) {
                    ...
                    if (i5 >= 0 && j2 % j3 == 0) {
                        jArr[i4] = m6d.m(1000000, m6d.m(j2, j3, RoundingMode.UNNECESSARY), roundingMode);
                    } else if (i5 >= 0 || j3 % j2 != 0) {
                        jArr[i4] = b0(j3, 1000000, j2, roundingMode);
                    } else {
                        jArr[i4] = m6d.L(1000000, m6d.m(j3, j2, RoundingMode.UNNECESSARY));
                    }
                }
            }
        } else {
            long m3 = m6d.m(1000000, j2, RoundingMode.UNNECESSARY);
            while (i3 < jArr.length) {
                jArr[i3] = m6d.L(jArr[i3], m3);
                i3++;
            }
        }
    }
    ...
    public static long a0(long j2, long j3, long j4, RoundingMode roundingMode) {
        ...
        if (i2 >= 0 && j4 % j3 == 0) {
            return m6d.m(j2, m6d.m(j4, j3, RoundingMode.UNNECESSARY), roundingMode);
        }
        if (i2 < 0 && j3 % j4 == 0) {
            return m6d.L(j2, m6d.m(j3, j4, RoundingMode.UNNECESSARY));
        }
        int i3 = (j4 > j2 ? 1 : (j4 == j2 ? 0 : -1));
        return (i3 < 0 || j4 % j2 != 0) ? (i3 >= 0 || j2 % j4 != 0) ? b0(j2, j3, j4, roundingMode) : m6d.L(j3, m6d.m(j2, j4, RoundingMode.UNNECESSARY)) : m6d.m(j3, m6d.m(j4, j2, RoundingMode.UNNECESSARY), roundingMode);
    }
    ...
    public static int b(long[] r4, long r5, boolean r7) {
        ...
        L_0x001a:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.oaf.b(long[], long, boolean):int");
    }
    ...
    public static long b0(long r9, long r11, long r13, java.math.RoundingMode r15) {
        /*
            long r0 = defpackage.m6d.L(r9, r11)
            ...
            if (r4 == 0) goto L_0x0018
            long r9 = defpackage.m6d.m(r0, r13, r15)
            return r9
        L_0x0018:
            long r0 = java.lang.Math.abs(r11)
            long r7 = java.lang.Math.abs(r13)
            long r0 = defpackage.m6d.o(r0, r7)
            java.math.RoundingMode r4 = java.math.RoundingMode.UNNECESSARY
            long r11 = defpackage.m6d.m(r11, r0, r4)
            long r13 = defpackage.m6d.m(r13, r0, r4)
            long r0 = java.lang.Math.abs(r9)
            long r7 = java.lang.Math.abs(r13)
            long r0 = defpackage.m6d.o(r0, r7)
            long r9 = defpackage.m6d.m(r9, r0, r4)
            long r13 = defpackage.m6d.m(r13, r0, r4)
            long r0 = defpackage.m6d.L(r9, r11)
            int r4 = (r0 > r2 ? 1 : (r0 == r2 ? 0 : -1))
        ...
        L_0x00ac:
            ...
            goto L_0x00e8
        L_0x00b1:
            boolean r0 = defpackage.um4.a(r9)
    ...
    public static int c(nv7 nv7, long j2) {
        int i2 = nv7.b - 1;
        int i3 = 0;
        while (i3 <= i2) {
            int i4 = (i3 + i2) >>> 1;
    ...
    public static boolean c0(q3b q3b, boolean z) {
        if (q3b == null || !q3b.u() || q3b.getPlaybackState() == 1 || q3b.getPlaybackState() == 4) {
            return true;
        }
        return z && q3b.v0() != 0;
    }
    ...
    public static int e(int[] r3, int r4, boolean r5, boolean r6) {
        ...
        L_0x0020:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.oaf.e(int[], int, boolean, boolean):int");
    }
    ...
    /* JADX WARNING: type inference failed for: r0v0, types: [ccd, k1, java.lang.Object] */
    public static ccd g0(bm7 bm7, vu vuVar) {
        ? obj = new Object();
        fre fre = new fre(obj, 3, bm7);
        nk4 nk4 = nk4.a;
        obj.d(fre, nk4);
        bm7.d(new ewc(bm7, obj, vuVar, 10), nk4);
        return obj;
    }
    ...
    public static Handler p(hl4 hl4) {
        return new Handler(w(), hl4);
    }
