...
public final class m02 extends a12 {
    ...
    public final jbe c() {
        ...
        long j2 = this.I0;
        if (j2 == -9223372036854775807L || this.X - j2 < j || (jbe = (jbe) this.b.pollFirst()) == null) {
            return null;
        }
        this.y0 = Collections.emptyList();
        this.I0 = -9223372036854775807L;
        jbe jbe2 = jbe;
        jbe2.w(this.X, a(), Long.MAX_VALUE);
        return jbe;
    }
    ...
    public final ArrayList h() {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            xz3 c = ((k02) arrayList.get(i2)).c(Integer.MIN_VALUE);
            arrayList2.add(c);
            if (c != null) {
                i = Math.min(i, c.t0);
            }
        ...
        for (int i3 = 0; i3 < size; i3++) {
            xz3 xz3 = (xz3) arrayList2.get(i3);
            if (xz3 != null) {
                if (xz3.t0 != i) {
                    xz3 = ((k02) arrayList.get(i3)).c(i);
                    xz3.getClass();
                }
                arrayList3.add(xz3);
            }
