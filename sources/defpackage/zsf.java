...
public final /* synthetic */ class zsf implements ga6 {
    ...
    /* JADX WARNING: type inference failed for: r0v0, types: [java.lang.Object, zsf, ga6] */
    static {
        ? obj = new Object();
        a = obj;
        d5b d5b = new d5b("one.me.webapp.domain.jsbridge.delegates.biometry.WebAppBiometryAccessRequest", obj, 3);
        d5b.k("queryId", false);
    ...
    public final Object a(x8 x8Var) {
        ...
        j.z(r6d);
        return new btf(str, i, str2, str3);
    }
