...
public final class wg extends dle {
    ...
    public final Object z(Context context, XmlResourceParser xmlResourceParser, int i) {
        ...
        switch (this.o) {
            case 0:
                Long f0 = dae.f0(xmlResourceParser.getAttributeValue(i));
                return Long.valueOf(f0 != null ? f0.longValue() : 0);
            case 1:
            ...
            default:
                ...
                int parseInt = (str == null || !w9e.S0(str, '#')) ? Integer.parseInt(xmlResourceParser.getAttributeValue(i)) : 3;
                if (parseInt == 0) {
                    return new ih(0.0f);
                }
                if (parseInt == 1) {
