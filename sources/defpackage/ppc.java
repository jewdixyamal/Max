...
public abstract class ppc implements RunnableFuture {
    ...
    public final boolean cancel(boolean r4) {
        ...
        L_0x0020:
            ...
            goto L_0x0031
        L_0x0022:
            ae3 r4 = r3.a     // Catch:{ all -> 0x0020 }
            r4.g()     // Catch:{ all -> 0x0020 }
            ae3 r3 = r3.b     // Catch:{ all -> 0x0020 }
        ...
        L_0x0031:
            ...
            throw r3
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.ppc.cancel(boolean):boolean");
    }
    ...
    public final void run() {
        ...
        L_0x0059:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.ppc.run():void");
    }
        ...
        synchronized (ae3) {
            if (convert <= 0) {
                ...
                if (j2 < elapsedRealtime) {
                    ...
                    while (!ae3.b && elapsedRealtime < j2) {
                        ae3.wait(j2 - elapsedRealtime);
