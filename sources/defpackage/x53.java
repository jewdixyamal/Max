...
public abstract class x53 extends d63 {
    ...
    public static Set H0(Iterable iterable) {
        ...
        if (z) {
            ...
            if (size != 1) {
                LinkedHashSet linkedHashSet = new LinkedHashSet(mz7.Z(collection.size()));
                A0(iterable, linkedHashSet);
                return linkedHashSet;
            }
        ...
        return size2 != 0 ? size2 != 1 ? linkedHashSet2 : Collections.singleton(linkedHashSet2.iterator().next()) : wz4;
    }
    ...
    public static ArrayList I0(Iterable iterable, int i, int i2) {
        ...
        if (!(iterable instanceof RandomAccess) || !(iterable instanceof List)) {
            ArrayList arrayList = new ArrayList();
            Iterator Q = np8.Q(iterable.iterator(), i, i2, false);
            while (Q.hasNext()) {
    ...
    public static final int a0(int i, List list) {
        ...
        StringBuilder n = rh4.n(i, "Element index ", " must be in range [");
        n.append(new h37(0, y53.L(list), 1));
        n.append("].");
    ...
    public static final int b0(int i, List list) {
        ...
        StringBuilder n = rh4.n(i, "Position index ", " must be in range [");
        n.append(new h37(0, list.size(), 1));
        n.append("].");
        throw new IndexOutOfBoundsException(n.toString());
    }
    ...
    public static final void l0(Iterable iterable, Appendable appendable, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i, CharSequence charSequence4, m56 m56) {
    ...
    public static /* synthetic */ void m0(Collection collection, Appendable appendable, int i, m56 m56, int i2) {
        if ((i2 & 16) != 0) {
            i = -1;
        }
        int i3 = i;
    ...
    public static String n0(Iterable iterable, String str, String str2, String str3, m56 m56, int i) {
        if ((i & 1) != 0) {
            str = ", ";
        }
        String str4 = str;
        ...
        l0(iterable, sb, str4, str5, str6, -1, "...", m56);
        return sb.toString();
    }
