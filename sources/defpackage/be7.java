...
public final class be7 implements cw4 {
    ...
    public be7(String str) {
        this.a = str;
        yaf yaf = new yaf((int) LockFreeTaskQueueCore.MIN_ADD_SPIN_CAPACITY);
        this.b = yaf;
        byte[] bArr = yaf.a;
    ...
    public final void f(defpackage.yaf r24) {
        /*
            r23 = this;
            r0 = r23
            xze r1 = r0.d
        ...
        L_0x0258:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.be7.f(yaf):void");
    }
