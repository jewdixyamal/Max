...
public final class y55 {
    ...
    public static y55 c(long[] jArr, ByteOrder byteOrder) {
        ByteBuffer wrap = ByteBuffer.wrap(new byte[(c65.Q[4] * jArr.length)]);
        wrap.order(byteOrder);
        for (long j : jArr) {
            wrap.putInt((int) j);
        }
        return new y55(4, wrap.array(), jArr.length);
    }

    public static y55 d(a65[] a65Arr, ByteOrder byteOrder) {
        ByteBuffer wrap = ByteBuffer.wrap(new byte[(c65.Q[5] * a65Arr.length)]);
        wrap.order(byteOrder);
        for (a65 a65 : a65Arr) {
            wrap.putInt((int) a65.a);
            wrap.putInt((int) a65.b);
        }
        return new y55(5, wrap.array(), a65Arr.length);
    }
    ...
    public static y55 f(int[] iArr, ByteOrder byteOrder) {
        ByteBuffer wrap = ByteBuffer.wrap(new byte[(c65.Q[3] * iArr.length)]);
        wrap.order(byteOrder);
        for (int i : iArr) {
            wrap.putShort((short) i);
        }
        return new y55(3, wrap.array(), iArr.length);
    }
    ...
    public final double g(ByteOrder byteOrder) {
        ...
        if (j == null) {
            ...
            if (j instanceof long[]) {
                ...
                throw new NumberFormatException("There are more than one component");
            } else if (j instanceof a65[]) {
                a65[] a65Arr = (a65[]) j;
                if (a65Arr.length == 1) {
                    a65 a65 = a65Arr[0];
                    return ((double) a65.a) / ((double) a65.b);
                }
                throw new NumberFormatException("There are more than one component");
            } else {
    ...
    public final String i(ByteOrder byteOrder) {
        ...
        if (j instanceof long[]) {
            ...
            a65[] a65Arr = (a65[]) j;
            while (i < a65Arr.length) {
                sb.append(a65Arr[i].a);
                sb.append('/');
                sb.append(a65Arr[i].b);
                i++;
                if (i != a65Arr.length) {
                    sb.append(",");
                }
    ...
    /* JADX WARNING: type inference failed for: r12v12, types: [a65[], java.io.Serializable] */
    ...
    /* JADX WARNING: type inference failed for: r12v15, types: [a65[], java.io.Serializable] */
    ...
    public final java.io.Serializable j(java.nio.ByteOrder r12) {
        /*
            ...
            byte[] r2 = r11.d
            r3 = 0
            x55 r4 = new x55     // Catch:{ IOException -> 0x011a, all -> 0x0118 }
        ...
        L_0x0040:
            return r12
        L_0x0041:
            a65[] r12 = new defpackage.a65[r11]     // Catch:{ IOException -> 0x0122, all -> 0x0028 }
        L_0x0043:
            ...
            a65 r2 = new a65     // Catch:{ IOException -> 0x0122, all -> 0x0028 }
        ...
        L_0x00ba:
            return r12
        L_0x00bb:
            byte[] r12 = defpackage.c65.R     // Catch:{ IOException -> 0x0122, all -> 0x0028 }
            int r12 = r12.length     // Catch:{ IOException -> 0x0122, all -> 0x0028 }
            if (r11 < r12) goto L_0x00d0
            r12 = r0
        L_0x00c1:
            byte[] r5 = defpackage.c65.R     // Catch:{ IOException -> 0x0122, all -> 0x0028 }
        ...
        L_0x010d:
            ...
            java.nio.charset.Charset r12 = defpackage.c65.Z     // Catch:{ IOException -> 0x0122, all -> 0x0028 }
