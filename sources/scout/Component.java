...
public abstract class Component {
    ...
    public final <K, V> je7 associateLazy(boolean z) {
        getAccessor();
        tpa.F();
        throw null;
    }

    public final <K, V> fpb associateProvider(boolean z) {
        getAccessor();
        tpa.F();
        throw null;
    }
    ...
    public final <T> je7 collectLazy(boolean z) {
        getAccessor();
        tpa.F();
        throw null;
    }

    public final <T> fpb collectProvider(boolean z) {
        getAccessor();
        tpa.F();
        throw null;
    }
