...
final class LZ4HCJavaSafeCompressor extends LZ4Compressor {
    ...
    public int compress(byte[] r22, int r23, int r24, byte[] r25, int r26, int r27) {
        /*
            ...
            r9 = r26
            r2 = r27
            defpackage.vqc.b(r0, r8, r1)
            r10 = r25
            defpackage.vqc.b(r9, r10, r2)
            int r11 = r0 + r1
            int r12 = r9 + r2
            int r13 = r11 + -12
            int r14 = r11 + -5
            int r1 = r0 + 1
            net.jpountz.lz4.LZ4HCJavaSafeCompressor$HashTable r15 = new net.jpountz.lz4.LZ4HCJavaSafeCompressor$HashTable
            r2 = r21
            r15.<init>(r0)
        ...
        L_0x0132:
            ...
            r14 = r7
            r7 = r12
            int r17 = net.jpountz.lz4.LZ4SafeUtils.encodeSequence(r0, r1, r2, r3, r4, r5, r6, r7)
            int r16 = r8.end()
        ...
        L_0x01f9:
            ...
            r6 = r17
            r7 = r12
            int r6 = net.jpountz.lz4.LZ4SafeUtils.encodeSequence(r0, r1, r2, r3, r4, r5, r6, r7)
            int r1 = r8.end()
            int r2 = r14.start
            int r3 = r14.ref
            int r4 = r14.len
            int r16 = net.jpountz.lz4.LZ4SafeUtils.encodeSequence(r0, r1, r2, r3, r4, r5, r6, r7)
            int r2 = r14.end()
        L_0x021e:
            r1 = r2
            r6 = r8
    ...
    public class HashTable {
        ...
        public boolean insertAndFindBestMatch(byte[] bArr, int i, int i2, LZ4Utils.Match match) {
            ...
            for (int i5 = 0; i5 < LZ4HCJavaSafeCompressor.this.maxAttempts && hashPointer >= Math.max(this.base, i - MASK) && hashPointer <= i; i5++) {
        ...
        public boolean insertAndFindWiderMatch(byte[] bArr, int i, int i2, int i3, int i4, LZ4Utils.Match match) {
            ...
            int hashPointer = hashPointer(bArr, i);
            for (int i5 = 0; i5 < LZ4HCJavaSafeCompressor.this.maxAttempts && hashPointer >= Math.max(this.base, i - MASK) && hashPointer <= i; i5++) {
                if (LZ4SafeUtils.readIntEquals(bArr, hashPointer, i) && (commonBytes = LZ4SafeUtils.commonBytes(bArr, hashPointer + 4, i + 4, i3) + 4 + commonBytesBackward) > match.len) {
                    match.len = commonBytes;
                    match.ref = hashPointer - (commonBytesBackward = LZ4SafeUtils.commonBytesBackward(bArr, hashPointer, i, this.base, i2));
    ...
    public int compress(java.nio.ByteBuffer r23, int r24, int r25, java.nio.ByteBuffer r26, int r27, int r28) {
        /*
            ...
            return r0
        L_0x0036:
            java.nio.ByteBuffer r10 = defpackage.tv0.c(r23)
            java.nio.ByteBuffer r11 = defpackage.tv0.c(r26)
            defpackage.tv0.b(r10, r0, r3)
            defpackage.tv0.b(r11, r1, r6)
            int r12 = r0 + r3
            int r13 = r1 + r6
            int r14 = r12 + -12
            int r15 = r12 + -5
