...
public class LZ4FrameInputStream extends FilterInputStream {
    ...
    private void readBlock() throws IOException {
        ...
        if (i != 0) {
            ...
            throw new IOException(rh4.h("Block size ", i, this.maxBlockSize, " exceeded max: "));
    ...
    private void skippableFrame() throws IOException {
        ...
        while (readInt > 0) {
            int read = this.in.read(bArr, 0, Math.min(readInt, LockFreeTaskQueueCore.MIN_ADD_SPIN_CAPACITY));
            if (read >= 0) {
                readInt -= read;
            } else {
                throw new IOException(PREMATURE_EOS);
    ...
    public LZ4FrameInputStream(InputStream inputStream, LZ4SafeDecompressor lZ4SafeDecompressor, n9g n9g) throws IOException {
        this(inputStream, lZ4SafeDecompressor, n9g, false);
    }

    public LZ4FrameInputStream(InputStream inputStream, LZ4SafeDecompressor lZ4SafeDecompressor, n9g n9g, boolean z) throws IOException {
        super(inputStream);
